...
class EzsigndocumentApplyEzsigntemplateV2Request {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigndocumentApplyEzsigntemplateV2Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigndocumentApplyEzsigntemplateV2Request</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigndocumentApplyEzsigntemplateV2Request.RequiredProperties) {
...
EzsigndocumentApplyEzsigntemplateV2Request.RequiredProperties = ["fkiEzsigntemplateID", "a_sEzsigntemplatesigner", "a_pkiEzsignfoldersignerassociationID"];
