...
/**
 * The UsergroupexternalListElement model module.
 * @module eZmaxAPI/model/UsergroupexternalListElement
 * @version 1.2.0
 */
class UsergroupexternalListElement {
    /**
     * Constructs a new <code>UsergroupexternalListElement</code>.
     * A Usergroupexternal List Element
     * @alias module:eZmaxAPI/model/UsergroupexternalListElement
    ...
    constructor(pkiUsergroupexternalID, sUsergroupexternalName, sUsergroupexternalID) { 
        ...
        UsergroupexternalListElement.initialize(this, pkiUsergroupexternalID, sUsergroupexternalName, sUsergroupexternalID);
    }
    ...
    /**
     * Constructs a <code>UsergroupexternalListElement</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UsergroupexternalListElement} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UsergroupexternalListElement} The populated <code>UsergroupexternalListElement</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsergroupexternalListElement();
    ...
    /**
     * Validates the JSON data with respect to <code>UsergroupexternalListElement</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsergroupexternalListElement</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UsergroupexternalListElement.RequiredProperties) {
...
UsergroupexternalListElement.RequiredProperties = ["pkiUsergroupexternalID", "sUsergroupexternalName", "sUsergroupexternalID"];

/**
 * The unique ID of the Usergroupexternal
 * @member {Number} pkiUsergroupexternalID
 */
UsergroupexternalListElement.prototype['pkiUsergroupexternalID'] = undefined;

/**
 * The name of the Usergroupexternal
 * @member {String} sUsergroupexternalName
 */
UsergroupexternalListElement.prototype['sUsergroupexternalName'] = undefined;

/**
 * The id of the Usergroupexternal
 * @member {String} sUsergroupexternalID
 */
UsergroupexternalListElement.prototype['sUsergroupexternalID'] = undefined;
...
export default UsergroupexternalListElement;
