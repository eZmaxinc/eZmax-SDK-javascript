...
/**
 * The EzsignsignaturecustomdateResponse model module.
 * @module eZmaxAPI/model/EzsignsignaturecustomdateResponse
 * @version 1.1.18
 */
class EzsignsignaturecustomdateResponse {
    /**
     * Constructs a new <code>EzsignsignaturecustomdateResponse</code>.
     * An Ezsignsignaturecustomdate Object
     * @alias module:eZmaxAPI/model/EzsignsignaturecustomdateResponse
    ...
    /**
     * Constructs a <code>EzsignsignaturecustomdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsignsignaturecustomdateResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsignsignaturecustomdateResponse} The populated <code>EzsignsignaturecustomdateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsignsignaturecustomdateResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignsignaturecustomdateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignsignaturecustomdateResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignsignaturecustomdateResponse.RequiredProperties) {
            if (!data[property]) {
...
EzsignsignaturecustomdateResponse.RequiredProperties = ["pkiEzsignsignaturecustomdateID", "iEzsignsignaturecustomdateX", "iEzsignsignaturecustomdateY", "sEzsignsignaturecustomdateFormat"];
...
export default EzsignsignaturecustomdateResponse;
