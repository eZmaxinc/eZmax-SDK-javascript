...
/**
 * The WebhookEzsignFolderDisposed model module.
 * @module eZmaxAPI/model/WebhookEzsignFolderDisposed
 * @version 1.2.0
 */
class WebhookEzsignFolderDisposed {
    /**
     * Constructs a new <code>WebhookEzsignFolderDisposed</code>.
     * This is the base Webhook object
     * @alias module:eZmaxAPI/model/WebhookEzsignFolderDisposed
    ...
    constructor(objWebhook, a_objAttempt, objEzsignfolder) { 
        ...
        WebhookEzsignFolderDisposed.initialize(this, objWebhook, a_objAttempt, objEzsignfolder);
    }
    ...
    /**
     * Constructs a <code>WebhookEzsignFolderDisposed</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/WebhookEzsignFolderDisposed} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/WebhookEzsignFolderDisposed} The populated <code>WebhookEzsignFolderDisposed</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookEzsignFolderDisposed();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookEzsignFolderDisposed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookEzsignFolderDisposed</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookEzsignFolderDisposed.RequiredProperties) {
...
WebhookEzsignFolderDisposed.RequiredProperties = ["objWebhook", "a_objAttempt", "objEzsignfolder"];

/**
 * @member {module:eZmaxAPI/model/CustomWebhookResponse} objWebhook
 */
WebhookEzsignFolderDisposed.prototype['objWebhook'] = undefined;

/**
 * An array containing details of previous attempts that were made to deliver the message. The array is empty if it's the first attempt.
 * @member {Array.<module:eZmaxAPI/model/AttemptResponseCompound>} a_objAttempt
 */
WebhookEzsignFolderDisposed.prototype['a_objAttempt'] = undefined;

/**
 * @member {module:eZmaxAPI/model/EzsignfolderResponse} objEzsignfolder
 */
WebhookEzsignFolderDisposed.prototype['objEzsignfolder'] = undefined;
...
export default WebhookEzsignFolderDisposed;
