...
/**
 * The SignatureGetObjectV2Response model module.
 * @module eZmaxAPI/model/SignatureGetObjectV2Response
 * @version 1.2.0
 */
class SignatureGetObjectV2Response {
    ...
    /**
     * Constructs a <code>SignatureGetObjectV2Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/SignatureGetObjectV2Response} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/SignatureGetObjectV2Response} The populated <code>SignatureGetObjectV2Response</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>SignatureGetObjectV2Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SignatureGetObjectV2Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SignatureGetObjectV2Response.RequiredProperties) {
 ...
 */
SignatureGetObjectV2Response.prototype['objDebugPayload'] = undefined;
...
export default SignatureGetObjectV2Response;
