...
/**
 * The EzmaxinvoicingGetProvisionalV1ResponseMPayload model module.
 * @module eZmaxAPI/model/EzmaxinvoicingGetProvisionalV1ResponseMPayload
 * @version 1.2.0
 */
class EzmaxinvoicingGetProvisionalV1ResponseMPayload {
    /**
     * Constructs a new <code>EzmaxinvoicingGetProvisionalV1ResponseMPayload</code>.
     * Payload for GET /1/object/ezmaxinvoicing/getProvisional
     * @alias module:eZmaxAPI/model/EzmaxinvoicingGetProvisionalV1ResponseMPayload
    ...
    constructor(fkiEzmaxinvoicingcontractID, fkiEzmaxpricingID, fkiSystemconfigurationtypeID, sSystemconfigurationtypeDescriptionX, yyyymmEzmaxinvoicing, iEzmaxinvoicingDays, eEzmaxinvoicingPaymenttype, dEzmaxinvoicingRebatepaymenttype, iEzmaxinvoicingContractlength, dEzmaxinvoicingRebatecontractlength, bEzmaxinvoicingRebateEzsignallagents, objEzmaxinvoicingcontract, objEzmaxpricing, a_objEzmaxinvoicingsummaryglobal, a_objEzmaxinvoicingsummaryexternal, a_objEzmaxinvoicingsummaryinternal, a_objEzmaxinvoicingagent, a_objEzmaxinvoicinguser, a_objEzmaxinvoicingezsignfolder, a_objEzmaxinvoicingezsigndocument) { 
        ...
        EzmaxinvoicingGetProvisionalV1ResponseMPayload.initialize(this, fkiEzmaxinvoicingcontractID, fkiEzmaxpricingID, fkiSystemconfigurationtypeID, sSystemconfigurationtypeDescriptionX, yyyymmEzmaxinvoicing, iEzmaxinvoicingDays, eEzmaxinvoicingPaymenttype, dEzmaxinvoicingRebatepaymenttype, iEzmaxinvoicingContractlength, dEzmaxinvoicingRebatecontractlength, bEzmaxinvoicingRebateEzsignallagents, objEzmaxinvoicingcontract, objEzmaxpricing, a_objEzmaxinvoicingsummaryglobal, a_objEzmaxinvoicingsummaryexternal, a_objEzmaxinvoicingsummaryinternal, a_objEzmaxinvoicingagent, a_objEzmaxinvoicinguser, a_objEzmaxinvoicingezsignfolder, a_objEzmaxinvoicingezsigndocument);
    }
    ...
    /**
     * Constructs a <code>EzmaxinvoicingGetProvisionalV1ResponseMPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzmaxinvoicingGetProvisionalV1ResponseMPayload} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzmaxinvoicingGetProvisionalV1ResponseMPayload} The populated <code>EzmaxinvoicingGetProvisionalV1ResponseMPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzmaxinvoicingGetProvisionalV1ResponseMPayload();
    ...
    /**
     * Validates the JSON data with respect to <code>EzmaxinvoicingGetProvisionalV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzmaxinvoicingGetProvisionalV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzmaxinvoicingGetProvisionalV1ResponseMPayload.RequiredProperties) {
...
EzmaxinvoicingGetProvisionalV1ResponseMPayload.RequiredProperties = ["fkiEzmaxinvoicingcontractID", "fkiEzmaxpricingID", "fkiSystemconfigurationtypeID", "sSystemconfigurationtypeDescriptionX", "yyyymmEzmaxinvoicing", "iEzmaxinvoicingDays", "eEzmaxinvoicingPaymenttype", "dEzmaxinvoicingRebatepaymenttype", "iEzmaxinvoicingContractlength", "dEzmaxinvoicingRebatecontractlength", "bEzmaxinvoicingRebateEzsignallagents", "objEzmaxinvoicingcontract", "objEzmaxpricing", "a_objEzmaxinvoicingsummaryglobal", "a_objEzmaxinvoicingsummaryexternal", "a_objEzmaxinvoicingsummaryinternal", "a_objEzmaxinvoicingagent", "a_objEzmaxinvoicinguser", "a_objEzmaxinvoicingezsignfolder", "a_objEzmaxinvoicingezsigndocument"];

/**
 * The unique ID of the Ezmaxinvoicing
 * @member {Number} pkiEzmaxinvoicingID
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['pkiEzmaxinvoicingID'] = undefined;

/**
 * The unique ID of the Ezmaxinvoicingcontract
 * @member {Number} fkiEzmaxinvoicingcontractID
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['fkiEzmaxinvoicingcontractID'] = undefined;

/**
 * The unique ID of the Ezmaxpricing
 * @member {Number} fkiEzmaxpricingID
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['fkiEzmaxpricingID'] = undefined;

/**
 * The unique ID of the Systemconfigurationtype
 * @member {Number} fkiSystemconfigurationtypeID
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['fkiSystemconfigurationtypeID'] = undefined;

/**
 * The description of the Systemconfigurationtype in the language of the requester
 * @member {String} sSystemconfigurationtypeDescriptionX
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['sSystemconfigurationtypeDescriptionX'] = undefined;

/**
 * The YYYYMM period of the Ezmaxinvoicing
 * @member {String} yyyymmEzmaxinvoicing
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['yyyymmEzmaxinvoicing'] = undefined;

/**
 * The number of days invoiced
 * @member {Number} iEzmaxinvoicingDays
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['iEzmaxinvoicingDays'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEEzmaxinvoicingPaymenttype} eEzmaxinvoicingPaymenttype
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['eEzmaxinvoicingPaymenttype'] = undefined;

/**
 * The percentage of rebate depending of the payment type
 * @member {String} dEzmaxinvoicingRebatepaymenttype
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['dEzmaxinvoicingRebatepaymenttype'] = undefined;

/**
 * The length of the contract in years
 * @member {Number} iEzmaxinvoicingContractlength
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['iEzmaxinvoicingContractlength'] = undefined;

/**
 * The percentage of rebate depending of the contract length
 * @member {String} dEzmaxinvoicingRebatecontractlength
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['dEzmaxinvoicingRebatecontractlength'] = undefined;

/**
 * Whether the rebate for eZsign is for all agents
 * @member {Boolean} bEzmaxinvoicingRebateEzsignallagents
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['bEzmaxinvoicingRebateEzsignallagents'] = undefined;

/**
 * @member {module:eZmaxAPI/model/CommonAudit} objAudit
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['objAudit'] = undefined;

/**
 * @member {module:eZmaxAPI/model/EzmaxinvoicingcontractResponseCompound} objEzmaxinvoicingcontract
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['objEzmaxinvoicingcontract'] = undefined;

/**
 * @member {module:eZmaxAPI/model/CustomEzmaxpricingResponse} objEzmaxpricing
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['objEzmaxpricing'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/EzmaxinvoicingsummaryglobalResponseCompound>} a_objEzmaxinvoicingsummaryglobal
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['a_objEzmaxinvoicingsummaryglobal'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/EzmaxinvoicingsummaryexternalResponseCompound>} a_objEzmaxinvoicingsummaryexternal
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['a_objEzmaxinvoicingsummaryexternal'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/EzmaxinvoicingsummaryinternalResponseCompound>} a_objEzmaxinvoicingsummaryinternal
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['a_objEzmaxinvoicingsummaryinternal'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/EzmaxinvoicingagentResponseCompound>} a_objEzmaxinvoicingagent
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['a_objEzmaxinvoicingagent'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/EzmaxinvoicinguserResponseCompound>} a_objEzmaxinvoicinguser
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['a_objEzmaxinvoicinguser'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/CustomEzmaxinvoicingEzsignfolderResponse>} a_objEzmaxinvoicingezsignfolder
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['a_objEzmaxinvoicingezsignfolder'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/CustomEzmaxinvoicingEzsigndocumentResponse>} a_objEzmaxinvoicingezsigndocument
 */
EzmaxinvoicingGetProvisionalV1ResponseMPayload.prototype['a_objEzmaxinvoicingezsigndocument'] = undefined;
...
export default EzmaxinvoicingGetProvisionalV1ResponseMPayload;
