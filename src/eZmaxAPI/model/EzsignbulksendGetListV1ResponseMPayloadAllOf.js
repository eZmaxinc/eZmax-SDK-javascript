...
class EzsignbulksendGetListV1ResponseMPayloadAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignbulksendGetListV1ResponseMPayloadAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignbulksendGetListV1ResponseMPayloadAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignbulksendGetListV1ResponseMPayloadAllOf.RequiredProperties) {
            if (!data[property]) {
...
EzsignbulksendGetListV1ResponseMPayloadAllOf.RequiredProperties = ["a_objEzsignbulksend"];
