...
class EzsignfolderCreateObjectV2Response {
    ...
    constructor(objDebugPayload, mPayload) { 
        ...
        EzsignfolderCreateObjectV2Response.initialize(this, objDebugPayload, mPayload);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfolderCreateObjectV2Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfolderCreateObjectV2Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfolderCreateObjectV2Response.RequiredProperties) {
            if (!data[property]) {
...
EzsignfolderCreateObjectV2Response.RequiredProperties = ["objDebugPayload", "mPayload"];
