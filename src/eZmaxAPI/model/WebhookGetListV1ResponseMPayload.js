...
class WebhookGetListV1ResponseMPayload {
     ...
     */
    constructor(iRowReturned, iRowFiltered, a_objWebhook) { 
        CommonGetListV1ResponseMPayload.initialize(this, iRowReturned, iRowFiltered);
        WebhookGetListV1ResponseMPayload.initialize(this, iRowReturned, iRowFiltered, a_objWebhook);
    }
     ...
     */
    static initialize(obj, iRowReturned, iRowFiltered, a_objWebhook) { 
...
WebhookGetListV1ResponseMPayload.RequiredProperties = ["iRowReturned", "iRowFiltered", "a_objWebhook"];
