 ...
 * @module eZmaxAPI/model/WebhookRequest
 * @version 1.2.0
 */
class WebhookRequest {
     ...
     * A Webhook Object
     * @alias module:eZmaxAPI/model/WebhookRequest
     ...
     * @param {module:eZmaxAPI/model/WebhookRequest} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/WebhookRequest} The populated <code>WebhookRequest</code> instance.
     */
...
WebhookRequest.RequiredProperties = ["sWebhookDescription", "eWebhookModule", "sWebhookUrl", "sWebhookEmailfailed", "bWebhookIsactive", "bWebhookSkipsslvalidation"];
