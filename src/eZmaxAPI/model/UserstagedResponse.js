...
/**
 * The UserstagedResponse model module.
 * @module eZmaxAPI/model/UserstagedResponse
 * @version 1.1.17
 */
class UserstagedResponse {
    /**
     * Constructs a new <code>UserstagedResponse</code>.
     * A Userstaged Object
     * @alias module:eZmaxAPI/model/UserstagedResponse
    ...
    /**
     * Constructs a <code>UserstagedResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UserstagedResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UserstagedResponse} The populated <code>UserstagedResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserstagedResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UserstagedResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserstagedResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserstagedResponse.RequiredProperties) {
            if (!data[property]) {
...
UserstagedResponse.RequiredProperties = ["pkiUserstagedID", "fkiEmailID", "sUserstagedFirstname", "sUserstagedLastname", "sUserstagedExternalid"];
...
export default UserstagedResponse;
