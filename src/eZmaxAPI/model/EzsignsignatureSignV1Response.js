...
class EzsignsignatureSignV1Response {
    ...
    constructor(objDebugPayload) { 
        ...
        EzsignsignatureSignV1Response.initialize(this, objDebugPayload);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of EzsignsignatureSignV1Response.RequiredProperties) {
...
EzsignsignatureSignV1Response.RequiredProperties = ["objDebugPayload"];
