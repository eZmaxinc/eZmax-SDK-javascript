...
class CustomAutocompleteElementDisabledResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomAutocompleteElementDisabledResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomAutocompleteElementDisabledResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomAutocompleteElementDisabledResponse.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['sCategory'] && !(typeof data['sCategory'] === 'string' || data['sCategory'] instanceof String)) {
            throw new Error("Expected the field `sCategory` to be a primitive type in the JSON string but got " + data['sCategory']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['mValue'] && !(typeof data['mValue'] === 'string' || data['mValue'] instanceof String)) {
            throw new Error("Expected the field `mValue` to be a primitive type in the JSON string but got " + data['mValue']);
        }
...
CustomAutocompleteElementDisabledResponse.RequiredProperties = ["bDisabled", "sCategory", "sLabel", "sValue", "bActive"];
