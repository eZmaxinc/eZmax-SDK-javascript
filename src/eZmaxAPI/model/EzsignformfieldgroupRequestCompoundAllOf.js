...
class EzsignformfieldgroupRequestCompoundAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignformfieldgroupRequestCompoundAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignformfieldgroupRequestCompoundAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignformfieldgroupRequestCompoundAllOf.RequiredProperties) {
            if (!data[property]) {
...
EzsignformfieldgroupRequestCompoundAllOf.RequiredProperties = ["a_objEzsignformfieldgroupsigner", "a_objEzsignformfield"];
