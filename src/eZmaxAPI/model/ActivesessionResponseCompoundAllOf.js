...
class ActivesessionResponseCompoundAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>ActivesessionResponseCompoundAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActivesessionResponseCompoundAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActivesessionResponseCompoundAllOf.RequiredProperties) {
            if (!data[property]) {
...
ActivesessionResponseCompoundAllOf.RequiredProperties = ["a_pkiPermissionID", "objUserReal", "a_eModuleInternalname"];
