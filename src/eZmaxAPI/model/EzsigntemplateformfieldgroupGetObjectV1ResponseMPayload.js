...
class EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload.RequiredProperties = ["pkiEzsigntemplateformfieldgroupID", "fkiEzsigntemplatedocumentID", "eEzsigntemplateformfieldgroupType", "eEzsigntemplateformfieldgroupSignerrequirement", "sEzsigntemplateformfieldgroupLabel", "iEzsigntemplateformfieldgroupStep", "iEzsigntemplateformfieldgroupFilledmin", "iEzsigntemplateformfieldgroupFilledmax", "bEzsigntemplateformfieldgroupReadonly", "a_objEzsigntemplateformfieldgroupsigner", "a_objEzsigntemplateformfield"];
