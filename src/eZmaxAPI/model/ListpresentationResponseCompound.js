...
/**
 * The ListpresentationResponseCompound model module.
 * @module eZmaxAPI/model/ListpresentationResponseCompound
 * @version 1.1.7
 */
class ListpresentationResponseCompound {
    /**
     * Constructs a new <code>ListpresentationResponseCompound</code>.
     * A Listpresentation Object and children to create a complete structure
     * @alias module:eZmaxAPI/model/ListpresentationResponseCompound
     * @implements module:eZmaxAPI/model/ListpresentationRequest
    ...
    constructor(sListpresentationDescription, sListpresentationFilter, sListpresentationOrderby, a_sColumnName, iListpresentationRowMax, iListpresentationRowOffset, bListpresentationDefault) { 
        ...
        ListpresentationResponseCompound.initialize(this, sListpresentationDescription, sListpresentationFilter, sListpresentationOrderby, a_sColumnName, iListpresentationRowMax, iListpresentationRowOffset, bListpresentationDefault);
    }
    ...
    /**
     * Constructs a <code>ListpresentationResponseCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/ListpresentationResponseCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/ListpresentationResponseCompound} The populated <code>ListpresentationResponseCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListpresentationResponseCompound();
            ListpresentationRequest.constructFromObject(data, obj);
 ...
 */
ListpresentationResponseCompound.prototype['sListpresentationDescription'] = undefined;

/**
 * The filter to apply to the request to limit results.
 * @member {String} sListpresentationFilter
 */
ListpresentationResponseCompound.prototype['sListpresentationFilter'] = undefined;

/**
 * The order by the user chose
 * @member {String} sListpresentationOrderby
 */
ListpresentationResponseCompound.prototype['sListpresentationOrderby'] = undefined;

/**
 * An array of column names that the user chose to bee visible
 * @member {Array.<String>} a_sColumnName
 */
ListpresentationResponseCompound.prototype['a_sColumnName'] = undefined;

/**
 * The maximum numbers of results to be returned
 * @member {Number} iListpresentationRowMax
 */
ListpresentationResponseCompound.prototype['iListpresentationRowMax'] = undefined;
 ...
 */
ListpresentationResponseCompound.prototype['iListpresentationRowOffset'] = undefined;
 ...
 */
ListpresentationResponseCompound.prototype['bListpresentationDefault'] = undefined;


// Implement ListpresentationRequest interface:
/**
 * A descriptive for the list presentation
 * @member {String} sListpresentationDescription
 */
...
export default ListpresentationResponseCompound;
