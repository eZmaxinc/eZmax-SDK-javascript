...
class WebhookGetObjectV1ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookGetObjectV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookGetObjectV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookGetObjectV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
WebhookGetObjectV1ResponseMPayload.RequiredProperties = ["pkiWebhookID", "sWebhookDescription", "eWebhookModule", "sWebhookUrl", "sWebhookEmailfailed", "bWebhookSkipsslvalidation", "sWebhookEvent"];
