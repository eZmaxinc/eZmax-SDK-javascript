...
class CommonResponseWarning {
    ...
    /**
     * Validates the JSON data with respect to <code>CommonResponseWarning</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonResponseWarning</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommonResponseWarning.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['sWarningMessage'] && !(typeof data['sWarningMessage'] === 'string' || data['sWarningMessage'] instanceof String)) {
            throw new Error("Expected the field `sWarningMessage` to be a primitive type in the JSON string but got " + data['sWarningMessage']);
        }
        // ensure the json data is a string
        if (data['eWarningCode'] && !(typeof data['eWarningCode'] === 'string' || data['eWarningCode'] instanceof String)) {
            throw new Error("Expected the field `eWarningCode` to be a primitive type in the JSON string but got " + data['eWarningCode']);
        }
...
CommonResponseWarning.RequiredProperties = ["sWarningMessage", "eWarningCode"];
