...
/**
 * The BillingentityinternalproductResponse model module.
 * @module eZmaxAPI/model/BillingentityinternalproductResponse
 * @version 1.2.0
 */
class BillingentityinternalproductResponse {
    /**
     * Constructs a new <code>BillingentityinternalproductResponse</code>.
     * A Billingentityinternalproduct Object
     * @alias module:eZmaxAPI/model/BillingentityinternalproductResponse
    ...
    /**
     * Constructs a <code>BillingentityinternalproductResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/BillingentityinternalproductResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/BillingentityinternalproductResponse} The populated <code>BillingentityinternalproductResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BillingentityinternalproductResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BillingentityinternalproductResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BillingentityinternalproductResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BillingentityinternalproductResponse.RequiredProperties) {
...
BillingentityinternalproductResponse.RequiredProperties = ["pkiBillingentityinternalproductID", "fkiBillingentityinternalID", "sBillingentityinternalDescriptionX", "fkiEzmaxproductID", "sEzmaxproductDescriptionX", "fkiBillingentityexternalID", "sBillingentityexternalDescription"];
...
export default BillingentityinternalproductResponse;
