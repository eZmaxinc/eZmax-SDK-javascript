...
/**
 * The SystemconfigurationGetObjectV2Response model module.
 * @module eZmaxAPI/model/SystemconfigurationGetObjectV2Response
 * @version 1.1.18
 */
class SystemconfigurationGetObjectV2Response {
    ...
    /**
     * Constructs a <code>SystemconfigurationGetObjectV2Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/SystemconfigurationGetObjectV2Response} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/SystemconfigurationGetObjectV2Response} The populated <code>SystemconfigurationGetObjectV2Response</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>SystemconfigurationGetObjectV2Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SystemconfigurationGetObjectV2Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SystemconfigurationGetObjectV2Response.RequiredProperties) {
            if (!data[property]) {
 ...
 */
SystemconfigurationGetObjectV2Response.prototype['objDebugPayload'] = undefined;
...
export default SystemconfigurationGetObjectV2Response;
