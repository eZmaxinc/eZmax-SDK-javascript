...
/**
 * The EzsignfoldertypeRequestV2 model module.
 * @module eZmaxAPI/model/EzsignfoldertypeRequestV2
 * @version 1.2.0
 */
class EzsignfoldertypeRequestV2 {
    /**
     * Constructs a new <code>EzsignfoldertypeRequestV2</code>.
     * A Ezsignfoldertype Object
     * @alias module:eZmaxAPI/model/EzsignfoldertypeRequestV2
    ...
    /**
     * Constructs a <code>EzsignfoldertypeRequestV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsignfoldertypeRequestV2} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsignfoldertypeRequestV2} The populated <code>EzsignfoldertypeRequestV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsignfoldertypeRequestV2();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfoldertypeRequestV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfoldertypeRequestV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfoldertypeRequestV2.RequiredProperties) {
...
EzsignfoldertypeRequestV2.RequiredProperties = ["objEzsignfoldertypeName", "fkiBrandingID", "a_fkiUserlogintypeID", "eEzsignfoldertypePrivacylevel", "iEzsignfoldertypeArchivaldays", "eEzsignfoldertypeDisposal", "eEzsignfoldertypeCompletion", "iEzsignfoldertypeDeadlinedays", "bEzsignfoldertypeSendsignedtodocumentowner", "bEzsignfoldertypeSendsignedtofolderowner", "bEzsignfoldertypeSendsignedtocolleague", "bEzsignfoldertypeSendsummarytodocumentowner", "bEzsignfoldertypeSendsummarytofolderowner", "bEzsignfoldertypeSendsummarytocolleague", "bEzsignfoldertypeIsactive"];
...
export default EzsignfoldertypeRequestV2;
