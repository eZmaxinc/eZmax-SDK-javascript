...
class EzsignsignerResponseCompound {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignsignerResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignsignerResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignsignerResponseCompound.RequiredProperties) {
            if (!data[property]) {
...
EzsignsignerResponseCompound.RequiredProperties = ["pkiEzsignsignerID", "fkiTaxassignmentID", "fkiUserlogintypeID", "sUserlogintypeDescriptionX", "objContact"];
