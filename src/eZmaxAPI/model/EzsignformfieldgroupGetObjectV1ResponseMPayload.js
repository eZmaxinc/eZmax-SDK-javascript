...
class EzsignformfieldgroupGetObjectV1ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignformfieldgroupGetObjectV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignformfieldgroupGetObjectV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignformfieldgroupGetObjectV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
EzsignformfieldgroupGetObjectV1ResponseMPayload.RequiredProperties = ["pkiEzsignformfieldgroupID", "fkiEzsigndocumentID", "eEzsignformfieldgroupType", "eEzsignformfieldgroupSignerrequirement", "sEzsignformfieldgroupLabel", "iEzsignformfieldgroupStep", "iEzsignformfieldgroupFilledmin", "iEzsignformfieldgroupFilledmax", "bEzsignformfieldgroupReadonly", "a_objEzsignformfield", "a_objEzsignformfieldgroupsigner"];
