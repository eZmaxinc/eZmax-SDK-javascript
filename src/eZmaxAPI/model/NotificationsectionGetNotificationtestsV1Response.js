...
class NotificationsectionGetNotificationtestsV1Response {
    ...
    constructor(objDebugPayload, mPayload) { 
        ...
        NotificationsectionGetNotificationtestsV1Response.initialize(this, objDebugPayload, mPayload);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NotificationsectionGetNotificationtestsV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotificationsectionGetNotificationtestsV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotificationsectionGetNotificationtestsV1Response.RequiredProperties) {
            if (!data[property]) {
...
NotificationsectionGetNotificationtestsV1Response.RequiredProperties = ["objDebugPayload", "mPayload"];
