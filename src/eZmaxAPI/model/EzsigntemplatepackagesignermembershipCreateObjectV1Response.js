...
class EzsigntemplatepackagesignermembershipCreateObjectV1Response {
    ...
    constructor(objDebugPayload, mPayload) { 
        ...
        EzsigntemplatepackagesignermembershipCreateObjectV1Response.initialize(this, objDebugPayload, mPayload);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatepackagesignermembershipCreateObjectV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatepackagesignermembershipCreateObjectV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatepackagesignermembershipCreateObjectV1Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['mPayload']) { // data not null
          EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload.validateJSON(data['mPayload']);
        }
...
EzsigntemplatepackagesignermembershipCreateObjectV1Response.RequiredProperties = ["objDebugPayload", "mPayload"];
