...
import CommunicationexternalrecipientRequestCompound from './CommunicationexternalrecipientRequestCompound';
import CommunicationrecipientRequestCompound from './CommunicationrecipientRequestCompound';
import CommunicationreferenceRequestCompound from './CommunicationreferenceRequestCompound';
import CustomCommunicationattachmentRequest from './CustomCommunicationattachmentRequest';
...
/**
 * The CommunicationRequestCompound model module.
 * @module eZmaxAPI/model/CommunicationRequestCompound
 * @version 1.2.0
 */
class CommunicationRequestCompound {
    /**
     * Constructs a new <code>CommunicationRequestCompound</code>.
     * Request for POST /1/object/communication
     * @alias module:eZmaxAPI/model/CommunicationRequestCompound
     * @implements module:eZmaxAPI/model/CommunicationRequest
     ...
     * @param a_objCommunicationattachment {Array.<module:eZmaxAPI/model/CustomCommunicationattachmentRequest>} 
     * @param a_objCommunicationrecipient {Array.<module:eZmaxAPI/model/CommunicationrecipientRequestCompound>} 
     * @param a_objCommunicationreference {Array.<module:eZmaxAPI/model/CommunicationreferenceRequestCompound>} 
     * @param a_objCommunicationexternalrecipient {Array.<module:eZmaxAPI/model/CommunicationexternalrecipientRequestCompound>} 
     */
    constructor(eCommunicationType, tCommunicationBody, bCommunicationPrivate, a_objCommunicationattachment, a_objCommunicationrecipient, a_objCommunicationreference, a_objCommunicationexternalrecipient) { 
        CommunicationRequest.initialize(this, eCommunicationType, tCommunicationBody, bCommunicationPrivate);
        CommunicationRequestCompound.initialize(this, eCommunicationType, tCommunicationBody, bCommunicationPrivate, a_objCommunicationattachment, a_objCommunicationrecipient, a_objCommunicationreference, a_objCommunicationexternalrecipient);
    }
     ...
     */
    static initialize(obj, eCommunicationType, tCommunicationBody, bCommunicationPrivate, a_objCommunicationattachment, a_objCommunicationrecipient, a_objCommunicationreference, a_objCommunicationexternalrecipient) { 
        ...
        obj['a_objCommunicationreference'] = a_objCommunicationreference;
        obj['a_objCommunicationexternalrecipient'] = a_objCommunicationexternalrecipient;
    }

    /**
     * Constructs a <code>CommunicationRequestCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/CommunicationRequestCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/CommunicationRequestCompound} The populated <code>CommunicationRequestCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommunicationRequestCompound();
            CommunicationRequest.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('a_objCommunicationattachment')) {
                obj['a_objCommunicationattachment'] = ApiClient.convertToType(data['a_objCommunicationattachment'], [CustomCommunicationattachmentRequest]);
            }
            if (data.hasOwnProperty('a_objCommunicationrecipient')) {
                obj['a_objCommunicationrecipient'] = ApiClient.convertToType(data['a_objCommunicationrecipient'], [CommunicationrecipientRequestCompound]);
            }
            if (data.hasOwnProperty('a_objCommunicationreference')) {
                obj['a_objCommunicationreference'] = ApiClient.convertToType(data['a_objCommunicationreference'], [CommunicationreferenceRequestCompound]);
            }
            if (data.hasOwnProperty('a_objCommunicationexternalrecipient')) {
                obj['a_objCommunicationexternalrecipient'] = ApiClient.convertToType(data['a_objCommunicationexternalrecipient'], [CommunicationexternalrecipientRequestCompound]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CommunicationRequestCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommunicationRequestCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommunicationRequestCompound.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['a_objCommunicationattachment']) { // data not null
            ...
            for (const item of data['a_objCommunicationattachment']) {
                CustomCommunicationattachmentRequest.validateJSON(item);
            };
        }
        if (data['a_objCommunicationrecipient']) { // data not null
            ...
            for (const item of data['a_objCommunicationrecipient']) {
                CommunicationrecipientRequestCompound.validateJSON(item);
            };
        }
        if (data['a_objCommunicationreference']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['a_objCommunicationreference'])) {
                throw new Error("Expected the field `a_objCommunicationreference` to be an array in the JSON data but got " + data['a_objCommunicationreference']);
            }
            // validate the optional field `a_objCommunicationreference` (array)
            for (const item of data['a_objCommunicationreference']) {
                CommunicationreferenceRequestCompound.validateJSON(item);
            };
        }
        if (data['a_objCommunicationexternalrecipient']) { // data not null
            ...
            for (const item of data['a_objCommunicationexternalrecipient']) {
                CommunicationexternalrecipientRequestCompound.validateJSON(item);
            };
        }
...
/**
     ...
     * @return {module:eZmaxAPI/model/CommunicationRequestCompound.ECommunicationAttachmenttypeEnum}
     */
     ...
     * @param {module:eZmaxAPI/model/CommunicationRequestCompound.ECommunicationAttachmenttypeEnum} eCommunicationAttachmenttype How the attachment should be included in the email.   Only used if eCommunicationType is **Email**
     */
...
/**
     * @return {Array.<module:eZmaxAPI/model/CustomCommunicationattachmentRequest>}
     */
    ...
    /**
     * @param {Array.<module:eZmaxAPI/model/CustomCommunicationattachmentRequest>} a_objCommunicationattachment
     */
...
/**
     * @return {Array.<module:eZmaxAPI/model/CommunicationrecipientRequestCompound>}
     */
    ...
    /**
     * @param {Array.<module:eZmaxAPI/model/CommunicationrecipientRequestCompound>} a_objCommunicationrecipient
     */
    setAObjCommunicationrecipient(a_objCommunicationrecipient) {
        this['a_objCommunicationrecipient'] = a_objCommunicationrecipient;
    }
/**
     * @return {Array.<module:eZmaxAPI/model/CommunicationreferenceRequestCompound>}
     */
    getAObjCommunicationreference() {
        return this.a_objCommunicationreference;
    }

    /**
     * @param {Array.<module:eZmaxAPI/model/CommunicationreferenceRequestCompound>} a_objCommunicationreference
     */
    setAObjCommunicationreference(a_objCommunicationreference) {
        this['a_objCommunicationreference'] = a_objCommunicationreference;
    }
/**
     * @return {Array.<module:eZmaxAPI/model/CommunicationexternalrecipientRequestCompound>}
     */
    ...
    /**
     * @param {Array.<module:eZmaxAPI/model/CommunicationexternalrecipientRequestCompound>} a_objCommunicationexternalrecipient
     */
...
CommunicationRequestCompound.RequiredProperties = ["eCommunicationType", "tCommunicationBody", "bCommunicationPrivate", "a_objCommunicationattachment", "a_objCommunicationrecipient", "a_objCommunicationreference", "a_objCommunicationexternalrecipient"];

/**
 * The unique ID of the Communication.
 * @member {Number} pkiCommunicationID
 */
CommunicationRequestCompound.prototype['pkiCommunicationID'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldECommunicationImportance} eCommunicationImportance
 */
CommunicationRequestCompound.prototype['eCommunicationImportance'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldECommunicationType} eCommunicationType
 */
CommunicationRequestCompound.prototype['eCommunicationType'] = undefined;

/**
 * @member {module:eZmaxAPI/model/CustomCommunicationsenderRequest} objCommunicationsender
 */
CommunicationRequestCompound.prototype['objCommunicationsender'] = undefined;

/**
 * The subject of the Communication
 * @member {String} sCommunicationSubject
 */
CommunicationRequestCompound.prototype['sCommunicationSubject'] = undefined;

/**
 * The Body of the Communication
 * @member {String} tCommunicationBody
 */
CommunicationRequestCompound.prototype['tCommunicationBody'] = undefined;

/**
 * Whether the Communication is private or not
 * @member {Boolean} bCommunicationPrivate
 */
CommunicationRequestCompound.prototype['bCommunicationPrivate'] = undefined;

/**
 * How the attachment should be included in the email.   Only used if eCommunicationType is **Email**
 * @member {module:eZmaxAPI/model/CommunicationRequestCompound.ECommunicationAttachmenttypeEnum} eCommunicationAttachmenttype
 */
CommunicationRequestCompound.prototype['eCommunicationAttachmenttype'] = undefined;
 ...
 */
CommunicationRequestCompound.prototype['iCommunicationAttachmentlinkexpiration'] = undefined;

/**
 * Whether we ask for a read receipt or not.
 * @member {Boolean} bCommunicationReadreceipt
 */
CommunicationRequestCompound.prototype['bCommunicationReadreceipt'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/CustomCommunicationattachmentRequest>} a_objCommunicationattachment
 */
CommunicationRequestCompound.prototype['a_objCommunicationattachment'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/CommunicationrecipientRequestCompound>} a_objCommunicationrecipient
 */
CommunicationRequestCompound.prototype['a_objCommunicationrecipient'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/CommunicationreferenceRequestCompound>} a_objCommunicationreference
 */
CommunicationRequestCompound.prototype['a_objCommunicationreference'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/CommunicationexternalrecipientRequestCompound>} a_objCommunicationexternalrecipient
 */
CommunicationRequestCompound.prototype['a_objCommunicationexternalrecipient'] = undefined;


// Implement CommunicationRequest interface:
/**
 * The unique ID of the Communication.
 * @member {Number} pkiCommunicationID
 */
 ...
 * @readonly
 */
CommunicationRequestCompound['ECommunicationAttachmenttypeEnum'] = {
...
export default CommunicationRequestCompound;
