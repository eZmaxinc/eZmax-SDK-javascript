...
class EzsigntemplatesignerEditObjectV1Request {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatesignerEditObjectV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatesignerEditObjectV1Request</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatesignerEditObjectV1Request.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['objEzsigntemplatesigner']) { // data not null
          EzsigntemplatesignerRequestCompound.validateJSON(data['objEzsigntemplatesigner']);
        }
...
EzsigntemplatesignerEditObjectV1Request.RequiredProperties = ["objEzsigntemplatesigner"];
