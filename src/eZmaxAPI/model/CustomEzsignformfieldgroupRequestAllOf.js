...
/**
 * The CustomEzsignformfieldgroupRequestAllOf model module.
 * @module eZmaxAPI/model/CustomEzsignformfieldgroupRequestAllOf
 * @version 1.1.18
 */
class CustomEzsignformfieldgroupRequestAllOf {
    /**
     * Constructs a new <code>CustomEzsignformfieldgroupRequestAllOf</code>.
     * @alias module:eZmaxAPI/model/CustomEzsignformfieldgroupRequestAllOf
    ...
    /**
     * Constructs a <code>CustomEzsignformfieldgroupRequestAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/CustomEzsignformfieldgroupRequestAllOf} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/CustomEzsignformfieldgroupRequestAllOf} The populated <code>CustomEzsignformfieldgroupRequestAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomEzsignformfieldgroupRequestAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomEzsignformfieldgroupRequestAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomEzsignformfieldgroupRequestAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomEzsignformfieldgroupRequestAllOf.RequiredProperties) {
            if (!data[property]) {
...
CustomEzsignformfieldgroupRequestAllOf.RequiredProperties = ["a_objEzsignformfield"];
...
export default CustomEzsignformfieldgroupRequestAllOf;
