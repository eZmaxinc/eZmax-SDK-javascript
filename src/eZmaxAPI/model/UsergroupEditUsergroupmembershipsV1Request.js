...
/**
 * The UsergroupEditUsergroupmembershipsV1Request model module.
 * @module eZmaxAPI/model/UsergroupEditUsergroupmembershipsV1Request
 * @version 1.2.0
 */
class UsergroupEditUsergroupmembershipsV1Request {
    /**
     * Constructs a new <code>UsergroupEditUsergroupmembershipsV1Request</code>.
     * Request for PUT /1/object/usergroup/{pkiUsergroupID}/editUsergroupmemberships
     * @alias module:eZmaxAPI/model/UsergroupEditUsergroupmembershipsV1Request
    ...
    constructor(a_objUsergroupmembership) { 
        ...
        UsergroupEditUsergroupmembershipsV1Request.initialize(this, a_objUsergroupmembership);
    }
    ...
    /**
     * Constructs a <code>UsergroupEditUsergroupmembershipsV1Request</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UsergroupEditUsergroupmembershipsV1Request} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UsergroupEditUsergroupmembershipsV1Request} The populated <code>UsergroupEditUsergroupmembershipsV1Request</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsergroupEditUsergroupmembershipsV1Request();
    ...
    /**
     * Validates the JSON data with respect to <code>UsergroupEditUsergroupmembershipsV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsergroupEditUsergroupmembershipsV1Request</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UsergroupEditUsergroupmembershipsV1Request.RequiredProperties) {
            if (!data[property]) {
...
UsergroupEditUsergroupmembershipsV1Request.RequiredProperties = ["a_objUsergroupmembership"];

/**
 * @member {Array.<module:eZmaxAPI/model/UsergroupmembershipRequestCompound>} a_objUsergroupmembership
 */
UsergroupEditUsergroupmembershipsV1Request.prototype['a_objUsergroupmembership'] = undefined;
...
export default UsergroupEditUsergroupmembershipsV1Request;
