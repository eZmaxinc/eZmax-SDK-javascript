...
class EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload.RequiredProperties = ["pkiEzsigntemplatepackagemembershipID", "fkiEzsigntemplatepackageID", "fkiEzsigntemplateID", "iEzsigntemplatepackagemembershipOrder", "objEzsigntemplate", "a_objEzsigntemplatepackagesignermembership"];
