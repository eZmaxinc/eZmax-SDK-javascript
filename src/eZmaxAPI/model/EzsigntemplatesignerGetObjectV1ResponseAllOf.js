...
class EzsigntemplatesignerGetObjectV1ResponseAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatesignerGetObjectV1ResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatesignerGetObjectV1ResponseAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatesignerGetObjectV1ResponseAllOf.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['mPayload']) { // data not null
          EzsigntemplatesignerGetObjectV1ResponseMPayload.validateJSON(data['mPayload']);
        }
...
EzsigntemplatesignerGetObjectV1ResponseAllOf.RequiredProperties = ["mPayload"];
