...
class EzsigntemplatepackagemembershipResponseCompound {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatepackagemembershipResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatepackagemembershipResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatepackagemembershipResponseCompound.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['a_objEzsigntemplatepackagesignermembership']) { // data not null
            ...
            for (const item of data['a_objEzsigntemplatepackagesignermembership']) {
                EzsigntemplatepackagesignermembershipResponseCompound.validateJsonObject(item);
            };
        }
...
EzsigntemplatepackagemembershipResponseCompound.RequiredProperties = ["pkiEzsigntemplatepackagemembershipID", "fkiEzsigntemplatepackageID", "fkiEzsigntemplateID", "iEzsigntemplatepackagemembershipOrder", "objEzsigntemplate", "a_objEzsigntemplatepackagesignermembership"];
