...
import UsergroupmembershipResponse from './UsergroupmembershipResponse';

/**
 * The UsergroupmembershipResponseCompound model module.
 * @module eZmaxAPI/model/UsergroupmembershipResponseCompound
 * @version 1.2.0
 */
class UsergroupmembershipResponseCompound {
    /**
     * Constructs a new <code>UsergroupmembershipResponseCompound</code>.
     * A Usergroupmembership Object
     * @alias module:eZmaxAPI/model/UsergroupmembershipResponseCompound
     * @implements module:eZmaxAPI/model/UsergroupmembershipResponse
    ...
    constructor(pkiUsergroupmembershipID, fkiUsergroupID, sUsergroupNameX) { 
        ...
        UsergroupmembershipResponseCompound.initialize(this, pkiUsergroupmembershipID, fkiUsergroupID, sUsergroupNameX);
    }
    ...
    /**
     * Constructs a <code>UsergroupmembershipResponseCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UsergroupmembershipResponseCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UsergroupmembershipResponseCompound} The populated <code>UsergroupmembershipResponseCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsergroupmembershipResponseCompound();
            UsergroupmembershipResponse.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UsergroupmembershipResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsergroupmembershipResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UsergroupmembershipResponseCompound.RequiredProperties) {
...
UsergroupmembershipResponseCompound.RequiredProperties = ["pkiUsergroupmembershipID", "fkiUsergroupID", "sUsergroupNameX"];

/**
 * The unique ID of the Usergroupmembership
 * @member {Number} pkiUsergroupmembershipID
 */
UsergroupmembershipResponseCompound.prototype['pkiUsergroupmembershipID'] = undefined;

/**
 * The unique ID of the Usergroup
 * @member {Number} fkiUsergroupID
 */
UsergroupmembershipResponseCompound.prototype['fkiUsergroupID'] = undefined;

/**
 * The unique ID of the User
 * @member {Number} fkiUserID
 */
UsergroupmembershipResponseCompound.prototype['fkiUserID'] = undefined;

/**
 * The unique ID of the Usergroupexternal
 * @member {Number} fkiUsergroupexternalID
 */
UsergroupmembershipResponseCompound.prototype['fkiUsergroupexternalID'] = undefined;

/**
 * The first name of the user
 * @member {String} sUserFirstname
 */
UsergroupmembershipResponseCompound.prototype['sUserFirstname'] = undefined;

/**
 * The last name of the user
 * @member {String} sUserLastname
 */
UsergroupmembershipResponseCompound.prototype['sUserLastname'] = undefined;

/**
 * The login name of the User.
 * @member {String} sUserLoginname
 */
UsergroupmembershipResponseCompound.prototype['sUserLoginname'] = undefined;

/**
 * The email address.
 * @member {String} sEmailAddress
 */
UsergroupmembershipResponseCompound.prototype['sEmailAddress'] = undefined;

/**
 * The Name of the Usergroup in the language of the requester
 * @member {String} sUsergroupNameX
 */
UsergroupmembershipResponseCompound.prototype['sUsergroupNameX'] = undefined;

/**
 * The name of the Usergroupexternal
 * @member {String} sUsergroupexternalName
 */
UsergroupmembershipResponseCompound.prototype['sUsergroupexternalName'] = undefined;


// Implement UsergroupmembershipResponse interface:
/**
 * The unique ID of the Usergroupmembership
 * @member {Number} pkiUsergroupmembershipID
 */
UsergroupmembershipResponse.prototype['pkiUsergroupmembershipID'] = undefined;
/**
 * The unique ID of the Usergroup
 * @member {Number} fkiUsergroupID
 */
UsergroupmembershipResponse.prototype['fkiUsergroupID'] = undefined;
/**
 * The unique ID of the User
 * @member {Number} fkiUserID
 */
 ...
 * @member {String} sUserFirstname
 */
UsergroupmembershipResponse.prototype['sUserFirstname'] = undefined;
/**
 * The last name of the user
 * @member {String} sUserLastname
 */
UsergroupmembershipResponse.prototype['sUserLastname'] = undefined;
/**
 * The login name of the User.
 * @member {String} sUserLoginname
 */
UsergroupmembershipResponse.prototype['sUserLoginname'] = undefined;
/**
 * The email address.
 * @member {String} sEmailAddress
 */
UsergroupmembershipResponse.prototype['sEmailAddress'] = undefined;
/**
 * The Name of the Usergroup in the language of the requester
 * @member {String} sUsergroupNameX
 */
...
export default UsergroupmembershipResponseCompound;
