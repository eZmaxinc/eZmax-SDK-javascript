...
/**
 * The CustomEzsignformfieldRequestAllOf model module.
 * @module eZmaxAPI/model/CustomEzsignformfieldRequestAllOf
 * @version 1.1.18
 */
class CustomEzsignformfieldRequestAllOf {
    /**
     * Constructs a new <code>CustomEzsignformfieldRequestAllOf</code>.
     * @alias module:eZmaxAPI/model/CustomEzsignformfieldRequestAllOf
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CustomEzsignformfieldRequestAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/CustomEzsignformfieldRequestAllOf} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/CustomEzsignformfieldRequestAllOf} The populated <code>CustomEzsignformfieldRequestAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomEzsignformfieldRequestAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomEzsignformfieldRequestAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomEzsignformfieldRequestAllOf</code>.
     */
...
export default CustomEzsignformfieldRequestAllOf;
