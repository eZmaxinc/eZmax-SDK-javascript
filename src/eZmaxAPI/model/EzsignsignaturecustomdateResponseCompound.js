...
import EzsignsignaturecustomdateResponse from './EzsignsignaturecustomdateResponse';

/**
 * The EzsignsignaturecustomdateResponseCompound model module.
 * @module eZmaxAPI/model/EzsignsignaturecustomdateResponseCompound
 * @version 1.2.0
 */
class EzsignsignaturecustomdateResponseCompound {
    /**
     * Constructs a new <code>EzsignsignaturecustomdateResponseCompound</code>.
     * An Ezsignsignaturecustomdate Object and children to create a complete structure
     * @alias module:eZmaxAPI/model/EzsignsignaturecustomdateResponseCompound
     * @implements module:eZmaxAPI/model/EzsignsignaturecustomdateResponse
     * @param pkiEzsignsignaturecustomdateID {Number} The unique ID of the Ezsignsignaturecustomdate
     ...
     */
    constructor(pkiEzsignsignaturecustomdateID, sEzsignsignaturecustomdateFormat) { 
        EzsignsignaturecustomdateResponse.initialize(this, pkiEzsignsignaturecustomdateID, sEzsignsignaturecustomdateFormat);
        EzsignsignaturecustomdateResponseCompound.initialize(this, pkiEzsignsignaturecustomdateID, sEzsignsignaturecustomdateFormat);
    }
     ...
     */
    static initialize(obj, pkiEzsignsignaturecustomdateID, sEzsignsignaturecustomdateFormat) { 
        obj['pkiEzsignsignaturecustomdateID'] = pkiEzsignsignaturecustomdateID;
        obj['sEzsignsignaturecustomdateFormat'] = sEzsignsignaturecustomdateFormat;
    }

    /**
     * Constructs a <code>EzsignsignaturecustomdateResponseCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsignsignaturecustomdateResponseCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsignsignaturecustomdateResponseCompound} The populated <code>EzsignsignaturecustomdateResponseCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsignsignaturecustomdateResponseCompound();
            EzsignsignaturecustomdateResponse.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignsignaturecustomdateResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignsignaturecustomdateResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignsignaturecustomdateResponseCompound.RequiredProperties) {
...
EzsignsignaturecustomdateResponseCompound.RequiredProperties = ["pkiEzsignsignaturecustomdateID", "sEzsignsignaturecustomdateFormat"];

/**
 * The unique ID of the Ezsignsignaturecustomdate
 * @member {Number} pkiEzsignsignaturecustomdateID
 */
EzsignsignaturecustomdateResponseCompound.prototype['pkiEzsignsignaturecustomdateID'] = undefined;
 ...
 */
EzsignsignaturecustomdateResponseCompound.prototype['iEzsignsignaturecustomdateX'] = undefined;
 ...
 */
EzsignsignaturecustomdateResponseCompound.prototype['iEzsignsignaturecustomdateY'] = undefined;
 ...
 */
EzsignsignaturecustomdateResponseCompound.prototype['iEzsignsignaturecustomdateOffsetx'] = undefined;
 ...
 */
EzsignsignaturecustomdateResponseCompound.prototype['iEzsignsignaturecustomdateOffsety'] = undefined;
 ...
 */
EzsignsignaturecustomdateResponseCompound.prototype['sEzsignsignaturecustomdateFormat'] = undefined;


// Implement EzsignsignaturecustomdateResponse interface:
/**
 * The unique ID of the Ezsignsignaturecustomdate
 * @member {Number} pkiEzsignsignaturecustomdateID
 */
EzsignsignaturecustomdateResponse.prototype['pkiEzsignsignaturecustomdateID'] = undefined;
/**
 * The X coordinate (Horizontal) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 2 inches from the left border of the page, you would use \"200\" for the X coordinate.
 * @member {Number} iEzsignsignaturecustomdateX
 */
EzsignsignaturecustomdateResponse.prototype['iEzsignsignaturecustomdateX'] = undefined;
/**
 * The Y coordinate (Vertical) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 3 inches from the top border of the page, you would use \"300\" for the Y coordinate.
 * @member {Number} iEzsignsignaturecustomdateY
 */
EzsignsignaturecustomdateResponse.prototype['iEzsignsignaturecustomdateY'] = undefined;
/**
 * The X coordinate (Horizontal) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 2 inches from the left of the signature, you would use \"200\" for the X coordinate.
 * @member {Number} iEzsignsignaturecustomdateOffsetx
 */
EzsignsignaturecustomdateResponse.prototype['iEzsignsignaturecustomdateOffsetx'] = undefined;
/**
 * The Y coordinate (Vertical) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 3 inches from the top of the signature, you would use \"300\" for the Y coordinate.
 * @member {Number} iEzsignsignaturecustomdateOffsety
 */
EzsignsignaturecustomdateResponse.prototype['iEzsignsignaturecustomdateOffsety'] = undefined;
/**
 * The custom date format to use  You can use the codes below and they will be replaced at signature time. Text values like month and day names will be rendered in the proper language. Other text will be left as-is.  The codes examples below are based on the following datetime: Thursday, January 6, 2022 at 08:07:09 EST  For example, the format \"Signature date: {MM}/{DD}/{YYYY} {hh}:{mm}\" would become \"Signature date: 01/06/2022 08:07\"  **Year**  | Code | Example | | - | - | | {YYYY} | 2022 | | {YY} | 22 |  **Month**  | Code | Example | | - | - | | {MonthCapitalize} | Janvier | | {Month} | janvier | | {MM} | 01 | | {M} | 1 |  **Day**  | Code | Example | | - | - | | {DayCapitalize} | Jeudi | | {Day} | jeudi | | {DD} | 06 | | {D} | 6 |  **Hour**  | Code | Example | | - | - | | {hh} | 08 |  **Minute**  | Code | Example | | - | - | | {mm} | 07 |  **Second**  | Code | Example | | - | - | | {ss} | 09 |        **Timezone**  | Code | Example | | - | - | | {Z} | EST |       **Time**  | Code | Example | | - | - | | {Time} | 08:07:09 |   | {TimeZ} | 08:07:09 EST |     **Date**  | Code | Example | | - | - | | {Date} | 2022-01-06 |   | {DateText} | 1er Janvier 2022 |  **Full**  | Code | Example | | - | - | | {DateTime} | 2022-01-06 08:07:09 |   | {DateTimeZ} | 2022-01-06 08:07:09 EST | 
 * @member {String} sEzsignsignaturecustomdateFormat
 */
EzsignsignaturecustomdateResponse.prototype['sEzsignsignaturecustomdateFormat'] = undefined;




export default EzsignsignaturecustomdateResponseCompound;
