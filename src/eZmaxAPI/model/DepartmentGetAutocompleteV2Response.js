...
/**
 * The DepartmentGetAutocompleteV2Response model module.
 * @module eZmaxAPI/model/DepartmentGetAutocompleteV2Response
 * @version 1.1.18
 */
class DepartmentGetAutocompleteV2Response {
    ...
    /**
     * Constructs a <code>DepartmentGetAutocompleteV2Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/DepartmentGetAutocompleteV2Response} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/DepartmentGetAutocompleteV2Response} The populated <code>DepartmentGetAutocompleteV2Response</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>DepartmentGetAutocompleteV2Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DepartmentGetAutocompleteV2Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DepartmentGetAutocompleteV2Response.RequiredProperties) {
            if (!data[property]) {
 ...
 */
DepartmentGetAutocompleteV2Response.prototype['objDebugPayload'] = undefined;
...
export default DepartmentGetAutocompleteV2Response;
