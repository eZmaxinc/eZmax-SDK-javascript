...
/**
 * The PhoneRequestV2 model module.
 * @module eZmaxAPI/model/PhoneRequestV2
 * @version 1.2.0
 */
class PhoneRequestV2 {
    /**
     * Constructs a new <code>PhoneRequestV2</code>.
     * A Phone Object
     * @alias module:eZmaxAPI/model/PhoneRequestV2
    ...
    /**
     * Constructs a <code>PhoneRequestV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/PhoneRequestV2} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/PhoneRequestV2} The populated <code>PhoneRequestV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PhoneRequestV2();
    ...
    /**
     * Validates the JSON data with respect to <code>PhoneRequestV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PhoneRequestV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PhoneRequestV2.RequiredProperties) {
...
PhoneRequestV2.RequiredProperties = ["fkiPhonetypeID"];
