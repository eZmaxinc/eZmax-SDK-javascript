...
/**
 * The EzsigntemplatesignerResponse model module.
 * @module eZmaxAPI/model/EzsigntemplatesignerResponse
 * @version 1.1.17
 */
class EzsigntemplatesignerResponse {
    /**
     * Constructs a new <code>EzsigntemplatesignerResponse</code>.
     * A Ezsigntemplatesigner Object
     * @alias module:eZmaxAPI/model/EzsigntemplatesignerResponse
    ...
    /**
     * Constructs a <code>EzsigntemplatesignerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsigntemplatesignerResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsigntemplatesignerResponse} The populated <code>EzsigntemplatesignerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsigntemplatesignerResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatesignerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatesignerResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatesignerResponse.RequiredProperties) {
            if (!data[property]) {
...
EzsigntemplatesignerResponse.RequiredProperties = ["pkiEzsigntemplatesignerID", "fkiEzsigntemplateID", "sEzsigntemplatesignerDescription"];
...
export default EzsigntemplatesignerResponse;
