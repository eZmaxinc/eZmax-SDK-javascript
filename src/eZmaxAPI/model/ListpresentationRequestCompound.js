...
/**
 * The ListpresentationRequestCompound model module.
 * @module eZmaxAPI/model/ListpresentationRequestCompound
 * @version 1.1.7
 */
class ListpresentationRequestCompound {
    /**
     * Constructs a new <code>ListpresentationRequestCompound</code>.
     * A Listpresentation Object and children to create a complete structure
     * @alias module:eZmaxAPI/model/ListpresentationRequestCompound
    ...
    constructor(sListpresentationDescription, sListpresentationFilter, sListpresentationOrderby, a_sColumnName, iListpresentationRowMax, iListpresentationRowOffset, bListpresentationDefault) { 
        ...
        ListpresentationRequestCompound.initialize(this, sListpresentationDescription, sListpresentationFilter, sListpresentationOrderby, a_sColumnName, iListpresentationRowMax, iListpresentationRowOffset, bListpresentationDefault);
    }
    ...
    /**
     * Constructs a <code>ListpresentationRequestCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/ListpresentationRequestCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/ListpresentationRequestCompound} The populated <code>ListpresentationRequestCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListpresentationRequestCompound();
 ...
 */
ListpresentationRequestCompound.prototype['sListpresentationDescription'] = undefined;

/**
 * The filter to apply to the request to limit results.
 * @member {String} sListpresentationFilter
 */
ListpresentationRequestCompound.prototype['sListpresentationFilter'] = undefined;

/**
 * The order by the user chose
 * @member {String} sListpresentationOrderby
 */
ListpresentationRequestCompound.prototype['sListpresentationOrderby'] = undefined;

/**
 * An array of column names that the user chose to bee visible
 * @member {Array.<String>} a_sColumnName
 */
ListpresentationRequestCompound.prototype['a_sColumnName'] = undefined;

/**
 * The maximum numbers of results to be returned
 * @member {Number} iListpresentationRowMax
 */
ListpresentationRequestCompound.prototype['iListpresentationRowMax'] = undefined;
 ...
 */
ListpresentationRequestCompound.prototype['iListpresentationRowOffset'] = undefined;
 ...
 */
ListpresentationRequestCompound.prototype['bListpresentationDefault'] = undefined;
...
export default ListpresentationRequestCompound;
