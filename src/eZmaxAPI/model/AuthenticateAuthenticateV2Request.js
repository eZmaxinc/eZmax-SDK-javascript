...
class AuthenticateAuthenticateV2Request {
     ...
     */
    constructor(pksCustomerCode, sPassword) { 
        
        AuthenticateAuthenticateV2Request.initialize(this, pksCustomerCode, sPassword);
    }
     ...
     */
    static initialize(obj, pksCustomerCode, sPassword) { 
