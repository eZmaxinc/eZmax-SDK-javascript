...
/**
 * The UserResponseCompound model module.
 * @module eZmaxAPI/model/UserResponseCompound
 * @version 1.2.0
 */
class UserResponseCompound {
    /**
     * Constructs a new <code>UserResponseCompound</code>.
     * A User Object and children to create a complete structure
     * @alias module:eZmaxAPI/model/UserResponseCompound
     * @implements module:eZmaxAPI/model/UserResponse
    ...
    constructor(pkiUserID, fkiCompanyIDDefault, sCompanyNameX, fkiDepartmentIDDefault, sDepartmentNameX, fkiTimezoneID, sTimezoneName, fkiLanguageID, sLanguageNameX, objEmail, fkiBillingentityinternalID, sBillingentityinternalDescriptionX, eUserOrigin, eUserType, eUserLogintype, sUserFirstname, sUserLastname, sUserLoginname, eUserEzsignaccess, bUserIsactive, bUserChangepassword, objAudit) { 
        ...
        UserResponseCompound.initialize(this, pkiUserID, fkiCompanyIDDefault, sCompanyNameX, fkiDepartmentIDDefault, sDepartmentNameX, fkiTimezoneID, sTimezoneName, fkiLanguageID, sLanguageNameX, objEmail, fkiBillingentityinternalID, sBillingentityinternalDescriptionX, eUserOrigin, eUserType, eUserLogintype, sUserFirstname, sUserLastname, sUserLoginname, eUserEzsignaccess, bUserIsactive, bUserChangepassword, objAudit);
    }
    ...
    /**
     * Constructs a <code>UserResponseCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UserResponseCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UserResponseCompound} The populated <code>UserResponseCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserResponseCompound();
    ...
    /**
     * Validates the JSON data with respect to <code>UserResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserResponseCompound.RequiredProperties) {
...
UserResponseCompound.RequiredProperties = ["pkiUserID", "fkiCompanyIDDefault", "sCompanyNameX", "fkiDepartmentIDDefault", "sDepartmentNameX", "fkiTimezoneID", "sTimezoneName", "fkiLanguageID", "sLanguageNameX", "objEmail", "fkiBillingentityinternalID", "sBillingentityinternalDescriptionX", "eUserOrigin", "eUserType", "eUserLogintype", "sUserFirstname", "sUserLastname", "sUserLoginname", "eUserEzsignaccess", "bUserIsactive", "bUserChangepassword", "objAudit"];

/**
 * The unique ID of the User
 * @member {Number} pkiUserID
 */
UserResponseCompound.prototype['pkiUserID'] = undefined;

/**
 * The unique ID of the Agent.
 * @member {Number} fkiAgentID
 */
UserResponseCompound.prototype['fkiAgentID'] = undefined;

/**
 * The unique ID of the Broker.
 * @member {Number} fkiBrokerID
 */
UserResponseCompound.prototype['fkiBrokerID'] = undefined;

/**
 * The unique ID of the Assistant.
 * @member {Number} fkiAssistantID
 */
UserResponseCompound.prototype['fkiAssistantID'] = undefined;

/**
 * The unique ID of the Employee.
 * @member {Number} fkiEmployeeID
 */
UserResponseCompound.prototype['fkiEmployeeID'] = undefined;

/**
 * The unique ID of the Company
 * @member {Number} fkiCompanyIDDefault
 */
UserResponseCompound.prototype['fkiCompanyIDDefault'] = undefined;

/**
 * The Name of the Company in the language of the requester
 * @member {String} sCompanyNameX
 */
UserResponseCompound.prototype['sCompanyNameX'] = undefined;

/**
 * The unique ID of the Department
 * @member {Number} fkiDepartmentIDDefault
 */
UserResponseCompound.prototype['fkiDepartmentIDDefault'] = undefined;

/**
 * The Name of the Department in the language of the requester
 * @member {String} sDepartmentNameX
 */
UserResponseCompound.prototype['sDepartmentNameX'] = undefined;

/**
 * The unique ID of the Timezone
 * @member {Number} fkiTimezoneID
 */
UserResponseCompound.prototype['fkiTimezoneID'] = undefined;

/**
 * The description of the Timezone
 * @member {String} sTimezoneName
 */
UserResponseCompound.prototype['sTimezoneName'] = undefined;

/**
 * The unique ID of the Language.  Valid values:  |Value|Description| |-|-| |1|French| |2|English|
 * @member {Number} fkiLanguageID
 */
UserResponseCompound.prototype['fkiLanguageID'] = undefined;

/**
 * The Name of the Language in the language of the requester
 * @member {String} sLanguageNameX
 */
UserResponseCompound.prototype['sLanguageNameX'] = undefined;

/**
 * @member {module:eZmaxAPI/model/EmailResponseCompound} objEmail
 */
UserResponseCompound.prototype['objEmail'] = undefined;

/**
 * The unique ID of the Billingentityinternal.
 * @member {Number} fkiBillingentityinternalID
 */
UserResponseCompound.prototype['fkiBillingentityinternalID'] = undefined;

/**
 * The description of the Billingentityinternal in the language of the requester
 * @member {String} sBillingentityinternalDescriptionX
 */
UserResponseCompound.prototype['sBillingentityinternalDescriptionX'] = undefined;

/**
 * @member {module:eZmaxAPI/model/PhoneResponseCompound} objPhoneHome
 */
UserResponseCompound.prototype['objPhoneHome'] = undefined;

/**
 * @member {module:eZmaxAPI/model/PhoneResponseCompound} objPhoneSMS
 */
UserResponseCompound.prototype['objPhoneSMS'] = undefined;

/**
 * The unique ID of the Secretquestion.  Valid values:  |Value|Description| |-|-| |1|The name of the hospital in which you were born| |2|The name of your grade school| |3|The last name of your favorite teacher| |4|Your favorite sports team| |5|Your favorite TV show| |6|Your favorite movie| |7|The name of the street on which you grew up| |8|The name of your first employer| |9|Your first car| |10|Your favorite food| |11|The name of your first pet| |12|Favorite musician/band| |13|What instrument you play| |14|Your father's middle name| |15|Your mother's maiden name| |16|Name of your eldest child| |17|Your spouse's middle name| |18|Favorite restaurant| |19|Childhood nickname| |20|Favorite vacation destination| |21|Your boat's name| |22|Date of Birth (YYYY-MM-DD)| |22|Secret Code| |22|Your reference code|
 * @member {Number} fkiSecretquestionID
 */
UserResponseCompound.prototype['fkiSecretquestionID'] = undefined;

/**
 * The unique ID of the Module
 * @member {Number} fkiModuleIDForm
 */
UserResponseCompound.prototype['fkiModuleIDForm'] = undefined;

/**
 * The Name of the Module in the language of the requester
 * @member {String} sModuleNameX
 */
UserResponseCompound.prototype['sModuleNameX'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEUserOrigin} eUserOrigin
 */
UserResponseCompound.prototype['eUserOrigin'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEUserType} eUserType
 */
UserResponseCompound.prototype['eUserType'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEUserLogintype} eUserLogintype
 */
UserResponseCompound.prototype['eUserLogintype'] = undefined;

/**
 * The first name of the user
 * @member {String} sUserFirstname
 */
UserResponseCompound.prototype['sUserFirstname'] = undefined;

/**
 * The last name of the user
 * @member {String} sUserLastname
 */
UserResponseCompound.prototype['sUserLastname'] = undefined;

/**
 * The login name of the User.
 * @member {String} sUserLoginname
 */
UserResponseCompound.prototype['sUserLoginname'] = undefined;

/**
 * The job title of the user
 * @member {String} sUserJobtitle
 */
UserResponseCompound.prototype['sUserJobtitle'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEUserEzsignaccess} eUserEzsignaccess
 */
UserResponseCompound.prototype['eUserEzsignaccess'] = undefined;

/**
 * The last logon date of the User
 * @member {String} dtUserLastlogondate
 */
UserResponseCompound.prototype['dtUserLastlogondate'] = undefined;

/**
 * The date at which the User's password was last changed
 * @member {String} dtUserPasswordchanged
 */
UserResponseCompound.prototype['dtUserPasswordchanged'] = undefined;

/**
 * The eZsign prepaid expiration date
 * @member {String} dtUserEzsignprepaidexpiration
 */
UserResponseCompound.prototype['dtUserEzsignprepaidexpiration'] = undefined;

/**
 * Whether the User is active or not
 * @member {Boolean} bUserIsactive
 */
UserResponseCompound.prototype['bUserIsactive'] = undefined;
 ...
 */
UserResponseCompound.prototype['bUserValidatebyadministration'] = undefined;
...
export default UserResponseCompound;
