...
class EzsignfoldersignerassociationCreateObjectV2ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfoldersignerassociationCreateObjectV2ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfoldersignerassociationCreateObjectV2ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfoldersignerassociationCreateObjectV2ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
EzsignfoldersignerassociationCreateObjectV2ResponseMPayload.RequiredProperties = ["a_pkiEzsignfoldersignerassociationID"];
