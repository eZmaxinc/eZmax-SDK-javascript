...
/**
 * The TextstylestaticResponse model module.
 * @module eZmaxAPI/model/TextstylestaticResponse
 * @version 1.1.17
 */
class TextstylestaticResponse {
    /**
     * Constructs a new <code>TextstylestaticResponse</code>.
     * A Textstylestatic Object
     * @alias module:eZmaxAPI/model/TextstylestaticResponse
    ...
    /**
     * Constructs a <code>TextstylestaticResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/TextstylestaticResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/TextstylestaticResponse} The populated <code>TextstylestaticResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TextstylestaticResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>TextstylestaticResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TextstylestaticResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TextstylestaticResponse.RequiredProperties) {
            if (!data[property]) {
...
TextstylestaticResponse.RequiredProperties = ["fkiFontID", "bTextstylestaticBold", "bTextstylestaticUnderline", "bTextstylestaticItalic", "bTextstylestaticStrikethrough", "iTextstylestaticFontcolor", "iTextstylestaticSize"];
...
export default TextstylestaticResponse;
