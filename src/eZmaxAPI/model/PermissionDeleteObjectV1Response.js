...
class PermissionDeleteObjectV1Response {
    ...
    constructor(objDebugPayload) { 
        ...
        PermissionDeleteObjectV1Response.initialize(this, objDebugPayload);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of PermissionDeleteObjectV1Response.RequiredProperties) {
            if (!data[property]) {
...
PermissionDeleteObjectV1Response.RequiredProperties = ["objDebugPayload"];
