...
class EzsignbulksendCreateObjectV1Request {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignbulksendCreateObjectV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignbulksendCreateObjectV1Request</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignbulksendCreateObjectV1Request.RequiredProperties) {
            if (!data[property]) {
...
EzsignbulksendCreateObjectV1Request.RequiredProperties = ["a_objEzsignbulksend"];
