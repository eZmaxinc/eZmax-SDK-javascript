...
class EzsignsignatureGetObjectV1ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignsignatureGetObjectV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignsignatureGetObjectV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignsignatureGetObjectV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
EzsignsignatureGetObjectV1ResponseMPayload.RequiredProperties = ["pkiEzsignsignatureID", "fkiEzsigndocumentID", "fkiEzsignfoldersignerassociationID", "iEzsignpagePagenumber", "iEzsignsignatureX", "iEzsignsignatureY", "iEzsignsignatureStep", "eEzsignsignatureType"];
