...
class EzsignfolderCreateObjectV1Response {
    ...
    constructor(objDebugPayload, mPayload) { 
        ...
        EzsignfolderCreateObjectV1Response.initialize(this, objDebugPayload, mPayload);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfolderCreateObjectV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfolderCreateObjectV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfolderCreateObjectV1Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['mPayload']) { // data not null
          EzsignfolderCreateObjectV1ResponseMPayload.validateJSON(data['mPayload']);
        }
...
EzsignfolderCreateObjectV1Response.RequiredProperties = ["objDebugPayload", "mPayload"];
