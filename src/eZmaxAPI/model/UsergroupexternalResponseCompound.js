...
import UsergroupexternalResponse from './UsergroupexternalResponse';

/**
 * The UsergroupexternalResponseCompound model module.
 * @module eZmaxAPI/model/UsergroupexternalResponseCompound
 * @version 1.2.0
 */
class UsergroupexternalResponseCompound {
    /**
     * Constructs a new <code>UsergroupexternalResponseCompound</code>.
     * A Usergroupexternal Object
     * @alias module:eZmaxAPI/model/UsergroupexternalResponseCompound
     * @implements module:eZmaxAPI/model/UsergroupexternalResponse
    ...
    constructor(pkiUsergroupexternalID, sUsergroupexternalName, sUsergroupexternalID) { 
        ...
        UsergroupexternalResponseCompound.initialize(this, pkiUsergroupexternalID, sUsergroupexternalName, sUsergroupexternalID);
    }
    ...
    /**
     * Constructs a <code>UsergroupexternalResponseCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UsergroupexternalResponseCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UsergroupexternalResponseCompound} The populated <code>UsergroupexternalResponseCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsergroupexternalResponseCompound();
            UsergroupexternalResponse.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UsergroupexternalResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsergroupexternalResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UsergroupexternalResponseCompound.RequiredProperties) {
...
UsergroupexternalResponseCompound.RequiredProperties = ["pkiUsergroupexternalID", "sUsergroupexternalName", "sUsergroupexternalID"];

/**
 * The unique ID of the Usergroupexternal
 * @member {Number} pkiUsergroupexternalID
 */
UsergroupexternalResponseCompound.prototype['pkiUsergroupexternalID'] = undefined;

/**
 * The name of the Usergroupexternal
 * @member {String} sUsergroupexternalName
 */
UsergroupexternalResponseCompound.prototype['sUsergroupexternalName'] = undefined;

/**
 * The id of the Usergroupexternal
 * @member {String} sUsergroupexternalID
 */
UsergroupexternalResponseCompound.prototype['sUsergroupexternalID'] = undefined;


// Implement UsergroupexternalResponse interface:
/**
 * The unique ID of the Usergroupexternal
 * @member {Number} pkiUsergroupexternalID
 */
...
export default UsergroupexternalResponseCompound;
