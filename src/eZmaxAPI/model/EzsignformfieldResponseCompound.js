...
class EzsignformfieldResponseCompound {
    ...
    constructor(pkiEzsignformfieldID, iEzsignpagePagenumber, sEzsignformfieldLabel, iEzsignformfieldX, iEzsignformfieldY, iEzsignformfieldWidth, iEzsignformfieldHeight) { 
        ...
        EzsignformfieldResponseCompound.initialize(this, pkiEzsignformfieldID, iEzsignpagePagenumber, sEzsignformfieldLabel, iEzsignformfieldX, iEzsignformfieldY, iEzsignformfieldWidth, iEzsignformfieldHeight);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignformfieldResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignformfieldResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignformfieldResponseCompound.RequiredProperties) {
            if (!data[property]) {
...
EzsignformfieldResponseCompound.RequiredProperties = ["pkiEzsignformfieldID", "iEzsignpagePagenumber", "sEzsignformfieldLabel", "iEzsignformfieldX", "iEzsignformfieldY", "iEzsignformfieldWidth", "iEzsignformfieldHeight"];
 ...
 */
EzsignformfieldResponseCompound.prototype['bEzsignformfieldAutocomplete'] = undefined;
