...
class EzsignfoldersignerassociationGetInPersonLoginUrlV1Response {
    ...
    constructor(objDebugPayload, mPayload) { 
        ...
        EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.initialize(this, objDebugPayload, mPayload);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfoldersignerassociationGetInPersonLoginUrlV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfoldersignerassociationGetInPersonLoginUrlV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.RequiredProperties) {
...
EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.RequiredProperties = ["objDebugPayload", "mPayload"];
