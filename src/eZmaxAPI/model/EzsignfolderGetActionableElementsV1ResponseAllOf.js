...
class EzsignfolderGetActionableElementsV1ResponseAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfolderGetActionableElementsV1ResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfolderGetActionableElementsV1ResponseAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfolderGetActionableElementsV1ResponseAllOf.RequiredProperties) {
            if (!data[property]) {
...
EzsignfolderGetActionableElementsV1ResponseAllOf.RequiredProperties = ["mPayload"];
