...
/**
 * The EzsigntemplatesignaturecustomdateResponse model module.
 * @module eZmaxAPI/model/EzsigntemplatesignaturecustomdateResponse
 * @version 1.2.0
 */
class EzsigntemplatesignaturecustomdateResponse {
    /**
     * Constructs a new <code>EzsigntemplatesignaturecustomdateResponse</code>.
     * An Ezsigntemplatesignaturecustomdate Object
     * @alias module:eZmaxAPI/model/EzsigntemplatesignaturecustomdateResponse
     ...
     */
    constructor(pkiEzsigntemplatesignaturecustomdateID, sEzsigntemplatesignaturecustomdateFormat) { 
        
        EzsigntemplatesignaturecustomdateResponse.initialize(this, pkiEzsigntemplatesignaturecustomdateID, sEzsigntemplatesignaturecustomdateFormat);
    }
     ...
     */
    static initialize(obj, pkiEzsigntemplatesignaturecustomdateID, sEzsigntemplatesignaturecustomdateFormat) { 
    ...
    /**
     * Constructs a <code>EzsigntemplatesignaturecustomdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsigntemplatesignaturecustomdateResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsigntemplatesignaturecustomdateResponse} The populated <code>EzsigntemplatesignaturecustomdateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsigntemplatesignaturecustomdateResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatesignaturecustomdateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatesignaturecustomdateResponse</code>.
     */
...
EzsigntemplatesignaturecustomdateResponse.RequiredProperties = ["pkiEzsigntemplatesignaturecustomdateID", "sEzsigntemplatesignaturecustomdateFormat"];
 ...
 */
EzsigntemplatesignaturecustomdateResponse.prototype['iEzsigntemplatesignaturecustomdateOffsetx'] = undefined;
 ...
 */
EzsigntemplatesignaturecustomdateResponse.prototype['iEzsigntemplatesignaturecustomdateOffsety'] = undefined;
...
export default EzsigntemplatesignaturecustomdateResponse;
