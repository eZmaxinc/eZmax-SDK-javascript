...
/**
 * The EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload model module.
 * @module eZmaxAPI/model/EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload
 * @version 1.2.0
 */
class EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload {
    /**
     * Constructs a new <code>EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload</code>.
     * Payload for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getEzsignsignaturesAutomatic
     * @alias module:eZmaxAPI/model/EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload
    ...
    constructor(a_eEzsignsignatureType, a_objEzsignfolder) { 
        ...
        EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload.initialize(this, a_eEzsignsignatureType, a_objEzsignfolder);
    }
    ...
    /**
     * Constructs a <code>EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload} The populated <code>EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload.RequiredProperties = ["a_eEzsignsignatureType", "a_objEzsignfolder"];
 ...
 */
EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload.prototype['a_eEzsignsignatureType'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/CustomEzsignfolderEzsignsignaturesAutomaticResponse>} a_objEzsignfolder
 */
EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload.prototype['a_objEzsignfolder'] = undefined;
...
export default EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload;
