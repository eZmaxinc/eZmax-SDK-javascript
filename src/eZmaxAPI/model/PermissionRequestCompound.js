...
/**
 * The PermissionRequestCompound model module.
 * @module eZmaxAPI/model/PermissionRequestCompound
 * @version 1.1.18
 */
class PermissionRequestCompound {
    /**
     * Constructs a new <code>PermissionRequestCompound</code>.
     * A Permission Object and children to create a complete structure
     * @alias module:eZmaxAPI/model/PermissionRequestCompound
     * @implements module:eZmaxAPI/model/PermissionRequest
    ...
    constructor(fkiModulesectionID) { 
        ...
        PermissionRequestCompound.initialize(this, fkiModulesectionID);
    }
    ...
    /**
     * Constructs a <code>PermissionRequestCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/PermissionRequestCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/PermissionRequestCompound} The populated <code>PermissionRequestCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PermissionRequestCompound();
    ...
    /**
     * Validates the JSON data with respect to <code>PermissionRequestCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PermissionRequestCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PermissionRequestCompound.RequiredProperties) {
            if (!data[property]) {
...
PermissionRequestCompound.RequiredProperties = ["fkiModulesectionID"];

/**
 * The unique ID of the Permission
 * @member {Number} pkiPermissionID
 */
PermissionRequestCompound.prototype['pkiPermissionID'] = undefined;

/**
 * The unique ID of the User
 * @member {Number} fkiUserID
 */
PermissionRequestCompound.prototype['fkiUserID'] = undefined;

/**
 * The unique ID of the Apikey
 * @member {Number} fkiApikeyID
 */
PermissionRequestCompound.prototype['fkiApikeyID'] = undefined;

/**
 * The unique ID of the Usergroup
 * @member {Number} fkiUsergroupID
 */
PermissionRequestCompound.prototype['fkiUsergroupID'] = undefined;

/**
 * The unique ID of the Company
 * @member {Number} fkiCompanyID
 */
PermissionRequestCompound.prototype['fkiCompanyID'] = undefined;

/**
 * The unique ID of the Modulesection
 * @member {Number} fkiModulesectionID
 */
PermissionRequestCompound.prototype['fkiModulesectionID'] = undefined;
...
export default PermissionRequestCompound;
