...
class EzsigntemplatedocumentGetWordsPositionsV1Request {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatedocumentGetWordsPositionsV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatedocumentGetWordsPositionsV1Request</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatedocumentGetWordsPositionsV1Request.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['eGet'] && !(typeof data['eGet'] === 'string' || data['eGet'] instanceof String)) {
            throw new Error("Expected the field `eGet` to be a primitive type in the JSON string but got " + data['eGet']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['a_sWord'])) {
            throw new Error("Expected the field `a_sWord` to be an array in the JSON data but got " + data['a_sWord']);
        }
...
EzsigntemplatedocumentGetWordsPositionsV1Request.RequiredProperties = ["eGet", "bWordCaseSensitive"];
