...
import SystemconfigurationResponse from './SystemconfigurationResponse';

/**
 * The SystemconfigurationResponseCompound model module.
 * @module eZmaxAPI/model/SystemconfigurationResponseCompound
 * @version 1.2.0
 */
class SystemconfigurationResponseCompound {
    /**
     * Constructs a new <code>SystemconfigurationResponseCompound</code>.
     * A Systemconfiguration Object
     * @alias module:eZmaxAPI/model/SystemconfigurationResponseCompound
     * @implements module:eZmaxAPI/model/SystemconfigurationResponse
    ...
    /**
     * Constructs a <code>SystemconfigurationResponseCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/SystemconfigurationResponseCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/SystemconfigurationResponseCompound} The populated <code>SystemconfigurationResponseCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SystemconfigurationResponseCompound();
            SystemconfigurationResponse.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SystemconfigurationResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SystemconfigurationResponseCompound</code>.
     */
 ...
 */
SystemconfigurationResponseCompound.prototype['pkiSystemconfigurationID'] = undefined;

/**
 * The unique ID of the Systemconfigurationtype
 * @member {Number} fkiSystemconfigurationtypeID
 */
SystemconfigurationResponseCompound.prototype['fkiSystemconfigurationtypeID'] = undefined;

/**
 * The description of the Systemconfigurationtype in the language of the requester
 * @member {String} sSystemconfigurationtypeDescriptionX
 */
SystemconfigurationResponseCompound.prototype['sSystemconfigurationtypeDescriptionX'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldESystemconfigurationNewexternaluseraction} eSystemconfigurationNewexternaluseraction
 */
SystemconfigurationResponseCompound.prototype['eSystemconfigurationNewexternaluseraction'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldESystemconfigurationLanguage1} eSystemconfigurationLanguage1
 */
SystemconfigurationResponseCompound.prototype['eSystemconfigurationLanguage1'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldESystemconfigurationLanguage2} eSystemconfigurationLanguage2
 */
SystemconfigurationResponseCompound.prototype['eSystemconfigurationLanguage2'] = undefined;
 ...
 */
SystemconfigurationResponseCompound.prototype['bSystemconfigurationSspr'] = undefined;

/**
 * The start date where the system will be in read only
 * @member {String} dtSystemconfigurationReadonlyexpirationstart
 */
SystemconfigurationResponseCompound.prototype['dtSystemconfigurationReadonlyexpirationstart'] = undefined;

/**
 * The end date where the system will be in read only
 * @member {String} dtSystemconfigurationReadonlyexpirationend
 */
SystemconfigurationResponseCompound.prototype['dtSystemconfigurationReadonlyexpirationend'] = undefined;


// Implement SystemconfigurationResponse interface:
/**
 * The unique ID of the Systemconfiguration
 * @member {Number} pkiSystemconfigurationID
 */
...
export default SystemconfigurationResponseCompound;
