...
class CustomWebhooklogResponseAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomWebhooklogResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomWebhooklogResponseAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomWebhooklogResponseAllOf.RequiredProperties) {
            if (!data[property]) {
...
CustomWebhooklogResponseAllOf.RequiredProperties = ["dtWebhooklogDate", "tWebhooklogJson"];
