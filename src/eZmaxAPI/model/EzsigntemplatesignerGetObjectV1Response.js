...
class EzsigntemplatesignerGetObjectV1Response {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatesignerGetObjectV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatesignerGetObjectV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatesignerGetObjectV1Response.RequiredProperties) {
            if (!data[property]) {
...
EzsigntemplatesignerGetObjectV1Response.RequiredProperties = ["mPayload"];
