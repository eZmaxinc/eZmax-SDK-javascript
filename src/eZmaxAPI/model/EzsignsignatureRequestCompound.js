...
class EzsignsignatureRequestCompound {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignsignatureRequestCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignsignatureRequestCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignsignatureRequestCompound.RequiredProperties) {
            if (!data[property]) {
...
EzsignsignatureRequestCompound.RequiredProperties = ["fkiEzsignfoldersignerassociationID", "iEzsignpagePagenumber", "iEzsignsignatureX", "iEzsignsignatureY", "iEzsignsignatureStep", "eEzsignsignatureType", "fkiEzsigndocumentID"];
 ...
 * @member {Number} iEzsignsignatureMaxlength
 */
EzsignsignatureRequest.prototype['iEzsignsignatureMaxlength'] = undefined;
/**
 * @member {module:eZmaxAPI/model/EnumTextvalidation} eEzsignsignatureTextvalidation
 */
