...
/**
 * The UserstagedGetListV1Response model module.
 * @module eZmaxAPI/model/UserstagedGetListV1Response
 * @version 1.2.0
 */
class UserstagedGetListV1Response {
    ...
    /**
     * Constructs a <code>UserstagedGetListV1Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UserstagedGetListV1Response} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UserstagedGetListV1Response} The populated <code>UserstagedGetListV1Response</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>UserstagedGetListV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserstagedGetListV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserstagedGetListV1Response.RequiredProperties) {
            if (!data[property]) {
 ...
 */
UserstagedGetListV1Response.prototype['objDebugPayload'] = undefined;
...
export default UserstagedGetListV1Response;
