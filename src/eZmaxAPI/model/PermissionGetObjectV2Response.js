...
import PermissionGetObjectV2ResponseAllOf from './PermissionGetObjectV2ResponseAllOf';
...
class PermissionGetObjectV2Response {
     ...
     * @implements module:eZmaxAPI/model/PermissionGetObjectV2ResponseAllOf
     * @implements module:eZmaxAPI/model/CommonResponse
     * @param mPayload {module:eZmaxAPI/model/PermissionGetObjectV2ResponseMPayload} 
     */
    constructor(mPayload) { 
        PermissionGetObjectV2ResponseAllOf.initialize(this, mPayload);CommonResponse.initialize(this);
        PermissionGetObjectV2Response.initialize(this, mPayload);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            PermissionGetObjectV2ResponseAllOf.constructFromObject(data, obj);
...
PermissionGetObjectV2Response.RequiredProperties = ["mPayload"];
...
// Implement PermissionGetObjectV2ResponseAllOf interface:
/**
 * @member {module:eZmaxAPI/model/PermissionGetObjectV2ResponseMPayload} mPayload
 */
