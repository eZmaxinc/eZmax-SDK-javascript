...
import UsergroupdelegationResponse from './UsergroupdelegationResponse';

/**
 * The UsergroupdelegationResponseCompound model module.
 * @module eZmaxAPI/model/UsergroupdelegationResponseCompound
 * @version 1.1.18
 */
class UsergroupdelegationResponseCompound {
    /**
     * Constructs a new <code>UsergroupdelegationResponseCompound</code>.
     * A Usergroupdelegation Object
     * @alias module:eZmaxAPI/model/UsergroupdelegationResponseCompound
     * @implements module:eZmaxAPI/model/UsergroupdelegationResponse
    ...
    constructor(pkiUsergroupdelegationID, fkiUsergroupID, fkiUserID, sUserFirstname, sUserLastname, sUserLoginname, sUsergroupNameX) { 
        ...
        UsergroupdelegationResponseCompound.initialize(this, pkiUsergroupdelegationID, fkiUsergroupID, fkiUserID, sUserFirstname, sUserLastname, sUserLoginname, sUsergroupNameX);
    }
    ...
    /**
     * Constructs a <code>UsergroupdelegationResponseCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UsergroupdelegationResponseCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UsergroupdelegationResponseCompound} The populated <code>UsergroupdelegationResponseCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsergroupdelegationResponseCompound();
            UsergroupdelegationResponse.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UsergroupdelegationResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsergroupdelegationResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UsergroupdelegationResponseCompound.RequiredProperties) {
            if (!data[property]) {
...
UsergroupdelegationResponseCompound.RequiredProperties = ["pkiUsergroupdelegationID", "fkiUsergroupID", "fkiUserID", "sUserFirstname", "sUserLastname", "sUserLoginname", "sUsergroupNameX"];

/**
 * The unique ID of the Usergroupdelegation
 * @member {Number} pkiUsergroupdelegationID
 */
UsergroupdelegationResponseCompound.prototype['pkiUsergroupdelegationID'] = undefined;

/**
 * The unique ID of the Usergroup
 * @member {Number} fkiUsergroupID
 */
UsergroupdelegationResponseCompound.prototype['fkiUsergroupID'] = undefined;

/**
 * The unique ID of the User
 * @member {Number} fkiUserID
 */
UsergroupdelegationResponseCompound.prototype['fkiUserID'] = undefined;

/**
 * The first name of the user
 * @member {String} sUserFirstname
 */
UsergroupdelegationResponseCompound.prototype['sUserFirstname'] = undefined;

/**
 * The last name of the user
 * @member {String} sUserLastname
 */
UsergroupdelegationResponseCompound.prototype['sUserLastname'] = undefined;

/**
 * The login name of the User.
 * @member {String} sUserLoginname
 */
UsergroupdelegationResponseCompound.prototype['sUserLoginname'] = undefined;

/**
 * The email address.
 * @member {String} sEmailAddress
 */
UsergroupdelegationResponseCompound.prototype['sEmailAddress'] = undefined;

/**
 * The Name of the Usergroup in the language of the requester
 * @member {String} sUsergroupNameX
 */
UsergroupdelegationResponseCompound.prototype['sUsergroupNameX'] = undefined;


// Implement UsergroupdelegationResponse interface:
/**
 * The unique ID of the Usergroupdelegation
 * @member {Number} pkiUsergroupdelegationID
 */
...
export default UsergroupdelegationResponseCompound;
