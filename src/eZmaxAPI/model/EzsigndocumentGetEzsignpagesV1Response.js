...
class EzsigndocumentGetEzsignpagesV1Response {
    ...
    constructor(objDebugPayload, mPayload) { 
        ...
        EzsigndocumentGetEzsignpagesV1Response.initialize(this, objDebugPayload, mPayload);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigndocumentGetEzsignpagesV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigndocumentGetEzsignpagesV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigndocumentGetEzsignpagesV1Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['mPayload']) { // data not null
          EzsigndocumentGetEzsignpagesV1ResponseMPayload.validateJSON(data['mPayload']);
        }
...
EzsigndocumentGetEzsignpagesV1Response.RequiredProperties = ["objDebugPayload", "mPayload"];
