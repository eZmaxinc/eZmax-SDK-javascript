...
/**
 * The PaymenttermResponse model module.
 * @module eZmaxAPI/model/PaymenttermResponse
 * @version 1.2.0
 */
class PaymenttermResponse {
    /**
     * Constructs a new <code>PaymenttermResponse</code>.
     * A Paymentterm Object
     * @alias module:eZmaxAPI/model/PaymenttermResponse
    ...
    /**
     * Constructs a <code>PaymenttermResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/PaymenttermResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/PaymenttermResponse} The populated <code>PaymenttermResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymenttermResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymenttermResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymenttermResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymenttermResponse.RequiredProperties) {
...
PaymenttermResponse.RequiredProperties = ["pkiPaymenttermID", "sPaymenttermCode", "ePaymenttermType", "iPaymenttermDay", "objPaymenttermDescription", "bPaymenttermIsactive", "objAudit"];
...
export default PaymenttermResponse;
