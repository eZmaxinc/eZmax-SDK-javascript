...
class EzsignbulksenddocumentmappingGetObjectV1ResponseAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignbulksenddocumentmappingGetObjectV1ResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignbulksenddocumentmappingGetObjectV1ResponseAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignbulksenddocumentmappingGetObjectV1ResponseAllOf.RequiredProperties) {
            if (!data[property]) {
...
EzsignbulksenddocumentmappingGetObjectV1ResponseAllOf.RequiredProperties = ["mPayload"];
