...
class EzsignformfieldgroupGetObjectV2ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignformfieldgroupGetObjectV2ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignformfieldgroupGetObjectV2ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignformfieldgroupGetObjectV2ResponseMPayload.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `objEzsignformfieldgroup`
        if (data['objEzsignformfieldgroup']) { // data not null
          EzsignformfieldgroupResponseCompound.validateJSON(data['objEzsignformfieldgroup']);
        }
...
EzsignformfieldgroupGetObjectV2ResponseMPayload.RequiredProperties = ["objEzsignformfieldgroup"];
