...
class MultilingualApikeyDescription {
    ...
    /**
     * Validates the JSON data with respect to <code>MultilingualApikeyDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MultilingualApikeyDescription</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['sApikeyDescription1'] && !(typeof data['sApikeyDescription1'] === 'string' || data['sApikeyDescription1'] instanceof String)) {
            throw new Error("Expected the field `sApikeyDescription1` to be a primitive type in the JSON string but got " + data['sApikeyDescription1']);
        }
        // ensure the json data is a string
        if (data['sApikeyDescription2'] && !(typeof data['sApikeyDescription2'] === 'string' || data['sApikeyDescription2'] instanceof String)) {
            throw new Error("Expected the field `sApikeyDescription2` to be a primitive type in the JSON string but got " + data['sApikeyDescription2']);
        }
