...
class EzsignfoldersignerassociationCreateObjectV1Request {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfoldersignerassociationCreateObjectV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfoldersignerassociationCreateObjectV1Request</code>.
     */
    static validateJSON(data) {
        // validate the optional field `objEzsignfoldersignerassociation`
        if (data['objEzsignfoldersignerassociation']) { // data not null
          EzsignfoldersignerassociationRequest.validateJSON(data['objEzsignfoldersignerassociation']);
        }
        // validate the optional field `objEzsignfoldersignerassociationCompound`
        if (data['objEzsignfoldersignerassociationCompound']) { // data not null
          EzsignfoldersignerassociationRequestCompound.validateJSON(data['objEzsignfoldersignerassociationCompound']);
        }
