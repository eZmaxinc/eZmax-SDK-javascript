...
class CustomAutocompleteElementResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomAutocompleteElementResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomAutocompleteElementResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomAutocompleteElementResponse.RequiredProperties) {
            if (!data[property]) {
...
CustomAutocompleteElementResponse.RequiredProperties = ["sCategory", "sLabel", "sValue", "bActive"];
