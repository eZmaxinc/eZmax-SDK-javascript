...
/**
 * The SsprUnlockAccountV1Request model module.
 * @module eZmaxAPI/model/SsprUnlockAccountV1Request
 * @version 1.0.31
 */
class SsprUnlockAccountV1Request {
    /**
     * Constructs a new <code>SsprUnlockAccountV1Request</code>.
     * Request for the /1/module/sspr/unlockAccount API Request
     * @alias module:eZmaxAPI/model/SsprUnlockAccountV1Request
    ...
    constructor(pksCustomerCode, fkiLanguageID, eUserTypeSSPR, binUserSSPRtoken) { 
        ...
        SsprUnlockAccountV1Request.initialize(this, pksCustomerCode, fkiLanguageID, eUserTypeSSPR, binUserSSPRtoken);
    }
    ...
    /**
     * Constructs a <code>SsprUnlockAccountV1Request</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/SsprUnlockAccountV1Request} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/SsprUnlockAccountV1Request} The populated <code>SsprUnlockAccountV1Request</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SsprUnlockAccountV1Request();
 ...
 */
SsprUnlockAccountV1Request.prototype['pksCustomerCode'] = undefined;

/**
 * The unique ID of the Language.  Valid values:  |Value|Description| |-|-| |1|French| |2|English|
 * @member {Number} fkiLanguageID
 */
SsprUnlockAccountV1Request.prototype['fkiLanguageID'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEUserTypeSSPR} eUserTypeSSPR
 */
SsprUnlockAccountV1Request.prototype['eUserTypeSSPR'] = undefined;

/**
 * The email address.
 * @member {String} sEmailAddress
 */
SsprUnlockAccountV1Request.prototype['sEmailAddress'] = undefined;

/**
 * The Login name of the User.
 * @member {String} sUserLoginname
 */
SsprUnlockAccountV1Request.prototype['sUserLoginname'] = undefined;

/**
 * Hex Encoded Secret SSPR token
 * @member {String} binUserSSPRtoken
 */
SsprUnlockAccountV1Request.prototype['binUserSSPRtoken'] = undefined;
...
export default SsprUnlockAccountV1Request;
