...
class EzmaxinvoicingGetAutocompleteV2ResponseAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>EzmaxinvoicingGetAutocompleteV2ResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzmaxinvoicingGetAutocompleteV2ResponseAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzmaxinvoicingGetAutocompleteV2ResponseAllOf.RequiredProperties) {
            if (!data[property]) {
...
EzmaxinvoicingGetAutocompleteV2ResponseAllOf.RequiredProperties = ["mPayload"];
