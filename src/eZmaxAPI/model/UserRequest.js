 ...
 * @module eZmaxAPI/model/UserRequest
 * @version 1.2.0
 */
class UserRequest {
    /**
     ...
     * A User Object
     * @alias module:eZmaxAPI/model/UserRequest
     ...
     * @param {module:eZmaxAPI/model/UserRequest} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UserRequest} The populated <code>UserRequest</code> instance.
     */
...
UserRequest.RequiredProperties = ["fkiCompanyIDDefault", "fkiDepartmentIDDefault", "fkiTimezoneID", "fkiLanguageID", "objEmail", "fkiBillingentityinternalID", "eUserType", "eUserLogintype", "sUserFirstname", "sUserLastname", "sUserLoginname", "eUserEzsignaccess", "bUserIsactive"];
