...
import EzsignfoldertypeResponseV3 from './EzsignfoldertypeResponseV3';
...
/**
 * The EzsignfoldertypeResponseCompoundV3 model module.
 * @module eZmaxAPI/model/EzsignfoldertypeResponseCompoundV3
 * @version 1.2.0
 */
class EzsignfoldertypeResponseCompoundV3 {
    /**
     * Constructs a new <code>EzsignfoldertypeResponseCompoundV3</code>.
     * A Ezsignfoldertype Object
     * @alias module:eZmaxAPI/model/EzsignfoldertypeResponseCompoundV3
     * @implements module:eZmaxAPI/model/EzsignfoldertypeResponseV3
    ...
    constructor(pkiEzsignfoldertypeID, objEzsignfoldertypeName, fkiBrandingID, sBrandingDescriptionX, eEzsignfoldertypePrivacylevel, iEzsignfoldertypeArchivaldays, eEzsignfoldertypeDisposal, eEzsignfoldertypeCompletion, iEzsignfoldertypeDeadlinedays, bEzsignfoldertypeSendsignedtodocumentowner, bEzsignfoldertypeSendsignedtofolderowner, bEzsignfoldertypeSendsignedtocolleague, bEzsignfoldertypeSendsummarytodocumentowner, bEzsignfoldertypeSendsummarytofolderowner, bEzsignfoldertypeSendsummarytocolleague, bEzsignfoldertypeIsactive, a_objUserlogintype) { 
        ...
        EzsignfoldertypeResponseCompoundV3.initialize(this, pkiEzsignfoldertypeID, objEzsignfoldertypeName, fkiBrandingID, sBrandingDescriptionX, eEzsignfoldertypePrivacylevel, iEzsignfoldertypeArchivaldays, eEzsignfoldertypeDisposal, eEzsignfoldertypeCompletion, iEzsignfoldertypeDeadlinedays, bEzsignfoldertypeSendsignedtodocumentowner, bEzsignfoldertypeSendsignedtofolderowner, bEzsignfoldertypeSendsignedtocolleague, bEzsignfoldertypeSendsummarytodocumentowner, bEzsignfoldertypeSendsummarytofolderowner, bEzsignfoldertypeSendsummarytocolleague, bEzsignfoldertypeIsactive, a_objUserlogintype);
    }
    ...
    /**
     * Constructs a <code>EzsignfoldertypeResponseCompoundV3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsignfoldertypeResponseCompoundV3} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsignfoldertypeResponseCompoundV3} The populated <code>EzsignfoldertypeResponseCompoundV3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsignfoldertypeResponseCompoundV3();
            EzsignfoldertypeResponseV3.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfoldertypeResponseCompoundV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfoldertypeResponseCompoundV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfoldertypeResponseCompoundV3.RequiredProperties) {
...
EzsignfoldertypeResponseCompoundV3.RequiredProperties = ["pkiEzsignfoldertypeID", "objEzsignfoldertypeName", "fkiBrandingID", "sBrandingDescriptionX", "eEzsignfoldertypePrivacylevel", "iEzsignfoldertypeArchivaldays", "eEzsignfoldertypeDisposal", "eEzsignfoldertypeCompletion", "iEzsignfoldertypeDeadlinedays", "bEzsignfoldertypeSendsignedtodocumentowner", "bEzsignfoldertypeSendsignedtofolderowner", "bEzsignfoldertypeSendsignedtocolleague", "bEzsignfoldertypeSendsummarytodocumentowner", "bEzsignfoldertypeSendsummarytofolderowner", "bEzsignfoldertypeSendsummarytocolleague", "bEzsignfoldertypeIsactive", "a_objUserlogintype"];

/**
 * The unique ID of the Ezsignfoldertype.
 * @member {Number} pkiEzsignfoldertypeID
 */
EzsignfoldertypeResponseCompoundV3.prototype['pkiEzsignfoldertypeID'] = undefined;

/**
 * @member {module:eZmaxAPI/model/MultilingualEzsignfoldertypeName} objEzsignfoldertypeName
 */
EzsignfoldertypeResponseCompoundV3.prototype['objEzsignfoldertypeName'] = undefined;

/**
 * The unique ID of the Branding
 * @member {Number} fkiBrandingID
 */
EzsignfoldertypeResponseCompoundV3.prototype['fkiBrandingID'] = undefined;

/**
 * The unique ID of the Billingentityinternal.
 * @member {Number} fkiBillingentityinternalID
 */
EzsignfoldertypeResponseCompoundV3.prototype['fkiBillingentityinternalID'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['fkiEzsigntsarequirementID'] = undefined;

/**
 * The Description of the Branding in the language of the requester
 * @member {String} sBrandingDescriptionX
 */
EzsignfoldertypeResponseCompoundV3.prototype['sBrandingDescriptionX'] = undefined;

/**
 * The description of the Billingentityinternal in the language of the requester
 * @member {String} sBillingentityinternalDescriptionX
 */
EzsignfoldertypeResponseCompoundV3.prototype['sBillingentityinternalDescriptionX'] = undefined;

/**
 * The description of the Ezsigntsarequirement in the language of the requester
 * @member {String} sEzsigntsarequirementDescriptionX
 */
EzsignfoldertypeResponseCompoundV3.prototype['sEzsigntsarequirementDescriptionX'] = undefined;

/**
 * The email address.
 * @member {String} sEmailAddressSigned
 */
EzsignfoldertypeResponseCompoundV3.prototype['sEmailAddressSigned'] = undefined;

/**
 * The email address.
 * @member {String} sEmailAddressSummary
 */
EzsignfoldertypeResponseCompoundV3.prototype['sEmailAddressSummary'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEEzsignfoldertypePrivacylevel} eEzsignfoldertypePrivacylevel
 */
EzsignfoldertypeResponseCompoundV3.prototype['eEzsignfoldertypePrivacylevel'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEEzsignfoldertypeSendreminderfrequency} eEzsignfoldertypeSendreminderfrequency
 */
EzsignfoldertypeResponseCompoundV3.prototype['eEzsignfoldertypeSendreminderfrequency'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['iEzsignfoldertypeArchivaldays'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEEzsignfoldertypeDisposal} eEzsignfoldertypeDisposal
 */
EzsignfoldertypeResponseCompoundV3.prototype['eEzsignfoldertypeDisposal'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEEzsignfoldertypeCompletion} eEzsignfoldertypeCompletion
 */
EzsignfoldertypeResponseCompoundV3.prototype['eEzsignfoldertypeCompletion'] = undefined;

/**
 * The number of days after the archival before the disposal of the Ezsignfolder
 * @member {Number} iEzsignfoldertypeDisposaldays
 */
EzsignfoldertypeResponseCompoundV3.prototype['iEzsignfoldertypeDisposaldays'] = undefined;

/**
 * The number of days to get all Ezsignsignatures
 * @member {Number} iEzsignfoldertypeDeadlinedays
 */
EzsignfoldertypeResponseCompoundV3.prototype['iEzsignfoldertypeDeadlinedays'] = undefined;

/**
 * Wheter if delegation of signature is allowed to another user or not
 * @member {Boolean} bEzsignfoldertypeDelegate
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeDelegate'] = undefined;

/**
 * Wheter if creating a new Discussion is allowed or not
 * @member {Boolean} bEzsignfoldertypeDiscussion
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeDiscussion'] = undefined;

/**
 * Wheter if Reassignment of signature is allowed by a signatory to another signatory or not
 * @member {Boolean} bEzsignfoldertypeReassignezsignsigner
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeReassignezsignsigner'] = undefined;

/**
 * Wheter if Reassignment of signature is allowed by a user to a signatory or another user or not
 * @member {Boolean} bEzsignfoldertypeReassignuser
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeReassignuser'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsignedtoezsignsigner'] = undefined;

/**
 * Whether we send an email to User who signed when document is completed
 * @member {Boolean} bEzsignfoldertypeSendsignedtouser
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsignedtouser'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendattachmentezsignsigner'] = undefined;

/**
 * Whether we send the proof in the email to Ezsignsigner
 * @member {Boolean} bEzsignfoldertypeSendproofezsignsigner
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendproofezsignsigner'] = undefined;

/**
 * Whether we send the Ezsigndocument in the email to User
 * @member {Boolean} bEzsignfoldertypeSendattachmentuser
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendattachmentuser'] = undefined;

/**
 * Whether we send the proof in the email to User
 * @member {Boolean} bEzsignfoldertypeSendproofuser
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendproofuser'] = undefined;

/**
 * Whether we send the proof in the email to external recipient
 * @member {Boolean} bEzsignfoldertypeSendproofemail
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendproofemail'] = undefined;

/**
 * Whether we allow the Ezsigndocument to be downloaded by an Ezsignsigner
 * @member {Boolean} bEzsignfoldertypeAllowdownloadattachmentezsignsigner
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeAllowdownloadattachmentezsignsigner'] = undefined;

/**
 * Whether we allow the proof to be downloaded by an Ezsignsigner
 * @member {Boolean} bEzsignfoldertypeAllowdownloadproofezsignsigner
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeAllowdownloadproofezsignsigner'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendproofreceivealldocument'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsignedtodocumentowner'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsignedtofolderowner'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsignedtofullgroup'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsignedtolimitedgroup'] = undefined;

/**
 * Whether we send the signed Ezsigndocument to the colleagues
 * @member {Boolean} bEzsignfoldertypeSendsignedtocolleague
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsignedtocolleague'] = undefined;

/**
 * Whether we send the summary to the Ezsigndocument's owner
 * @member {Boolean} bEzsignfoldertypeSendsummarytodocumentowner
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsummarytodocumentowner'] = undefined;

/**
 * Whether we send the summary to the Ezsignfolder's owner
 * @member {Boolean} bEzsignfoldertypeSendsummarytofolderowner
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsummarytofolderowner'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsummarytofullgroup'] = undefined;
 ...
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsummarytolimitedgroup'] = undefined;

/**
 * Whether we send the summary to the colleagues
 * @member {Boolean} bEzsignfoldertypeSendsummarytocolleague
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeSendsummarytocolleague'] = undefined;

/**
 * Whether the Ezsignfoldertype is active or not
 * @member {Boolean} bEzsignfoldertypeIsactive
 */
EzsignfoldertypeResponseCompoundV3.prototype['bEzsignfoldertypeIsactive'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/UserlogintypeResponse>} a_objUserlogintype
 */
EzsignfoldertypeResponseCompoundV3.prototype['a_objUserlogintype'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/UsergroupResponse>} a_objUsergroupAll
 */
EzsignfoldertypeResponseCompoundV3.prototype['a_objUsergroupAll'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/UsergroupResponse>} a_objUsergroupRestricted
 */
EzsignfoldertypeResponseCompoundV3.prototype['a_objUsergroupRestricted'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/UsergroupResponse>} a_objUsergroupTemplate
 */
EzsignfoldertypeResponseCompoundV3.prototype['a_objUsergroupTemplate'] = undefined;

/**
 * @member {Array.<Number>} a_fkiUserIDSigned
 */
EzsignfoldertypeResponseCompoundV3.prototype['a_fkiUserIDSigned'] = undefined;

/**
 * @member {Array.<Number>} a_fkiUserIDSummary
 */
EzsignfoldertypeResponseCompoundV3.prototype['a_fkiUserIDSummary'] = undefined;


// Implement EzsignfoldertypeResponseV3 interface:
/**
 * The unique ID of the Ezsignfoldertype.
 * @member {Number} pkiEzsignfoldertypeID
 */
...
export default EzsignfoldertypeResponseCompoundV3;
