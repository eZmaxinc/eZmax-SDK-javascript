...
class CommonResponseFilter {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('a_AutoTypeHaving')) {
                obj['a_AutoTypeHaving'] = ApiClient.convertToType(data['a_AutoTypeHaving'], {'String': 'String'});
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CommonResponseFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonResponseFilter</code>.
     */
...
/**
     * Returns List of computed filters that can be used in *sFilter* (Automatic types)
     * @return {Object.<String, String>}
     */
    getAAutoTypeHaving() {
        return this.a_AutoTypeHaving;
    }

    /**
     * Sets List of computed filters that can be used in *sFilter* (Automatic types)
     * @param {Object.<String, String>} a_AutoTypeHaving List of computed filters that can be used in *sFilter* (Automatic types)
     */
    setAAutoTypeHaving(a_AutoTypeHaving) {
        this['a_AutoTypeHaving'] = a_AutoTypeHaving;
    }
/**
 ...
 * @member {Object.<String, String>} a_AutoTypeHaving
 */
CommonResponseFilter.prototype['a_AutoTypeHaving'] = undefined;
