...
class ActivesessionGetCurrentV1ResponseMPayload {
     ...
     */
    constructor(sCustomerCode, eActivesessionSessiontype, fkiLanguageID, sCompanyNameX, sDepartmentNameX, a_RegisteredModules, a_Permissions) { 
        
        ActivesessionGetCurrentV1ResponseMPayload.initialize(this, sCustomerCode, eActivesessionSessiontype, fkiLanguageID, sCompanyNameX, sDepartmentNameX, a_RegisteredModules, a_Permissions);
    }
     ...
     */
    static initialize(obj, sCustomerCode, eActivesessionSessiontype, fkiLanguageID, sCompanyNameX, sDepartmentNameX, a_RegisteredModules, a_Permissions) { 
