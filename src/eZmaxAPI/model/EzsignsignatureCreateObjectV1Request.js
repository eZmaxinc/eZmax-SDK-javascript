...
class EzsignsignatureCreateObjectV1Request {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignsignatureCreateObjectV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignsignatureCreateObjectV1Request</code>.
     */
    static validateJSON(data) {
        // validate the optional field `objEzsignsignature`
        if (data['objEzsignsignature']) { // data not null
          EzsignsignatureRequest.validateJSON(data['objEzsignsignature']);
        }
        // validate the optional field `objEzsignsignatureCompound`
        if (data['objEzsignsignatureCompound']) { // data not null
          EzsignsignatureRequestCompound.validateJSON(data['objEzsignsignatureCompound']);
        }
