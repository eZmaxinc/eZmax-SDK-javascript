...
/**
 * The UsergroupmembershipResponse model module.
 * @module eZmaxAPI/model/UsergroupmembershipResponse
 * @version 1.2.0
 */
class UsergroupmembershipResponse {
    /**
     * Constructs a new <code>UsergroupmembershipResponse</code>.
    ...
    /**
     * Constructs a <code>UsergroupmembershipResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UsergroupmembershipResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UsergroupmembershipResponse} The populated <code>UsergroupmembershipResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsergroupmembershipResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UsergroupmembershipResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsergroupmembershipResponse</code>.
     */
...
export default UsergroupmembershipResponse;
