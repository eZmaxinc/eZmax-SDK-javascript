...
class EzsignfolderGetEzsignfoldersignerassociationsV1ResponseAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfolderGetEzsignfoldersignerassociationsV1ResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfolderGetEzsignfoldersignerassociationsV1ResponseAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfolderGetEzsignfoldersignerassociationsV1ResponseAllOf.RequiredProperties) {
            if (!data[property]) {
...
EzsignfolderGetEzsignfoldersignerassociationsV1ResponseAllOf.RequiredProperties = ["mPayload"];
