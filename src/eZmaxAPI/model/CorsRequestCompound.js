...
/**
 * The CorsRequestCompound model module.
 * @module eZmaxAPI/model/CorsRequestCompound
 * @version 1.1.18
 */
class CorsRequestCompound {
    /**
     * Constructs a new <code>CorsRequestCompound</code>.
     * A Cors Object and children
     * @alias module:eZmaxAPI/model/CorsRequestCompound
     * @implements module:eZmaxAPI/model/CorsRequest
    ...
    constructor(fkiApikeyID, sCorsEntryurl) { 
        ...
        CorsRequestCompound.initialize(this, fkiApikeyID, sCorsEntryurl);
    }
    ...
    /**
     * Constructs a <code>CorsRequestCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/CorsRequestCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/CorsRequestCompound} The populated <code>CorsRequestCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CorsRequestCompound();
            CorsRequest.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CorsRequestCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CorsRequestCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CorsRequestCompound.RequiredProperties) {
            if (!data[property]) {
...
CorsRequestCompound.RequiredProperties = ["fkiApikeyID", "sCorsEntryurl"];

/**
 * The unique ID of the Cors
 * @member {Number} pkiCorsID
 */
CorsRequestCompound.prototype['pkiCorsID'] = undefined;

/**
 * The unique ID of the Apikey
 * @member {Number} fkiApikeyID
 */
CorsRequestCompound.prototype['fkiApikeyID'] = undefined;

/**
 * The entryurl of the Cors
 * @member {String} sCorsEntryurl
 */
CorsRequestCompound.prototype['sCorsEntryurl'] = undefined;


// Implement CorsRequest interface:
/**
 * The unique ID of the Cors
 * @member {Number} pkiCorsID
 */
...
export default CorsRequestCompound;
