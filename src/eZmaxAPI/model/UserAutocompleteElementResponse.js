...
class UserAutocompleteElementResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>UserAutocompleteElementResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserAutocompleteElementResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserAutocompleteElementResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['sUserName'] && !(typeof data['sUserName'] === 'string' || data['sUserName'] instanceof String)) {
            throw new Error("Expected the field `sUserName` to be a primitive type in the JSON string but got " + data['sUserName']);
        }
...
UserAutocompleteElementResponse.RequiredProperties = ["eUserType", "sUserName", "pkiUserID", "bUserIsactive"];
