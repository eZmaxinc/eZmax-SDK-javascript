...
/**
 * The WebhookEzsignSignatureSigned model module.
 * @module eZmaxAPI/model/WebhookEzsignSignatureSigned
 * @version 1.2.0
 */
class WebhookEzsignSignatureSigned {
    /**
     * Constructs a new <code>WebhookEzsignSignatureSigned</code>.
     * This is the base Webhook object
     * @alias module:eZmaxAPI/model/WebhookEzsignSignatureSigned
     ...
     * @param objEzsignsignature {module:eZmaxAPI/model/EzsignsignatureResponse} 
     */
    constructor(objWebhook, a_objAttempt, objEzsignsignature) { 
        CommonWebhook.initialize(this, objWebhook, a_objAttempt);
        WebhookEzsignSignatureSigned.initialize(this, objWebhook, a_objAttempt, objEzsignsignature);
    }
     ...
     */
    static initialize(obj, objWebhook, a_objAttempt, objEzsignsignature) { 
    ...
    /**
     * Constructs a <code>WebhookEzsignSignatureSigned</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/WebhookEzsignSignatureSigned} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/WebhookEzsignSignatureSigned} The populated <code>WebhookEzsignSignatureSigned</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookEzsignSignatureSigned();
            ...
            if (data.hasOwnProperty('objEzsignsignature')) {
                obj['objEzsignsignature'] = EzsignsignatureResponse.constructFromObject(data['objEzsignsignature']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookEzsignSignatureSigned</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookEzsignSignatureSigned</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookEzsignSignatureSigned.RequiredProperties) {
        ...
        if (data['objEzsignsignature']) { // data not null
          EzsignsignatureResponse.validateJSON(data['objEzsignsignature']);
        }
...
/**
     * @return {module:eZmaxAPI/model/EzsignsignatureResponse}
     */
    ...
    /**
     * @param {module:eZmaxAPI/model/EzsignsignatureResponse} objEzsignsignature
     */
...
WebhookEzsignSignatureSigned.RequiredProperties = ["objWebhook", "a_objAttempt", "objEzsignsignature"];

/**
 * @member {module:eZmaxAPI/model/CustomWebhookResponse} objWebhook
 */
WebhookEzsignSignatureSigned.prototype['objWebhook'] = undefined;

/**
 * An array containing details of previous attempts that were made to deliver the message. The array is empty if it's the first attempt.
 * @member {Array.<module:eZmaxAPI/model/AttemptResponseCompound>} a_objAttempt
 */
WebhookEzsignSignatureSigned.prototype['a_objAttempt'] = undefined;

/**
 * @member {module:eZmaxAPI/model/EzsignsignatureResponse} objEzsignsignature
 */
WebhookEzsignSignatureSigned.prototype['objEzsignsignature'] = undefined;
...
export default WebhookEzsignSignatureSigned;
