...
class EzmaxinvoicinguserResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>EzmaxinvoicinguserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzmaxinvoicinguserResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzmaxinvoicinguserResponse.RequiredProperties) {
            if (!data[property]) {
...
EzmaxinvoicinguserResponse.RequiredProperties = ["fkiBillingentityinternalID", "sBillingentityinternalDescriptionX", "fkiUserID", "iEzmaxinvoicinguserEzsigndocument", "bEzmaxinvoicinguserEzsignaccount", "bEzmaxinvoicinguserBillableezsign", "eEzmaxinvoicinguserVariationezsign"];
