...
/**
 * The EzsigntemplateRequest model module.
 * @module eZmaxAPI/model/EzsigntemplateRequest
 * @version 1.2.0
 */
class EzsigntemplateRequest {
    /**
     * Constructs a new <code>EzsigntemplateRequest</code>.
     * A Ezsigntemplate Object
     * @alias module:eZmaxAPI/model/EzsigntemplateRequest
    ...
    /**
     * Constructs a <code>EzsigntemplateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsigntemplateRequest} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsigntemplateRequest} The populated <code>EzsigntemplateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsigntemplateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplateRequest</code>.
     */
...
EzsigntemplateRequest.RequiredProperties = ["fkiEzsignfoldertypeID", "fkiLanguageID", "sEzsigntemplateDescription", "bEzsigntemplateAdminonly"];
...
export default EzsigntemplateRequest;
