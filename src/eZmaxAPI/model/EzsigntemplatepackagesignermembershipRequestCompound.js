...
import EzsigntemplatepackagesignermembershipRequest from './EzsigntemplatepackagesignermembershipRequest';

/**
 * The EzsigntemplatepackagesignermembershipRequestCompound model module.
 * @module eZmaxAPI/model/EzsigntemplatepackagesignermembershipRequestCompound
 * @version 1.1.17
 */
class EzsigntemplatepackagesignermembershipRequestCompound {
    /**
     * Constructs a new <code>EzsigntemplatepackagesignermembershipRequestCompound</code>.
     * A Ezsigntemplatepackagesignermembership Object and children
     * @alias module:eZmaxAPI/model/EzsigntemplatepackagesignermembershipRequestCompound
     * @implements module:eZmaxAPI/model/EzsigntemplatepackagesignermembershipRequest
    ...
    constructor(fkiEzsigntemplatepackagemembershipID, fkiEzsigntemplatepackagesignerID, fkiEzsigntemplatesignerID) { 
        ...
        EzsigntemplatepackagesignermembershipRequestCompound.initialize(this, fkiEzsigntemplatepackagemembershipID, fkiEzsigntemplatepackagesignerID, fkiEzsigntemplatesignerID);
    }
    ...
    /**
     * Constructs a <code>EzsigntemplatepackagesignermembershipRequestCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsigntemplatepackagesignermembershipRequestCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsigntemplatepackagesignermembershipRequestCompound} The populated <code>EzsigntemplatepackagesignermembershipRequestCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsigntemplatepackagesignermembershipRequestCompound();
            EzsigntemplatepackagesignermembershipRequest.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatepackagesignermembershipRequestCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatepackagesignermembershipRequestCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatepackagesignermembershipRequestCompound.RequiredProperties) {
            if (!data[property]) {
...
EzsigntemplatepackagesignermembershipRequestCompound.RequiredProperties = ["fkiEzsigntemplatepackagemembershipID", "fkiEzsigntemplatepackagesignerID", "fkiEzsigntemplatesignerID"];

/**
 * The unique ID of the Ezsigntemplatepackagesignermembership
 * @member {Number} pkiEzsigntemplatepackagesignermembershipID
 */
EzsigntemplatepackagesignermembershipRequestCompound.prototype['pkiEzsigntemplatepackagesignermembershipID'] = undefined;

/**
 * The unique ID of the Ezsigntemplatepackagemembership
 * @member {Number} fkiEzsigntemplatepackagemembershipID
 */
EzsigntemplatepackagesignermembershipRequestCompound.prototype['fkiEzsigntemplatepackagemembershipID'] = undefined;

/**
 * The unique ID of the Ezsigntemplatepackagesigner
 * @member {Number} fkiEzsigntemplatepackagesignerID
 */
EzsigntemplatepackagesignermembershipRequestCompound.prototype['fkiEzsigntemplatepackagesignerID'] = undefined;

/**
 * The unique ID of the Ezsigntemplatesigner
 * @member {Number} fkiEzsigntemplatesignerID
 */
EzsigntemplatepackagesignermembershipRequestCompound.prototype['fkiEzsigntemplatesignerID'] = undefined;

/**
 * The Copy number in case of multiple copies.
 * @member {Number} iEzsigntemplatepackagesignermembershipCopy
 */
EzsigntemplatepackagesignermembershipRequestCompound.prototype['iEzsigntemplatepackagesignermembershipCopy'] = undefined;


// Implement EzsigntemplatepackagesignermembershipRequest interface:
/**
 * The unique ID of the Ezsigntemplatepackagesignermembership
 * @member {Number} pkiEzsigntemplatepackagesignermembershipID
 */
...
export default EzsigntemplatepackagesignermembershipRequestCompound;
