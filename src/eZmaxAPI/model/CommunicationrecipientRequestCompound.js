...
import CommunicationrecipientRequest from './CommunicationrecipientRequest';
import FieldECommunicationrecipientType from './FieldECommunicationrecipientType';

/**
 * The CommunicationrecipientRequestCompound model module.
 * @module eZmaxAPI/model/CommunicationrecipientRequestCompound
 * @version 1.2.0
 */
class CommunicationrecipientRequestCompound {
    /**
     * Constructs a new <code>CommunicationrecipientRequestCompound</code>.
     * A Communicationrecipient Object and children
     * @alias module:eZmaxAPI/model/CommunicationrecipientRequestCompound
     * @implements module:eZmaxAPI/model/CommunicationrecipientRequest
     */
    constructor() { 
        CommunicationrecipientRequest.initialize(this);
        CommunicationrecipientRequestCompound.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommunicationrecipientRequestCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/CommunicationrecipientRequestCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/CommunicationrecipientRequestCompound} The populated <code>CommunicationrecipientRequestCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommunicationrecipientRequestCompound();
            CommunicationrecipientRequest.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CommunicationrecipientRequestCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommunicationrecipientRequestCompound</code>.
     */
 ...
 */
CommunicationrecipientRequestCompound.prototype['pkiCommunicationrecipientID'] = undefined;
 ...
 */
CommunicationrecipientRequestCompound.prototype['fkiCustomerID'] = undefined;

/**
 * The unique ID of the Employee.
 * @member {Number} fkiEmployeeID
 */
CommunicationrecipientRequestCompound.prototype['fkiEmployeeID'] = undefined;

/**
 * The unique ID of the Assistant.
 * @member {Number} fkiAssistantID
 */
CommunicationrecipientRequestCompound.prototype['fkiAssistantID'] = undefined;

/**
 * The unique ID of the Externalbroker.
 * @member {Number} fkiExternalbrokerID
 */
CommunicationrecipientRequestCompound.prototype['fkiExternalbrokerID'] = undefined;

/**
 * The unique ID of the Ezsignsigner
 * @member {Number} fkiEzsignsignerID
 */
CommunicationrecipientRequestCompound.prototype['fkiEzsignsignerID'] = undefined;

/**
 * The unique ID of the Notary.
 * @member {Number} fkiNotaryID
 */
CommunicationrecipientRequestCompound.prototype['fkiNotaryID'] = undefined;

/**
 * The unique ID of the Supplier.
 * @member {Number} fkiSupplierID
 */
CommunicationrecipientRequestCompound.prototype['fkiSupplierID'] = undefined;
...
// Implement CommunicationrecipientRequest interface:
/**
 * The unique ID of the Communicationrecipient.
 * @member {Number} pkiCommunicationrecipientID
 */
...
export default CommunicationrecipientRequestCompound;
