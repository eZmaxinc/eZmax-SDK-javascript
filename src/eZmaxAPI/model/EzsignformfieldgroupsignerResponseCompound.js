...
class EzsignformfieldgroupsignerResponseCompound {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignformfieldgroupsignerResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignformfieldgroupsignerResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignformfieldgroupsignerResponseCompound.RequiredProperties) {
            if (!data[property]) {
...
EzsignformfieldgroupsignerResponseCompound.RequiredProperties = ["pkiEzsignformfieldgroupsignerID", "fkiEzsignfoldersignerassociationID"];
