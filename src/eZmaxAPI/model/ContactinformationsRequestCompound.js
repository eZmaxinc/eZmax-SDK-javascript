...
class ContactinformationsRequestCompound {
    ...
    /**
     * Validates the JSON data with respect to <code>ContactinformationsRequestCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactinformationsRequestCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ContactinformationsRequestCompound.RequiredProperties) {
            if (!data[property]) {
...
ContactinformationsRequestCompound.RequiredProperties = ["iAddressDefault", "iPhoneDefault", "iEmailDefault", "iWebsiteDefault", "a_objAddress", "a_objPhone", "a_objEmail", "a_objWebsite"];
