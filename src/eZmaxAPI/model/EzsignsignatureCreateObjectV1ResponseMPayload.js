...
class EzsignsignatureCreateObjectV1ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignsignatureCreateObjectV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignsignatureCreateObjectV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignsignatureCreateObjectV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
EzsignsignatureCreateObjectV1ResponseMPayload.RequiredProperties = ["a_pkiEzsignsignatureID"];
