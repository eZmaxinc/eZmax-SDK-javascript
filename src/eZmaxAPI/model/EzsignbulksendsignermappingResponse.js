...
class EzsignbulksendsignermappingResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignbulksendsignermappingResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignbulksendsignermappingResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignbulksendsignermappingResponse.RequiredProperties) {
            if (!data[property]) {
...
EzsignbulksendsignermappingResponse.RequiredProperties = ["pkiEzsignbulksendsignermappingID", "fkiEzsignbulksendID", "sEzsignbulksendsignermappingDescription"];
