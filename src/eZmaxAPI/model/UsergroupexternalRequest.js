...
/**
 * The UsergroupexternalRequest model module.
 * @module eZmaxAPI/model/UsergroupexternalRequest
 * @version 1.2.0
 */
class UsergroupexternalRequest {
    /**
     * Constructs a new <code>UsergroupexternalRequest</code>.
     * A Usergroupexternal Object
     * @alias module:eZmaxAPI/model/UsergroupexternalRequest
    ...
    /**
     * Constructs a <code>UsergroupexternalRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UsergroupexternalRequest} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UsergroupexternalRequest} The populated <code>UsergroupexternalRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsergroupexternalRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UsergroupexternalRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsergroupexternalRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UsergroupexternalRequest.RequiredProperties) {
...
UsergroupexternalRequest.RequiredProperties = ["sUsergroupexternalName", "sUsergroupexternalID"];
...
export default UsergroupexternalRequest;
