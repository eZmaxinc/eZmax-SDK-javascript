...
/**
 * The AttachmentlogResponse model module.
 * @module eZmaxAPI/model/AttachmentlogResponse
 * @version 1.2.0
 */
class AttachmentlogResponse {
    /**
     * Constructs a new <code>AttachmentlogResponse</code>.
     * An Attachmentlog Object
     * @alias module:eZmaxAPI/model/AttachmentlogResponse
    ...
    /**
     * Constructs a <code>AttachmentlogResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/AttachmentlogResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/AttachmentlogResponse} The populated <code>AttachmentlogResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachmentlogResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AttachmentlogResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachmentlogResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AttachmentlogResponse.RequiredProperties) {
...
AttachmentlogResponse.RequiredProperties = ["fkiAttachmentID", "fkiUserID", "dtAttachmentlogDatetime", "eAttachmentlogType"];
...
export default AttachmentlogResponse;
