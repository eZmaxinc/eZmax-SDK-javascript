...
class EzsignsignatureResponseCompound {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignsignatureResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignsignatureResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignsignatureResponseCompound.RequiredProperties) {
...
EzsignsignatureResponseCompound.RequiredProperties = ["pkiEzsignsignatureID", "fkiEzsigndocumentID", "fkiEzsignfoldersignerassociationID", "iEzsignpagePagenumber", "iEzsignsignatureX", "iEzsignsignatureY", "iEzsignsignatureStep", "eEzsignsignatureType", "objContactName"];
 ...
 */
EzsignsignatureResponseCompound.prototype['fkiEzsignsigningreasonID'] = undefined;

/**
 * The description of the Ezsignsigningreason in the language of the requester
 * @member {String} sEzsignsigningreasonDescriptionX
 */
EzsignsignatureResponseCompound.prototype['sEzsignsigningreasonDescriptionX'] = undefined;
 ...
 */
EzsignsignatureResponseCompound.prototype['iEzsignsignatureHeight'] = undefined;
 ...
 */
EzsignsignatureResponseCompound.prototype['iEzsignsignatureWidth'] = undefined;
 ...
 */
EzsignsignatureResponseCompound.prototype['dtEzsignsignatureDate'] = undefined;

/**
 * The count of Ezsignsignatureattachment
 * @member {Number} iEzsignsignatureattachmentCount
 */
EzsignsignatureResponseCompound.prototype['iEzsignsignatureattachmentCount'] = undefined;
 ...
 */
EzsignsignatureResponseCompound.prototype['sEzsignsignatureRegexp'] = undefined;

/**
 * @member {module:eZmaxAPI/model/CustomContactNameResponse} objContactName
 */
EzsignsignatureResponseCompound.prototype['objContactName'] = undefined;

/**
 * @member {module:eZmaxAPI/model/CustomContactNameResponse} objContactNameDelegation
 */
EzsignsignatureResponseCompound.prototype['objContactNameDelegation'] = undefined;

/**
 * @member {module:eZmaxAPI/model/SignatureResponseCompound} objSignature
 */
EzsignsignatureResponseCompound.prototype['objSignature'] = undefined;
