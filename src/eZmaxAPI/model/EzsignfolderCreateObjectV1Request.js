...
class EzsignfolderCreateObjectV1Request {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfolderCreateObjectV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfolderCreateObjectV1Request</code>.
     */
    static validateJSON(data) {
        // validate the optional field `objEzsignfolder`
        if (data['objEzsignfolder']) { // data not null
          EzsignfolderRequest.validateJSON(data['objEzsignfolder']);
        }
        // validate the optional field `objEzsignfolderCompound`
        if (data['objEzsignfolderCompound']) { // data not null
          EzsignfolderRequestCompound.validateJSON(data['objEzsignfolderCompound']);
        }
