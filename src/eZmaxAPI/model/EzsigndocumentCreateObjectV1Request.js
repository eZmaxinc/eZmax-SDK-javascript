...
class EzsigndocumentCreateObjectV1Request {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigndocumentCreateObjectV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigndocumentCreateObjectV1Request</code>.
     */
    static validateJSON(data) {
        // validate the optional field `objEzsigndocument`
        if (data['objEzsigndocument']) { // data not null
          EzsigndocumentRequest.validateJSON(data['objEzsigndocument']);
        }
        // validate the optional field `objEzsigndocumentCompound`
        if (data['objEzsigndocumentCompound']) { // data not null
          EzsigndocumentRequestCompound.validateJSON(data['objEzsigndocumentCompound']);
        }
