...
class BrandingGetObjectV2ResponseAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>BrandingGetObjectV2ResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BrandingGetObjectV2ResponseAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BrandingGetObjectV2ResponseAllOf.RequiredProperties) {
            if (!data[property]) {
...
BrandingGetObjectV2ResponseAllOf.RequiredProperties = ["mPayload"];
