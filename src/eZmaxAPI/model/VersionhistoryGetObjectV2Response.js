...
class VersionhistoryGetObjectV2Response {
    ...
    constructor(objDebugPayload, mPayload) { 
        ...
        VersionhistoryGetObjectV2Response.initialize(this, objDebugPayload, mPayload);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VersionhistoryGetObjectV2Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VersionhistoryGetObjectV2Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VersionhistoryGetObjectV2Response.RequiredProperties) {
        ...
        if (data['mPayload']) { // data not null
          VersionhistoryGetObjectV2ResponseMPayload.validateJSON(data['mPayload']);
        }
...
VersionhistoryGetObjectV2Response.RequiredProperties = ["objDebugPayload", "mPayload"];
