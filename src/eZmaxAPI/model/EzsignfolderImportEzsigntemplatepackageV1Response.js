...
class EzsignfolderImportEzsigntemplatepackageV1Response {
    ...
    constructor(objDebugPayload, mPayload) { 
        ...
        EzsignfolderImportEzsigntemplatepackageV1Response.initialize(this, objDebugPayload, mPayload);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfolderImportEzsigntemplatepackageV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfolderImportEzsigntemplatepackageV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfolderImportEzsigntemplatepackageV1Response.RequiredProperties) {
            if (!data[property]) {
...
EzsignfolderImportEzsigntemplatepackageV1Response.RequiredProperties = ["objDebugPayload", "mPayload"];
