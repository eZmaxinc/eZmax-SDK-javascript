...
/**
 * The BillingentityinternalRequest model module.
 * @module eZmaxAPI/model/BillingentityinternalRequest
 * @version 1.2.0
 */
class BillingentityinternalRequest {
    /**
     * Constructs a new <code>BillingentityinternalRequest</code>.
     * A Billingentityinternal Object
     * @alias module:eZmaxAPI/model/BillingentityinternalRequest
    ...
    /**
     * Constructs a <code>BillingentityinternalRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/BillingentityinternalRequest} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/BillingentityinternalRequest} The populated <code>BillingentityinternalRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BillingentityinternalRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>BillingentityinternalRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BillingentityinternalRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BillingentityinternalRequest.RequiredProperties) {
            if (!data[property]) {
...
BillingentityinternalRequest.RequiredProperties = ["objBillingentityinternalDescription"];
...
export default BillingentityinternalRequest;
