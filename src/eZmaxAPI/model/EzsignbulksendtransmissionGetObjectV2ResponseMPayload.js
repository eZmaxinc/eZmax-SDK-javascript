...
class EzsignbulksendtransmissionGetObjectV2ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignbulksendtransmissionGetObjectV2ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignbulksendtransmissionGetObjectV2ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignbulksendtransmissionGetObjectV2ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['objEzsignbulksendtransmission']) { // data not null
          EzsignbulksendtransmissionResponseCompound.validateJSON(data['objEzsignbulksendtransmission']);
        }
...
EzsignbulksendtransmissionGetObjectV2ResponseMPayload.RequiredProperties = ["objEzsignbulksendtransmission"];
