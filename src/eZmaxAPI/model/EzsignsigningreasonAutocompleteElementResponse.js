...
/**
 * The EzsignsigningreasonAutocompleteElementResponse model module.
 * @module eZmaxAPI/model/EzsignsigningreasonAutocompleteElementResponse
 * @version 1.2.0
 */
class EzsignsigningreasonAutocompleteElementResponse {
    /**
     * Constructs a new <code>EzsignsigningreasonAutocompleteElementResponse</code>.
     * A Ezsignsigningreason AutocompleteElement Response
     * @alias module:eZmaxAPI/model/EzsignsigningreasonAutocompleteElementResponse
    ...
    constructor(pkiEzsignsigningreasonID, sEzsignsigningreasonDescriptionX, bEzsignsigningreasonIsactive) { 
        ...
        EzsignsigningreasonAutocompleteElementResponse.initialize(this, pkiEzsignsigningreasonID, sEzsignsigningreasonDescriptionX, bEzsignsigningreasonIsactive);
    }
    ...
    /**
     * Constructs a <code>EzsignsigningreasonAutocompleteElementResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsignsigningreasonAutocompleteElementResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsignsigningreasonAutocompleteElementResponse} The populated <code>EzsignsigningreasonAutocompleteElementResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsignsigningreasonAutocompleteElementResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignsigningreasonAutocompleteElementResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignsigningreasonAutocompleteElementResponse</code>.
     */
...
EzsignsigningreasonAutocompleteElementResponse.RequiredProperties = ["pkiEzsignsigningreasonID", "sEzsignsigningreasonDescriptionX", "bEzsignsigningreasonIsactive"];

/**
 * The unique ID of the Ezsignsigningreason
 * @member {Number} pkiEzsignsigningreasonID
 */
EzsignsigningreasonAutocompleteElementResponse.prototype['pkiEzsignsigningreasonID'] = undefined;

/**
 * The description of the Ezsignsigningreason in the language of the requester
 * @member {String} sEzsignsigningreasonDescriptionX
 */
EzsignsigningreasonAutocompleteElementResponse.prototype['sEzsignsigningreasonDescriptionX'] = undefined;

/**
 * Whether the ezsignsigningreason is active or not
 * @member {Boolean} bEzsignsigningreasonIsactive
 */
EzsignsigningreasonAutocompleteElementResponse.prototype['bEzsignsigningreasonIsactive'] = undefined;
...
export default EzsignsigningreasonAutocompleteElementResponse;
