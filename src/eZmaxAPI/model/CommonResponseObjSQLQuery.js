...
class CommonResponseObjSQLQuery {
    ...
    /**
     * Validates the JSON data with respect to <code>CommonResponseObjSQLQuery</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonResponseObjSQLQuery</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommonResponseObjSQLQuery.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['sQuery'] && !(typeof data['sQuery'] === 'string' || data['sQuery'] instanceof String)) {
            throw new Error("Expected the field `sQuery` to be a primitive type in the JSON string but got " + data['sQuery']);
        }
...
CommonResponseObjSQLQuery.RequiredProperties = ["sQuery", "fDuration"];
