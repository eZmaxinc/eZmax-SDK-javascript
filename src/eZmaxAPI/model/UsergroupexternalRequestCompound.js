...
import UsergroupexternalRequest from './UsergroupexternalRequest';

/**
 * The UsergroupexternalRequestCompound model module.
 * @module eZmaxAPI/model/UsergroupexternalRequestCompound
 * @version 1.2.0
 */
class UsergroupexternalRequestCompound {
    /**
     * Constructs a new <code>UsergroupexternalRequestCompound</code>.
     * A Usergroupexternal Object and children
     * @alias module:eZmaxAPI/model/UsergroupexternalRequestCompound
     * @implements module:eZmaxAPI/model/UsergroupexternalRequest
     ...
     */
    constructor(sUsergroupexternalName, sUsergroupexternalID) { 
        UsergroupexternalRequest.initialize(this, sUsergroupexternalName, sUsergroupexternalID);
        UsergroupexternalRequestCompound.initialize(this, sUsergroupexternalName, sUsergroupexternalID);
    }
     ...
     */
    static initialize(obj, sUsergroupexternalName, sUsergroupexternalID) { 
        obj['sUsergroupexternalName'] = sUsergroupexternalName;
        obj['sUsergroupexternalID'] = sUsergroupexternalID;
    }

    /**
     * Constructs a <code>UsergroupexternalRequestCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UsergroupexternalRequestCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UsergroupexternalRequestCompound} The populated <code>UsergroupexternalRequestCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsergroupexternalRequestCompound();
            UsergroupexternalRequest.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UsergroupexternalRequestCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsergroupexternalRequestCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UsergroupexternalRequestCompound.RequiredProperties) {
...
UsergroupexternalRequestCompound.RequiredProperties = ["sUsergroupexternalName", "sUsergroupexternalID"];

/**
 * The unique ID of the Usergroupexternal
 * @member {Number} pkiUsergroupexternalID
 */
UsergroupexternalRequestCompound.prototype['pkiUsergroupexternalID'] = undefined;

/**
 * The name of the Usergroupexternal
 * @member {String} sUsergroupexternalName
 */
UsergroupexternalRequestCompound.prototype['sUsergroupexternalName'] = undefined;

/**
 * The id of the Usergroupexternal
 * @member {String} sUsergroupexternalID
 */
UsergroupexternalRequestCompound.prototype['sUsergroupexternalID'] = undefined;


// Implement UsergroupexternalRequest interface:
/**
 * The unique ID of the Usergroupexternal
 * @member {Number} pkiUsergroupexternalID
 */
UsergroupexternalRequest.prototype['pkiUsergroupexternalID'] = undefined;
/**
 * The name of the Usergroupexternal
 * @member {String} sUsergroupexternalName
 */
UsergroupexternalRequest.prototype['sUsergroupexternalName'] = undefined;
/**
 * The id of the Usergroupexternal
 * @member {String} sUsergroupexternalID
 */
UsergroupexternalRequest.prototype['sUsergroupexternalID'] = undefined;




export default UsergroupexternalRequestCompound;
