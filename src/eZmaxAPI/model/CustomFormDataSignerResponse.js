...
class CustomFormDataSignerResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomFormDataSignerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomFormDataSignerResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomFormDataSignerResponse.RequiredProperties) {
            if (!data[property]) {
...
CustomFormDataSignerResponse.RequiredProperties = ["fkiEzsignfoldersignerassociationID", "sContactFirstname", "sContactLastname", "a_objEzsignformfieldgroup"];
