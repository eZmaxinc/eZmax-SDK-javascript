...
class BrandingGetAutocompleteV2Response {
    ...
    constructor(objDebugPayload, mPayload) { 
        ...
        BrandingGetAutocompleteV2Response.initialize(this, objDebugPayload, mPayload);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BrandingGetAutocompleteV2Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BrandingGetAutocompleteV2Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BrandingGetAutocompleteV2Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['mPayload']) { // data not null
          BrandingGetAutocompleteV2ResponseMPayload.validateJSON(data['mPayload']);
        }
...
BrandingGetAutocompleteV2Response.RequiredProperties = ["objDebugPayload", "mPayload"];
