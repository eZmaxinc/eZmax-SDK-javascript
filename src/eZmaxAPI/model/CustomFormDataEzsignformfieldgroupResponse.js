...
class CustomFormDataEzsignformfieldgroupResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomFormDataEzsignformfieldgroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomFormDataEzsignformfieldgroupResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomFormDataEzsignformfieldgroupResponse.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['a_objEzsignformfield']) { // data not null
            ...
            for (const item of data['a_objEzsignformfield']) {
                CustomFormDataEzsignformfieldResponse.validateJsonObject(item);
            };
        }
...
CustomFormDataEzsignformfieldgroupResponse.RequiredProperties = ["sEzsignformfieldgroupLabel", "a_objEzsignformfield"];
