...
/**
 * The EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload model module.
 * @module eZmaxAPI/model/EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload
 * @version 1.2.0
 */
class EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload {
    /**
     * Constructs a new <code>EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload</code>.
     * Payload for GET /1/object/ezsignbulksend/{pkiEzsignbulksendID}/getEzsignsignaturesAutomatic
     * @alias module:eZmaxAPI/model/EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload
    ...
    constructor(a_eEzsignsignatureType, a_objEzsignfolder) { 
        ...
        EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload.initialize(this, a_eEzsignsignatureType, a_objEzsignfolder);
    }
    ...
    /**
     * Constructs a <code>EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload} The populated <code>EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload.RequiredProperties) {
...
EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload.RequiredProperties = ["a_eEzsignsignatureType", "a_objEzsignfolder"];
 ...
 */
EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload.prototype['a_eEzsignsignatureType'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/CustomEzsignfolderEzsignsignaturesAutomaticResponse>} a_objEzsignfolder
 */
EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload.prototype['a_objEzsignfolder'] = undefined;
...
export default EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload;
