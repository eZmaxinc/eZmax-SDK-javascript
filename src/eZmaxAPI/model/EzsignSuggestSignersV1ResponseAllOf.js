...
class EzsignSuggestSignersV1ResponseAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignSuggestSignersV1ResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignSuggestSignersV1ResponseAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignSuggestSignersV1ResponseAllOf.RequiredProperties) {
            if (!data[property]) {
...
EzsignSuggestSignersV1ResponseAllOf.RequiredProperties = ["mPayload"];
