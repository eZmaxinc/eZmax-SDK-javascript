...
class EzsignformfieldgroupCreateObjectV1Response {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignformfieldgroupCreateObjectV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignformfieldgroupCreateObjectV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignformfieldgroupCreateObjectV1Response.RequiredProperties) {
            if (!data[property]) {
