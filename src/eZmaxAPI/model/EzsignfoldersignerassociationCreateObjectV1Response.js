...
class EzsignfoldersignerassociationCreateObjectV1Response {
     ...
     * @implements module:eZmaxAPI/model/EzsignfoldersignerassociationCreateObjectV1ResponseAllOf
     * @implements module:eZmaxAPI/model/CommonResponse
     * @param mPayload {module:eZmaxAPI/model/EzsignfoldersignerassociationCreateObjectV1ResponseMPayload} 
     */
    constructor(mPayload) { 
        EzsignfoldersignerassociationCreateObjectV1ResponseAllOf.initialize(this, mPayload);CommonResponse.initialize(this);
        EzsignfoldersignerassociationCreateObjectV1Response.initialize(this, mPayload);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            EzsignfoldersignerassociationCreateObjectV1ResponseAllOf.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfoldersignerassociationCreateObjectV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfoldersignerassociationCreateObjectV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfoldersignerassociationCreateObjectV1Response.RequiredProperties) {
            if (!data[property]) {
...
EzsignfoldersignerassociationCreateObjectV1Response.RequiredProperties = ["mPayload"];
...
// Implement EzsignfoldersignerassociationCreateObjectV1ResponseAllOf interface:
/**
 * @member {module:eZmaxAPI/model/EzsignfoldersignerassociationCreateObjectV1ResponseMPayload} mPayload
 */
