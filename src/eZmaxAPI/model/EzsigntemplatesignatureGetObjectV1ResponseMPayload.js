...
/**
 * The EzsigntemplatesignatureGetObjectV1ResponseMPayload model module.
 * @module eZmaxAPI/model/EzsigntemplatesignatureGetObjectV1ResponseMPayload
 * @version 1.1.17
 */
class EzsigntemplatesignatureGetObjectV1ResponseMPayload {
    /**
     * Constructs a new <code>EzsigntemplatesignatureGetObjectV1ResponseMPayload</code>.
     * Payload for GET /1/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}
     * @alias module:eZmaxAPI/model/EzsigntemplatesignatureGetObjectV1ResponseMPayload
     * @implements module:eZmaxAPI/model/EzsigntemplatesignatureResponseCompound
    ...
    constructor(pkiEzsigntemplatesignatureID, fkiEzsigntemplatedocumentID, fkiEzsigntemplatesignerID, iEzsigntemplatedocumentpagePagenumber, iEzsigntemplatesignatureX, iEzsigntemplatesignatureY, iEzsigntemplatesignatureStep, eEzsigntemplatesignatureType) { 
        ...
        EzsigntemplatesignatureGetObjectV1ResponseMPayload.initialize(this, pkiEzsigntemplatesignatureID, fkiEzsigntemplatedocumentID, fkiEzsigntemplatesignerID, iEzsigntemplatedocumentpagePagenumber, iEzsigntemplatesignatureX, iEzsigntemplatesignatureY, iEzsigntemplatesignatureStep, eEzsigntemplatesignatureType);
    }
    ...
    /**
     * Constructs a <code>EzsigntemplatesignatureGetObjectV1ResponseMPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsigntemplatesignatureGetObjectV1ResponseMPayload} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsigntemplatesignatureGetObjectV1ResponseMPayload} The populated <code>EzsigntemplatesignatureGetObjectV1ResponseMPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsigntemplatesignatureGetObjectV1ResponseMPayload();
            EzsigntemplatesignatureResponseCompound.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatesignatureGetObjectV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatesignatureGetObjectV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatesignatureGetObjectV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
EzsigntemplatesignatureGetObjectV1ResponseMPayload.RequiredProperties = ["pkiEzsigntemplatesignatureID", "fkiEzsigntemplatedocumentID", "fkiEzsigntemplatesignerID", "iEzsigntemplatedocumentpagePagenumber", "iEzsigntemplatesignatureX", "iEzsigntemplatesignatureY", "iEzsigntemplatesignatureStep", "eEzsigntemplatesignatureType"];

/**
 * The unique ID of the Ezsigntemplatesignature
 * @member {Number} pkiEzsigntemplatesignatureID
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['pkiEzsigntemplatesignatureID'] = undefined;

/**
 * The unique ID of the Ezsigntemplatedocument
 * @member {Number} fkiEzsigntemplatedocumentID
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['fkiEzsigntemplatedocumentID'] = undefined;

/**
 * The unique ID of the Ezsigntemplatesigner
 * @member {Number} fkiEzsigntemplatesignerID
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['fkiEzsigntemplatesignerID'] = undefined;

/**
 * The unique ID of the Ezsigntemplatesigner
 * @member {Number} fkiEzsigntemplatesignerIDValidation
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['fkiEzsigntemplatesignerIDValidation'] = undefined;

/**
 * The page number in the Ezsigntemplatedocument
 * @member {Number} iEzsigntemplatedocumentpagePagenumber
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['iEzsigntemplatedocumentpagePagenumber'] = undefined;

/**
 * The X coordinate (Horizontal) where to put the Ezsigntemplatesignature on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsigntemplatesignature 2 inches from the left border of the page, you would use \"200\" for the X coordinate.
 * @member {Number} iEzsigntemplatesignatureX
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['iEzsigntemplatesignatureX'] = undefined;

/**
 * The Y coordinate (Vertical) where to put the Ezsigntemplatesignature on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsigntemplatesignature 3 inches from the top border of the page, you would use \"300\" for the Y coordinate.
 * @member {Number} iEzsigntemplatesignatureY
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['iEzsigntemplatesignatureY'] = undefined;

/**
 * The step when the Ezsigntemplatesigner will be invited to sign
 * @member {Number} iEzsigntemplatesignatureStep
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['iEzsigntemplatesignatureStep'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEEzsigntemplatesignatureType} eEzsigntemplatesignatureType
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['eEzsigntemplatesignatureType'] = undefined;

/**
 * A tooltip that will be presented to Ezsigntemplatesigner about the Ezsigntemplatesignature
 * @member {String} tEzsigntemplatesignatureTooltip
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['tEzsigntemplatesignatureTooltip'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEEzsigntemplatesignatureTooltipposition} eEzsigntemplatesignatureTooltipposition
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['eEzsigntemplatesignatureTooltipposition'] = undefined;

/**
 * @member {module:eZmaxAPI/model/FieldEEzsigntemplatesignatureFont} eEzsigntemplatesignatureFont
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['eEzsigntemplatesignatureFont'] = undefined;
 ...
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['iEzsigntemplatesignatureValidationstep'] = undefined;
 ...
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['sEzsigntemplatesignatureAttachmentdescription'] = undefined;
 ...
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['eEzsigntemplatesignatureAttachmentnamesource'] = undefined;
 ...
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['bEzsigntemplatesignatureRequired'] = undefined;

/**
 * Whether the Ezsigntemplatesignature has a custom date format or not. (Only possible when eEzsigntemplatesignatureType is **Name** or **Handwritten**)
 * @member {Boolean} bEzsigntemplatesignatureCustomdate
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['bEzsigntemplatesignatureCustomdate'] = undefined;
 ...
 */
EzsigntemplatesignatureGetObjectV1ResponseMPayload.prototype['a_objEzsigntemplatesignaturecustomdate'] = undefined;


// Implement EzsigntemplatesignatureResponseCompound interface:
/**
 * The unique ID of the Ezsigntemplatesignature
 * @member {Number} pkiEzsigntemplatesignatureID
 */
...
export default EzsigntemplatesignatureGetObjectV1ResponseMPayload;
