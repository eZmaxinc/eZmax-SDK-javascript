...
/**
 * The EzsigntemplatepackagesignermembershipResponse model module.
 * @module eZmaxAPI/model/EzsigntemplatepackagesignermembershipResponse
 * @version 1.1.18
 */
class EzsigntemplatepackagesignermembershipResponse {
    /**
     * Constructs a new <code>EzsigntemplatepackagesignermembershipResponse</code>.
     * A Ezsigntemplatepackagesignermembership Object
     * @alias module:eZmaxAPI/model/EzsigntemplatepackagesignermembershipResponse
    ...
    /**
     * Constructs a <code>EzsigntemplatepackagesignermembershipResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsigntemplatepackagesignermembershipResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsigntemplatepackagesignermembershipResponse} The populated <code>EzsigntemplatepackagesignermembershipResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsigntemplatepackagesignermembershipResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatepackagesignermembershipResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatepackagesignermembershipResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatepackagesignermembershipResponse.RequiredProperties) {
            if (!data[property]) {
...
EzsigntemplatepackagesignermembershipResponse.RequiredProperties = ["pkiEzsigntemplatepackagesignermembershipID", "fkiEzsigntemplatepackagemembershipID", "fkiEzsigntemplatepackagesignerID", "fkiEzsigntemplatesignerID"];
...
export default EzsigntemplatepackagesignermembershipResponse;
