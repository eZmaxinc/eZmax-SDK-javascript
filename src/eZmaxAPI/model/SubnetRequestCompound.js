...
import SubnetRequest from './SubnetRequest';

/**
 * The SubnetRequestCompound model module.
 * @module eZmaxAPI/model/SubnetRequestCompound
 * @version 1.2.0
 */
class SubnetRequestCompound {
    /**
     * Constructs a new <code>SubnetRequestCompound</code>.
     * A Subnet Object and children
     * @alias module:eZmaxAPI/model/SubnetRequestCompound
     * @implements module:eZmaxAPI/model/SubnetRequest
    ...
    constructor(objSubnetDescription, iSubnetNetwork, iSubnetMask) { 
        ...
        SubnetRequestCompound.initialize(this, objSubnetDescription, iSubnetNetwork, iSubnetMask);
    }
    ...
    /**
     * Constructs a <code>SubnetRequestCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/SubnetRequestCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/SubnetRequestCompound} The populated <code>SubnetRequestCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubnetRequestCompound();
            SubnetRequest.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SubnetRequestCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubnetRequestCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SubnetRequestCompound.RequiredProperties) {
...
SubnetRequestCompound.RequiredProperties = ["objSubnetDescription", "iSubnetNetwork", "iSubnetMask"];

/**
 * The unique ID of the Subnet
 * @member {Number} pkiSubnetID
 */
SubnetRequestCompound.prototype['pkiSubnetID'] = undefined;

/**
 * The unique ID of the User
 * @member {Number} fkiUserID
 */
SubnetRequestCompound.prototype['fkiUserID'] = undefined;

/**
 * The unique ID of the Apikey
 * @member {Number} fkiApikeyID
 */
SubnetRequestCompound.prototype['fkiApikeyID'] = undefined;

/**
 * @member {module:eZmaxAPI/model/MultilingualSubnetDescription} objSubnetDescription
 */
SubnetRequestCompound.prototype['objSubnetDescription'] = undefined;

/**
 * The network of the Subnet in integer form. For example 8.8.8.0 would be 134744064
 * @member {Number} iSubnetNetwork
 */
SubnetRequestCompound.prototype['iSubnetNetwork'] = undefined;

/**
 * The mask of the Subnet  in integer form. For example 255.255.255.0 would be 4294967040
 * @member {Number} iSubnetMask
 */
SubnetRequestCompound.prototype['iSubnetMask'] = undefined;


// Implement SubnetRequest interface:
/**
 * The unique ID of the Subnet
 * @member {Number} pkiSubnetID
 */
...
export default SubnetRequestCompound;
