...
/**
 * The SignatureResponseCompound model module.
 * @module eZmaxAPI/model/SignatureResponseCompound
 * @version 1.1.18
 */
class SignatureResponseCompound {
    /**
     * Constructs a new <code>SignatureResponseCompound</code>.
     * A Signature Object
     * @alias module:eZmaxAPI/model/SignatureResponseCompound
     * @implements module:eZmaxAPI/model/SignatureResponse
    ...
    constructor(pkiSignatureID, sSignatureUrl) { 
        ...
        SignatureResponseCompound.initialize(this, pkiSignatureID, sSignatureUrl);
    }
    ...
    /**
     * Constructs a <code>SignatureResponseCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/SignatureResponseCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/SignatureResponseCompound} The populated <code>SignatureResponseCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SignatureResponseCompound();
            SignatureResponse.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SignatureResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SignatureResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SignatureResponseCompound.RequiredProperties) {
            if (!data[property]) {
...
SignatureResponseCompound.RequiredProperties = ["pkiSignatureID", "sSignatureUrl"];

/**
 * The unique ID of the Signature
 * @member {Number} pkiSignatureID
 */
SignatureResponseCompound.prototype['pkiSignatureID'] = undefined;

/**
 * The URL of the SVG file for the Signature
 * @member {String} sSignatureUrl
 */
SignatureResponseCompound.prototype['sSignatureUrl'] = undefined;


// Implement SignatureResponse interface:
/**
 * The unique ID of the Signature
 * @member {Number} pkiSignatureID
 */
...
export default SignatureResponseCompound;
