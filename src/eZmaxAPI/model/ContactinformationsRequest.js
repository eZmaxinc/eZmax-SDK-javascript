...
class ContactinformationsRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>ContactinformationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactinformationsRequest</code>.
     */
...
ContactinformationsRequest.RequiredProperties = ["iAddressDefault", "iPhoneDefault", "iEmailDefault", "iWebsiteDefault"];
