...
class EzsigndocumentCreateObjectV1Response {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigndocumentCreateObjectV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigndocumentCreateObjectV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigndocumentCreateObjectV1Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['mPayload']) { // data not null
          EzsigndocumentCreateObjectV1ResponseMPayload.validateJSON(data['mPayload']);
        }
...
EzsigndocumentCreateObjectV1Response.RequiredProperties = ["mPayload"];
