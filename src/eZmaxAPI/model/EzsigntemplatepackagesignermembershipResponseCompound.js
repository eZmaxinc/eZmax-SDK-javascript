...
class EzsigntemplatepackagesignermembershipResponseCompound {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatepackagesignermembershipResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatepackagesignermembershipResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatepackagesignermembershipResponseCompound.RequiredProperties) {
            if (!data[property]) {
...
EzsigntemplatepackagesignermembershipResponseCompound.RequiredProperties = ["pkiEzsigntemplatepackagesignermembershipID", "fkiEzsigntemplatepackagemembershipID", "fkiEzsigntemplatepackagesignerID", "fkiEzsigntemplatesignerID"];
