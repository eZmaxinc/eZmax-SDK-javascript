...
/**
 * The EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload model module.
 * @module eZmaxAPI/model/EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload
 * @version 1.2.0
 */
class EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload {
    /**
     * Constructs a new <code>EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload</code>.
     * Payload for DELETE /1/object/ezsigntemplatepackagesignermembership/{pkiEzsigntemplatepackagesignermembershipID}
     * @alias module:eZmaxAPI/model/EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload
    ...
    constructor(bEzsigntemplatepackageNeedvalidation, bEzsignbulksendNeedvalidation) { 
        ...
        EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload.initialize(this, bEzsigntemplatepackageNeedvalidation, bEzsignbulksendNeedvalidation);
    }
    ...
    /**
     * Constructs a <code>EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload} The populated <code>EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload.RequiredProperties) {
...
EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload.RequiredProperties = ["bEzsigntemplatepackageNeedvalidation", "bEzsignbulksendNeedvalidation"];

/**
 * Whether the Ezsignbulksend was automatically modified and needs a manual validation
 * @member {Boolean} bEzsigntemplatepackageNeedvalidation
 */
EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload.prototype['bEzsigntemplatepackageNeedvalidation'] = undefined;

/**
 * Whether the Ezsigntemplatepackage was automatically modified and needs a manual validation
 * @member {Boolean} bEzsignbulksendNeedvalidation
 */
EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload.prototype['bEzsignbulksendNeedvalidation'] = undefined;
...
export default EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload;
