...
import SubnetResponse from './SubnetResponse';

/**
 * The SubnetResponseCompound model module.
 * @module eZmaxAPI/model/SubnetResponseCompound
 * @version 1.2.0
 */
class SubnetResponseCompound {
    /**
     * Constructs a new <code>SubnetResponseCompound</code>.
     * A Subnet Object
     * @alias module:eZmaxAPI/model/SubnetResponseCompound
     * @implements module:eZmaxAPI/model/SubnetResponse
    ...
    constructor(pkiSubnetID, objSubnetDescription, iSubnetNetwork, iSubnetMask) { 
        ...
        SubnetResponseCompound.initialize(this, pkiSubnetID, objSubnetDescription, iSubnetNetwork, iSubnetMask);
    }
    ...
    /**
     * Constructs a <code>SubnetResponseCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/SubnetResponseCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/SubnetResponseCompound} The populated <code>SubnetResponseCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubnetResponseCompound();
            SubnetResponse.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SubnetResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubnetResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SubnetResponseCompound.RequiredProperties) {
...
SubnetResponseCompound.RequiredProperties = ["pkiSubnetID", "objSubnetDescription", "iSubnetNetwork", "iSubnetMask"];

/**
 * The unique ID of the Subnet
 * @member {Number} pkiSubnetID
 */
SubnetResponseCompound.prototype['pkiSubnetID'] = undefined;

/**
 * The unique ID of the User
 * @member {Number} fkiUserID
 */
SubnetResponseCompound.prototype['fkiUserID'] = undefined;

/**
 * The unique ID of the Apikey
 * @member {Number} fkiApikeyID
 */
SubnetResponseCompound.prototype['fkiApikeyID'] = undefined;

/**
 * @member {module:eZmaxAPI/model/MultilingualSubnetDescription} objSubnetDescription
 */
SubnetResponseCompound.prototype['objSubnetDescription'] = undefined;

/**
 * The network of the Subnet in integer form. For example 8.8.8.0 would be 134744064
 * @member {Number} iSubnetNetwork
 */
SubnetResponseCompound.prototype['iSubnetNetwork'] = undefined;

/**
 * The mask of the Subnet  in integer form. For example 255.255.255.0 would be 4294967040
 * @member {Number} iSubnetMask
 */
SubnetResponseCompound.prototype['iSubnetMask'] = undefined;


// Implement SubnetResponse interface:
/**
 * The unique ID of the Subnet
 * @member {Number} pkiSubnetID
 */
...
export default SubnetResponseCompound;
