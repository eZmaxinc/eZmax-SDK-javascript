...
/**
 * The EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload model module.
 * @module eZmaxAPI/model/EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload
 * @version 1.1.17
 */
class EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload {
    /**
     * Constructs a new <code>EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload</code>.
     * Payload for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignsignaturesAutomatic
     * @alias module:eZmaxAPI/model/EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload
    ...
    constructor(a_eEzsignsignatureType, a_objEzsignfolder) { 
        ...
        EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload.initialize(this, a_eEzsignsignatureType, a_objEzsignfolder);
    }
    ...
    /**
     * Constructs a <code>EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload} The populated <code>EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload.RequiredProperties = ["a_eEzsignsignatureType", "a_objEzsignfolder"];
 ...
 */
EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload.prototype['a_eEzsignsignatureType'] = undefined;

/**
 * @member {Array.<module:eZmaxAPI/model/CustomEzsignfolderEzsignsignaturesAutomaticResponse>} a_objEzsignfolder
 */
EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload.prototype['a_objEzsignfolder'] = undefined;
...
export default EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload;
