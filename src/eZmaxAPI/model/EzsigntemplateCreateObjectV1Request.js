...
class EzsigntemplateCreateObjectV1Request {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplateCreateObjectV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplateCreateObjectV1Request</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplateCreateObjectV1Request.RequiredProperties) {
...
EzsigntemplateCreateObjectV1Request.RequiredProperties = ["a_objEzsigntemplate"];
