...
class EzsignfoldersignerassociationPatchObjectV1Response {
    ...
    constructor(objDebugPayload) { 
        ...
        EzsignfoldersignerassociationPatchObjectV1Response.initialize(this, objDebugPayload);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfoldersignerassociationPatchObjectV1Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfoldersignerassociationPatchObjectV1Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfoldersignerassociationPatchObjectV1Response.RequiredProperties) {
            if (!data[property]) {
...
EzsignfoldersignerassociationPatchObjectV1Response.RequiredProperties = ["objDebugPayload"];
