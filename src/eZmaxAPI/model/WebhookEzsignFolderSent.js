...
/**
 * The WebhookEzsignFolderSent model module.
 * @module eZmaxAPI/model/WebhookEzsignFolderSent
 * @version 1.2.0
 */
class WebhookEzsignFolderSent {
    /**
     * Constructs a new <code>WebhookEzsignFolderSent</code>.
     * This is the base Webhook object
     * @alias module:eZmaxAPI/model/WebhookEzsignFolderSent
    ...
    constructor(objWebhook, a_objAttempt, objEzsignfolder) { 
        ...
        WebhookEzsignFolderSent.initialize(this, objWebhook, a_objAttempt, objEzsignfolder);
    }
    ...
    /**
     * Constructs a <code>WebhookEzsignFolderSent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/WebhookEzsignFolderSent} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/WebhookEzsignFolderSent} The populated <code>WebhookEzsignFolderSent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookEzsignFolderSent();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookEzsignFolderSent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookEzsignFolderSent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookEzsignFolderSent.RequiredProperties) {
...
WebhookEzsignFolderSent.RequiredProperties = ["objWebhook", "a_objAttempt", "objEzsignfolder"];

/**
 * @member {module:eZmaxAPI/model/CustomWebhookResponse} objWebhook
 */
WebhookEzsignFolderSent.prototype['objWebhook'] = undefined;

/**
 * An array containing details of previous attempts that were made to deliver the message. The array is empty if it's the first attempt.
 * @member {Array.<module:eZmaxAPI/model/AttemptResponseCompound>} a_objAttempt
 */
WebhookEzsignFolderSent.prototype['a_objAttempt'] = undefined;

/**
 * @member {module:eZmaxAPI/model/EzsignfolderResponse} objEzsignfolder
 */
WebhookEzsignFolderSent.prototype['objEzsignfolder'] = undefined;
...
export default WebhookEzsignFolderSent;
