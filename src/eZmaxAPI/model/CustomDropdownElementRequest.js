...
class CustomDropdownElementRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomDropdownElementRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomDropdownElementRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomDropdownElementRequest.RequiredProperties) {
            if (!data[property]) {
...
CustomDropdownElementRequest.RequiredProperties = ["sLabel", "sValue"];
