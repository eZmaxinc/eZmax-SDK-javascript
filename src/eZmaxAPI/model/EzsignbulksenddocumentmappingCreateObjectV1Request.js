...
class EzsignbulksenddocumentmappingCreateObjectV1Request {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignbulksenddocumentmappingCreateObjectV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignbulksenddocumentmappingCreateObjectV1Request</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignbulksenddocumentmappingCreateObjectV1Request.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['a_objEzsignbulksenddocumentmapping']) { // data not null
            ...
            for (const item of data['a_objEzsignbulksenddocumentmapping']) {
                EzsignbulksenddocumentmappingRequestCompound.validateJsonObject(item);
            };
        }
...
EzsignbulksenddocumentmappingCreateObjectV1Request.RequiredProperties = ["a_objEzsignbulksenddocumentmapping"];
