...
class EzsignbulksendtransmissionResponseCompound {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignbulksendtransmissionResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignbulksendtransmissionResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignbulksendtransmissionResponseCompound.RequiredProperties) {
            if (!data[property]) {
...
EzsignbulksendtransmissionResponseCompound.RequiredProperties = ["pkiEzsignbulksendtransmissionID", "fkiEzsignbulksendID", "sEzsignbulksendtransmissionDescription", "iEzsignbulksendtransmissionErrors", "objAudit", "a_objEzsignfoldertransmission"];
