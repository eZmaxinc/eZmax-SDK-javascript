...
/**
 * The WebhookEzsignDocumentFormCompleted model module.
 * @module eZmaxAPI/model/WebhookEzsignDocumentFormCompleted
 * @version 1.2.0
 */
class WebhookEzsignDocumentFormCompleted {
    /**
     * Constructs a new <code>WebhookEzsignDocumentFormCompleted</code>.
     * This is the base Webhook object
     * @alias module:eZmaxAPI/model/WebhookEzsignDocumentFormCompleted
    ...
    constructor(objWebhook, a_objAttempt, objEzsigndocument) { 
        ...
        WebhookEzsignDocumentFormCompleted.initialize(this, objWebhook, a_objAttempt, objEzsigndocument);
    }
    ...
    /**
     * Constructs a <code>WebhookEzsignDocumentFormCompleted</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/WebhookEzsignDocumentFormCompleted} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/WebhookEzsignDocumentFormCompleted} The populated <code>WebhookEzsignDocumentFormCompleted</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookEzsignDocumentFormCompleted();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookEzsignDocumentFormCompleted</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookEzsignDocumentFormCompleted</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookEzsignDocumentFormCompleted.RequiredProperties) {
...
WebhookEzsignDocumentFormCompleted.RequiredProperties = ["objWebhook", "a_objAttempt", "objEzsigndocument"];

/**
 * @member {module:eZmaxAPI/model/CustomWebhookResponse} objWebhook
 */
WebhookEzsignDocumentFormCompleted.prototype['objWebhook'] = undefined;

/**
 * An array containing details of previous attempts that were made to deliver the message. The array is empty if it's the first attempt.
 * @member {Array.<module:eZmaxAPI/model/AttemptResponseCompound>} a_objAttempt
 */
WebhookEzsignDocumentFormCompleted.prototype['a_objAttempt'] = undefined;

/**
 * @member {module:eZmaxAPI/model/EzsigndocumentResponse} objEzsigndocument
 */
WebhookEzsignDocumentFormCompleted.prototype['objEzsigndocument'] = undefined;
...
export default WebhookEzsignDocumentFormCompleted;
