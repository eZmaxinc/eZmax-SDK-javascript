...
class ApikeyCreateObjectV1Request {
    ...
    /**
     * Validates the JSON data with respect to <code>ApikeyCreateObjectV1Request</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApikeyCreateObjectV1Request</code>.
     */
    static validateJSON(data) {
        // validate the optional field `objApikey`
        if (data['objApikey']) { // data not null
          ApikeyRequest.validateJSON(data['objApikey']);
        }
        // validate the optional field `objApikeyCompound`
        if (data['objApikeyCompound']) { // data not null
          ApikeyRequestCompound.validateJSON(data['objApikeyCompound']);
        }
