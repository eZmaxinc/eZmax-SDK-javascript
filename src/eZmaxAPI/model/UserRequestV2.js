...
/**
 * The UserRequestV2 model module.
 * @module eZmaxAPI/model/UserRequestV2
 * @version 1.2.0
 */
class UserRequestV2 {
    /**
     * Constructs a new <code>UserRequestV2</code>.
     * A User Object
     * @alias module:eZmaxAPI/model/UserRequestV2
    ...
    /**
     * Constructs a <code>UserRequestV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/UserRequestV2} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/UserRequestV2} The populated <code>UserRequestV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserRequestV2();
    ...
    /**
     * Validates the JSON data with respect to <code>UserRequestV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserRequestV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserRequestV2.RequiredProperties) {
...
UserRequestV2.RequiredProperties = ["fkiCompanyIDDefault", "fkiDepartmentIDDefault", "fkiTimezoneID", "fkiLanguageID", "objEmail", "fkiBillingentityinternalID", "eUserType", "eUserLogintype", "sUserFirstname", "sUserLastname", "sUserLoginname", "eUserEzsignaccess", "bUserIsactive"];
