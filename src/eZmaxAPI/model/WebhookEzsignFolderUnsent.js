...
/**
 * The WebhookEzsignFolderUnsent model module.
 * @module eZmaxAPI/model/WebhookEzsignFolderUnsent
 * @version 1.2.0
 */
class WebhookEzsignFolderUnsent {
    /**
     * Constructs a new <code>WebhookEzsignFolderUnsent</code>.
     * This is the base Webhook object
     * @alias module:eZmaxAPI/model/WebhookEzsignFolderUnsent
    ...
    constructor(objWebhook, a_objAttempt, objEzsignfolder) { 
        ...
        WebhookEzsignFolderUnsent.initialize(this, objWebhook, a_objAttempt, objEzsignfolder);
    }
    ...
    /**
     * Constructs a <code>WebhookEzsignFolderUnsent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/WebhookEzsignFolderUnsent} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/WebhookEzsignFolderUnsent} The populated <code>WebhookEzsignFolderUnsent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookEzsignFolderUnsent();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookEzsignFolderUnsent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookEzsignFolderUnsent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookEzsignFolderUnsent.RequiredProperties) {
...
WebhookEzsignFolderUnsent.RequiredProperties = ["objWebhook", "a_objAttempt", "objEzsignfolder"];

/**
 * @member {module:eZmaxAPI/model/CustomWebhookResponse} objWebhook
 */
WebhookEzsignFolderUnsent.prototype['objWebhook'] = undefined;

/**
 * An array containing details of previous attempts that were made to deliver the message. The array is empty if it's the first attempt.
 * @member {Array.<module:eZmaxAPI/model/AttemptResponseCompound>} a_objAttempt
 */
WebhookEzsignFolderUnsent.prototype['a_objAttempt'] = undefined;

/**
 * @member {module:eZmaxAPI/model/EzsignfolderResponse} objEzsignfolder
 */
WebhookEzsignFolderUnsent.prototype['objEzsignfolder'] = undefined;
...
export default WebhookEzsignFolderUnsent;
