...
import DiscussionmembershipRequest from './DiscussionmembershipRequest';

/**
 * The DiscussionmembershipRequestCompound model module.
 * @module eZmaxAPI/model/DiscussionmembershipRequestCompound
 * @version 1.2.0
 */
class DiscussionmembershipRequestCompound {
    /**
     * Constructs a new <code>DiscussionmembershipRequestCompound</code>.
     * A Discussionmembership Object and children
     * @alias module:eZmaxAPI/model/DiscussionmembershipRequestCompound
     * @implements module:eZmaxAPI/model/DiscussionmembershipRequest
    ...
    constructor(fkiDiscussionID, dtDiscussionmembershipJoined) { 
        ...
        DiscussionmembershipRequestCompound.initialize(this, fkiDiscussionID, dtDiscussionmembershipJoined);
    }
    ...
    /**
     * Constructs a <code>DiscussionmembershipRequestCompound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/DiscussionmembershipRequestCompound} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/DiscussionmembershipRequestCompound} The populated <code>DiscussionmembershipRequestCompound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DiscussionmembershipRequestCompound();
            DiscussionmembershipRequest.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DiscussionmembershipRequestCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DiscussionmembershipRequestCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DiscussionmembershipRequestCompound.RequiredProperties) {
...
DiscussionmembershipRequestCompound.RequiredProperties = ["fkiDiscussionID", "dtDiscussionmembershipJoined"];

/**
 * The unique ID of the Discussionmembership
 * @member {Number} pkiDiscussionmembershipID
 */
DiscussionmembershipRequestCompound.prototype['pkiDiscussionmembershipID'] = undefined;

/**
 * The unique ID of the Discussion
 * @member {Number} fkiDiscussionID
 */
DiscussionmembershipRequestCompound.prototype['fkiDiscussionID'] = undefined;

/**
 * The unique ID of the User
 * @member {Number} fkiUserID
 */
DiscussionmembershipRequestCompound.prototype['fkiUserID'] = undefined;

/**
 * The unique ID of the Usergroup
 * @member {Number} fkiUsergroupID
 */
DiscussionmembershipRequestCompound.prototype['fkiUsergroupID'] = undefined;

/**
 * The unique ID of the Modulesection
 * @member {Number} fkiModulesectionID
 */
DiscussionmembershipRequestCompound.prototype['fkiModulesectionID'] = undefined;

/**
 * The joined date of the Discussionmembership
 * @member {String} dtDiscussionmembershipJoined
 */
DiscussionmembershipRequestCompound.prototype['dtDiscussionmembershipJoined'] = undefined;


// Implement DiscussionmembershipRequest interface:
/**
 * The unique ID of the Discussionmembership
 * @member {Number} pkiDiscussionmembershipID
 */
...
export default DiscussionmembershipRequestCompound;
