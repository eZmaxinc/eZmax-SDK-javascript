...
class EzsigntemplatedocumentRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigntemplatedocumentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigntemplatedocumentRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigntemplatedocumentRequest.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['eEzsigntemplatedocumentSource'] && !(typeof data['eEzsigntemplatedocumentSource'] === 'string' || data['eEzsigntemplatedocumentSource'] instanceof String)) {
            throw new Error("Expected the field `eEzsigntemplatedocumentSource` to be a primitive type in the JSON string but got " + data['eEzsigntemplatedocumentSource']);
        }
        // ensure the json data is a string
        if (data['eEzsigntemplatedocumentFormat'] && !(typeof data['eEzsigntemplatedocumentFormat'] === 'string' || data['eEzsigntemplatedocumentFormat'] instanceof String)) {
            throw new Error("Expected the field `eEzsigntemplatedocumentFormat` to be a primitive type in the JSON string but got " + data['eEzsigntemplatedocumentFormat']);
        }
        // ensure the json data is a string
        if (data['sEzsigntemplatedocumentUrl'] && !(typeof data['sEzsigntemplatedocumentUrl'] === 'string' || data['sEzsigntemplatedocumentUrl'] instanceof String)) {
            throw new Error("Expected the field `sEzsigntemplatedocumentUrl` to be a primitive type in the JSON string but got " + data['sEzsigntemplatedocumentUrl']);
        }
        // ensure the json data is a string
        if (data['eEzsigntemplatedocumentForm'] && !(typeof data['eEzsigntemplatedocumentForm'] === 'string' || data['eEzsigntemplatedocumentForm'] instanceof String)) {
            throw new Error("Expected the field `eEzsigntemplatedocumentForm` to be a primitive type in the JSON string but got " + data['eEzsigntemplatedocumentForm']);
        }
        // ensure the json data is a string
        if (data['sEzsigntemplatedocumentPassword'] && !(typeof data['sEzsigntemplatedocumentPassword'] === 'string' || data['sEzsigntemplatedocumentPassword'] instanceof String)) {
            throw new Error("Expected the field `sEzsigntemplatedocumentPassword` to be a primitive type in the JSON string but got " + data['sEzsigntemplatedocumentPassword']);
        }
...
EzsigntemplatedocumentRequest.RequiredProperties = ["fkiEzsigntemplateID", "sEzsigntemplatedocumentName", "eEzsigntemplatedocumentSource"];
