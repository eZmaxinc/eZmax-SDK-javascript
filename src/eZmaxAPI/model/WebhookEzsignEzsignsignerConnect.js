...
/**
 * The WebhookEzsignEzsignsignerConnect model module.
 * @module eZmaxAPI/model/WebhookEzsignEzsignsignerConnect
 * @version 1.2.0
 */
class WebhookEzsignEzsignsignerConnect {
    /**
     * Constructs a new <code>WebhookEzsignEzsignsignerConnect</code>.
     * This is the base Webhook object
     * @alias module:eZmaxAPI/model/WebhookEzsignEzsignsignerConnect
    ...
    constructor(objWebhook, a_objAttempt, objEzsignfoldersignerassociation) { 
        ...
        WebhookEzsignEzsignsignerConnect.initialize(this, objWebhook, a_objAttempt, objEzsignfoldersignerassociation);
    }
    ...
    /**
     * Constructs a <code>WebhookEzsignEzsignsignerConnect</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/WebhookEzsignEzsignsignerConnect} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/WebhookEzsignEzsignsignerConnect} The populated <code>WebhookEzsignEzsignsignerConnect</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookEzsignEzsignsignerConnect();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookEzsignEzsignsignerConnect</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookEzsignEzsignsignerConnect</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookEzsignEzsignsignerConnect.RequiredProperties) {
...
WebhookEzsignEzsignsignerConnect.RequiredProperties = ["objWebhook", "a_objAttempt", "objEzsignfoldersignerassociation"];

/**
 * @member {module:eZmaxAPI/model/CustomWebhookResponse} objWebhook
 */
WebhookEzsignEzsignsignerConnect.prototype['objWebhook'] = undefined;

/**
 * An array containing details of previous attempts that were made to deliver the message. The array is empty if it's the first attempt.
 * @member {Array.<module:eZmaxAPI/model/AttemptResponseCompound>} a_objAttempt
 */
WebhookEzsignEzsignsignerConnect.prototype['a_objAttempt'] = undefined;

/**
 * @member {module:eZmaxAPI/model/EzsignfolderResponse} objEzsignfolder
 */
WebhookEzsignEzsignsignerConnect.prototype['objEzsignfolder'] = undefined;

/**
 * @member {module:eZmaxAPI/model/EzsignfoldersignerassociationResponseCompound} objEzsignfoldersignerassociation
 */
WebhookEzsignEzsignsignerConnect.prototype['objEzsignfoldersignerassociation'] = undefined;
...
export default WebhookEzsignEzsignsignerConnect;
