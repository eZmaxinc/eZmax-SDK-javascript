...
class EzsignfoldersignerassociationResponseCompound {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignfoldersignerassociationResponseCompound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignfoldersignerassociationResponseCompound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignfoldersignerassociationResponseCompound.RequiredProperties) {
            if (!data[property]) {
...
EzsignfoldersignerassociationResponseCompound.RequiredProperties = ["pkiEzsignfoldersignerassociationID", "fkiEzsignfolderID", "bEzsignfoldersignerassociationDelayedsend", "bEzsignfoldersignerassociationReceivecopy", "tEzsignfoldersignerassociationMessage"];
