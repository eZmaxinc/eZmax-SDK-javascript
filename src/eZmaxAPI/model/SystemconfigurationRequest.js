...
/**
 * The SystemconfigurationRequest model module.
 * @module eZmaxAPI/model/SystemconfigurationRequest
 * @version 1.2.0
 */
class SystemconfigurationRequest {
    /**
     * Constructs a new <code>SystemconfigurationRequest</code>.
     * A Systemconfiguration Object
     * @alias module:eZmaxAPI/model/SystemconfigurationRequest
    ...
    /**
     * Constructs a <code>SystemconfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/SystemconfigurationRequest} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/SystemconfigurationRequest} The populated <code>SystemconfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SystemconfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SystemconfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SystemconfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SystemconfigurationRequest.RequiredProperties) {
            if (!data[property]) {
...
SystemconfigurationRequest.RequiredProperties = ["eSystemconfigurationNewexternaluseraction", "eSystemconfigurationLanguage1", "eSystemconfigurationLanguage2", "bSystemconfigurationEzsignpersonnal", "bSystemconfigurationSspr"];
...
export default SystemconfigurationRequest;
