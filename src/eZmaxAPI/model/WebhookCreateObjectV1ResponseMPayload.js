...
class WebhookCreateObjectV1ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookCreateObjectV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookCreateObjectV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookCreateObjectV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is an array
        if (!Array.isArray(data['a_pkiWebhookID'])) {
            throw new Error("Expected the field `a_pkiWebhookID` to be an array in the JSON data but got " + data['a_pkiWebhookID']);
        }
...
WebhookCreateObjectV1ResponseMPayload.RequiredProperties = ["a_pkiWebhookID"];
