...
class EzsignbulksenddocumentmappingGetObjectV1ResponseMPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>EzsignbulksenddocumentmappingGetObjectV1ResponseMPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsignbulksenddocumentmappingGetObjectV1ResponseMPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsignbulksenddocumentmappingGetObjectV1ResponseMPayload.RequiredProperties) {
            if (!data[property]) {
...
EzsignbulksenddocumentmappingGetObjectV1ResponseMPayload.RequiredProperties = ["pkiEzsignbulksenddocumentmappingID", "fkiEzsignbulksendID", "iEzsignbulksenddocumentmappingOrder"];
