...
/**
 * The EzmaxinvoicingsummaryinternaldetailResponse model module.
 * @module eZmaxAPI/model/EzmaxinvoicingsummaryinternaldetailResponse
 * @version 1.2.0
 */
class EzmaxinvoicingsummaryinternaldetailResponse {
    /**
     * Constructs a new <code>EzmaxinvoicingsummaryinternaldetailResponse</code>.
     * A Ezmaxinvoicingsummaryinternaldetail Object
     * @alias module:eZmaxAPI/model/EzmaxinvoicingsummaryinternaldetailResponse
    ...
    /**
     * Constructs a <code>EzmaxinvoicingsummaryinternaldetailResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzmaxinvoicingsummaryinternaldetailResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzmaxinvoicingsummaryinternaldetailResponse} The populated <code>EzmaxinvoicingsummaryinternaldetailResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzmaxinvoicingsummaryinternaldetailResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EzmaxinvoicingsummaryinternaldetailResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzmaxinvoicingsummaryinternaldetailResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzmaxinvoicingsummaryinternaldetailResponse.RequiredProperties) {
            if (!data[property]) {
...
export default EzmaxinvoicingsummaryinternaldetailResponse;
