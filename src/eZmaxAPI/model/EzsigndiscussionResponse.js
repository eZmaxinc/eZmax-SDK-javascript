...
/**
 * The EzsigndiscussionResponse model module.
 * @module eZmaxAPI/model/EzsigndiscussionResponse
 * @version 1.2.0
 */
class EzsigndiscussionResponse {
    /**
     * Constructs a new <code>EzsigndiscussionResponse</code>.
     * A Ezsigndiscussion Object
     * @alias module:eZmaxAPI/model/EzsigndiscussionResponse
    ...
    /**
     * Constructs a <code>EzsigndiscussionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:eZmaxAPI/model/EzsigndiscussionResponse} obj Optional instance to populate.
     * @return {module:eZmaxAPI/model/EzsigndiscussionResponse} The populated <code>EzsigndiscussionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EzsigndiscussionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EzsigndiscussionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzsigndiscussionResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzsigndiscussionResponse.RequiredProperties) {
...
EzsigndiscussionResponse.RequiredProperties = ["pkiEzsigndiscussionID", "fkiEzsignpageID", "fkiDiscussionID", "iEzsigndiscussionX", "iEzsigndiscussionY", "iEzsigndiscussionPagenumber", "objDiscussion"];
...
export default EzsigndiscussionResponse;
