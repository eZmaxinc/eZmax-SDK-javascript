...
* @alias module:eZmaxAPI/ApiClient
* @class
*/
class ApiClient {
    /**
     ...
     */
    constructor(basePath = 'https://prod.api.appcluster01.ca-central-1.ezmax.com/rest') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
        ...
        this.authentications = {
            ...
            'Bearer': {type: 'bearer'},
            'Presigned': {type: 'apiKey', 'in': 'query', name: 'sAuthorization'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.1.18/Javascript'
        };
    ...
    * @param {module:eZmaxAPI/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
    ...
    * @callback module:eZmaxAPI/ApiClient~callApiCallback
    ...
    * @param {module:eZmaxAPI/ApiClient~callApiCallback} callback The callback function.
...
* @type {module:eZmaxAPI/ApiClient}
*/
