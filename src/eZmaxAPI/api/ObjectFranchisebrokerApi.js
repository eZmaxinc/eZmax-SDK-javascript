...
export default class ObjectFranchisebrokerApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the franchisebrokerGetAutocompleteV2 operation.
     * @callback module:eZmaxAPI/api/ObjectFranchisebrokerApi~franchisebrokerGetAutocompleteV2Callback
     * @param {String} error Error message, if any.
     * @param {module:eZmaxAPI/model/FranchisebrokerGetAutocompleteV2Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     */
    franchisebrokerGetAutocompleteV2(sSelector, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'sSelector' is set
      if (sSelector === undefined || sSelector === null) {
        throw new Error("Missing the required parameter 'sSelector' when calling franchisebrokerGetAutocompleteV2");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FranchisebrokerGetAutocompleteV2Response;
      return this.apiClient.callApi(
