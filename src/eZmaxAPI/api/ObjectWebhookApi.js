...
export default class ObjectWebhookApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the webhookTestUrlV1 operation.
     * @callback module:eZmaxAPI/api/ObjectWebhookApi~webhookTestUrlV1Callback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {Number} pkiWebhookID 
     * @param {module:eZmaxAPI/api/ObjectWebhookApi~webhookTestUrlV1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:eZmaxAPI/model/WebhookTestV1Response}
     */
    webhookTestUrlV1(pkiWebhookID, callback) {
      let postBody = null;
      // verify the required parameter 'pkiWebhookID' is set
      if (pkiWebhookID === undefined || pkiWebhookID === null) {
        throw new Error("Missing the required parameter 'pkiWebhookID' when calling webhookTestUrlV1");
      }
