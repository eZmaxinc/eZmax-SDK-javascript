...
export default class ObjectUserApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the userGetAutocompleteV1 operation.
     * @callback module:eZmaxAPI/api/ObjectUserApi~userGetAutocompleteV1Callback
     ...
     * @param {module:eZmaxAPI/api/ObjectUserApi~userGetAutocompleteV1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:eZmaxAPI/model/CommonGetAutocompleteV1Response}
     */
    userGetAutocompleteV1(sSelector, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'sSelector' is set
      if (sSelector === undefined || sSelector === null) {
        throw new Error("Missing the required parameter 'sSelector' when calling userGetAutocompleteV1");
      }
      ...
      return this.apiClient.callApi(
        '/1/object/user/getAutocomplete/{sSelector}', 'GET',
