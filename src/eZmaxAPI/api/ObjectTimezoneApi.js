...
/**
* ObjectTimezone service.
* @module eZmaxAPI/api/ObjectTimezoneApi
* @version 1.1.13
*/
export default class ObjectTimezoneApi {

    /**
    * Constructs a new ObjectTimezoneApi. 
    * @alias module:eZmaxAPI/api/ObjectTimezoneApi
    * @class
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:eZmaxAPI/model/TimezoneGetAutocompleteV2Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     */
    timezoneGetAutocompleteV2(sSelector, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'sSelector' is set
      if (sSelector === undefined || sSelector === null) {
        throw new Error("Missing the required parameter 'sSelector' when calling timezoneGetAutocompleteV2");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TimezoneGetAutocompleteV2Response;
      return this.apiClient.callApi(
        '/2/object/timezone/getAutocomplete/{sSelector}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
