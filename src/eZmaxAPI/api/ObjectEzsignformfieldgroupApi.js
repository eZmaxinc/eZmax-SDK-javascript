...
export default class ObjectEzsignformfieldgroupApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the ezsignformfieldgroupGetObjectV2 operation.
     * @callback module:eZmaxAPI/api/ObjectEzsignformfieldgroupApi~ezsignformfieldgroupGetObjectV2Callback
     * @param {String} error Error message, if any.
     * @param {module:eZmaxAPI/model/EzsignformfieldgroupGetObjectV2Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {Number} pkiEzsignformfieldgroupID 
     * @param {module:eZmaxAPI/api/ObjectEzsignformfieldgroupApi~ezsignformfieldgroupGetObjectV2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:eZmaxAPI/model/EzsignformfieldgroupGetObjectV2Response}
     */
    ezsignformfieldgroupGetObjectV2(pkiEzsignformfieldgroupID, callback) {
      let postBody = null;
      // verify the required parameter 'pkiEzsignformfieldgroupID' is set
      if (pkiEzsignformfieldgroupID === undefined || pkiEzsignformfieldgroupID === null) {
        throw new Error("Missing the required parameter 'pkiEzsignformfieldgroupID' when calling ezsignformfieldgroupGetObjectV2");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = EzsignformfieldgroupGetObjectV2Response;
      return this.apiClient.callApi(
        '/2/object/ezsignformfieldgroup/{pkiEzsignformfieldgroupID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
