...
export default class ObjectEzsignfolderApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the ezsignfolderGetObjectGetChildrenV1 operation.
     * @callback module:eZmaxAPI/api/ObjectEzsignfolderApi~ezsignfolderGetObjectGetChildrenV1Callback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} pkiEzsignfolderID The unique ID of the Ezsignfolder
     * @param {module:eZmaxAPI/api/ObjectEzsignfolderApi~ezsignfolderGetObjectGetChildrenV1Callback} callback The callback function, accepting three arguments: error, data, response
     */
    ezsignfolderGetObjectGetChildrenV1(pkiEzsignfolderID, callback) {
      let postBody = null;
      // verify the required parameter 'pkiEzsignfolderID' is set
      if (pkiEzsignfolderID === undefined || pkiEzsignfolderID === null) {
        throw new Error("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetObjectGetChildrenV1");
      }
