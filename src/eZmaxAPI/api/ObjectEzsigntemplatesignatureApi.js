...
export default class ObjectEzsigntemplatesignatureApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the ezsigntemplatesignatureGetObjectV2 operation.
     * @callback module:eZmaxAPI/api/ObjectEzsigntemplatesignatureApi~ezsigntemplatesignatureGetObjectV2Callback
     * @param {String} error Error message, if any.
     * @param {module:eZmaxAPI/model/EzsigntemplatesignatureGetObjectV2Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {Number} pkiEzsigntemplatesignatureID 
     * @param {module:eZmaxAPI/api/ObjectEzsigntemplatesignatureApi~ezsigntemplatesignatureGetObjectV2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:eZmaxAPI/model/EzsigntemplatesignatureGetObjectV2Response}
     */
    ezsigntemplatesignatureGetObjectV2(pkiEzsigntemplatesignatureID, callback) {
      let postBody = null;
      // verify the required parameter 'pkiEzsigntemplatesignatureID' is set
      if (pkiEzsigntemplatesignatureID === undefined || pkiEzsigntemplatesignatureID === null) {
        throw new Error("Missing the required parameter 'pkiEzsigntemplatesignatureID' when calling ezsigntemplatesignatureGetObjectV2");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = EzsigntemplatesignatureGetObjectV2Response;
      return this.apiClient.callApi(
