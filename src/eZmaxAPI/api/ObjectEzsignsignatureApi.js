...
export default class ObjectEzsignsignatureApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the ezsignsignatureGetEzsignsignatureattachmentV1 operation.
     * @callback module:eZmaxAPI/api/ObjectEzsignsignatureApi~ezsignsignatureGetEzsignsignatureattachmentV1Callback
     * @param {String} error Error message, if any.
     * @param {module:eZmaxAPI/model/EzsignsignatureGetEzsignsignatureattachmentV1Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} pkiEzsignsignatureID 
     * @param {module:eZmaxAPI/api/ObjectEzsignsignatureApi~ezsignsignatureGetEzsignsignatureattachmentV1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:eZmaxAPI/model/EzsignsignatureGetEzsignsignatureattachmentV1Response}
     */
    ezsignsignatureGetEzsignsignatureattachmentV1(pkiEzsignsignatureID, callback) {
      let postBody = null;
      // verify the required parameter 'pkiEzsignsignatureID' is set
      if (pkiEzsignsignatureID === undefined || pkiEzsignsignatureID === null) {
        throw new Error("Missing the required parameter 'pkiEzsignsignatureID' when calling ezsignsignatureGetEzsignsignatureattachmentV1");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = EzsignsignatureGetEzsignsignatureattachmentV1Response;
      return this.apiClient.callApi(
