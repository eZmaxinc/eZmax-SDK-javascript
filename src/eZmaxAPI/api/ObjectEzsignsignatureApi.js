...
export default class ObjectEzsignsignatureApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the ezsignsignatureGetObjectGetChildrenV1 operation.
     * @callback module:eZmaxAPI/api/ObjectEzsignsignatureApi~ezsignsignatureGetObjectGetChildrenV1Callback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} pkiEzsignsignatureID The unique ID of the Ezsignsignature
     * @param {module:eZmaxAPI/api/ObjectEzsignsignatureApi~ezsignsignatureGetObjectGetChildrenV1Callback} callback The callback function, accepting three arguments: error, data, response
     */
    ezsignsignatureGetObjectGetChildrenV1(pkiEzsignsignatureID, callback) {
      let postBody = null;
      // verify the required parameter 'pkiEzsignsignatureID' is set
      if (pkiEzsignsignatureID === undefined || pkiEzsignsignatureID === null) {
        throw new Error("Missing the required parameter 'pkiEzsignsignatureID' when calling ezsignsignatureGetObjectGetChildrenV1");
      }
