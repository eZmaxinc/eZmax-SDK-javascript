# EZmaxApiDefinitionFull.ObjectModuleApi
...
> ModuleGetAutocompleteV2Response moduleGetAutocompleteV2(sSelector, opts)
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectModuleApi();
...
apiInstance.moduleGetAutocompleteV2(sSelector, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
