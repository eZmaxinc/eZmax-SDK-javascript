# EZmaxApiDefinitionFull.ObjectClonehistoryApi
...
> ClonehistoryGetListV1Response clonehistoryGetListV1(opts)
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectClonehistoryApi();
let opts = {
...
apiInstance.clonehistoryGetListV1(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
