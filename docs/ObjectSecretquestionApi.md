# EZmaxApiDefinitionFull.ObjectSecretquestionApi
...
> CommonGetAutocompleteV1Response secretquestionGetAutocompleteV1(sSelector, opts)
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectSecretquestionApi();
...
apiInstance.secretquestionGetAutocompleteV1(sSelector, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> SecretquestionGetAutocompleteV2Response secretquestionGetAutocompleteV2(sSelector, opts)
...
apiInstance.secretquestionGetAutocompleteV2(sSelector, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
