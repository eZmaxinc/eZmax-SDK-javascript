# EZmaxApiDefinitionFull.ObjectBillingentityexternalApi
...
> BillingentityexternalGetAutocompleteV2Response billingentityexternalGetAutocompleteV2(sSelector, opts)
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectBillingentityexternalApi();
...
apiInstance.billingentityexternalGetAutocompleteV2(sSelector, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
