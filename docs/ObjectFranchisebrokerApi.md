# EZmaxApiDefinitionFull.ObjectFranchisebrokerApi
...
> FranchisebrokerGetAutocompleteV2Response franchisebrokerGetAutocompleteV2(sSelector, opts)
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectFranchisebrokerApi();
...
apiInstance.franchisebrokerGetAutocompleteV2(sSelector, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
