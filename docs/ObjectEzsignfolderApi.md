...
let apiInstance = new EZmaxApiDefinitionFull.ObjectEzsignfolderApi();
let pkiEzsignfolderID = 56; // Number | 
apiInstance.ezsignfolderGetAttachmentCountV1(pkiEzsignfolderID, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectEzsignfolderApi();
let pkiEzsignfolderID = 56; // Number | 
apiInstance.ezsignfolderGetAttachmentsV1(pkiEzsignfolderID, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectEzsignfolderApi();
let pkiEzsignfolderID = 56; // Number | 
apiInstance.ezsignfolderGetCommunicationrecipientsV1(pkiEzsignfolderID, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectEzsignfolderApi();
let pkiEzsignfolderID = 56; // Number | 
apiInstance.ezsignfolderGetCommunicationsendersV1(pkiEzsignfolderID, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
