# EZmaxApiDefinitionFull.ObjectInscriptiontempApi
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectInscriptiontempApi();
let pkiInscriptiontempID = 56; // Number | 
apiInstance.inscriptiontempGetCommunicationListV1(pkiInscriptiontempID, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
