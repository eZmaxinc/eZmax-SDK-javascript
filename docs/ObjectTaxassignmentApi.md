...
> TaxassignmentGetAutocompleteV2Response taxassignmentGetAutocompleteV2(sSelector, opts)
...
apiInstance.taxassignmentGetAutocompleteV2(sSelector, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
