...
let apiInstance = new EZmaxApiDefinitionFull.ObjectEzsigndocumentApi();
let pkiEzsigndocumentID = 56; // Number | 
let EzsigndocumentCreateEzsignelementsPositionedByWordV1Request = new EZmaxApiDefinitionFull.EzsigndocumentCreateEzsignelementsPositionedByWordV1Request(); // EzsigndocumentCreateEzsignelementsPositionedByWordV1Request | 
apiInstance.ezsigndocumentCreateEzsignelementsPositionedByWordV1(pkiEzsigndocumentID, EzsigndocumentCreateEzsignelementsPositionedByWordV1Request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectEzsigndocumentApi();
let pkiEzsigndocumentID = 56; // Number | 
let EzsigndocumentDeclineToSignV1Request = new EZmaxApiDefinitionFull.EzsigndocumentDeclineToSignV1Request(); // EzsigndocumentDeclineToSignV1Request | 
apiInstance.ezsigndocumentDeclineToSignV1(pkiEzsigndocumentID, EzsigndocumentDeclineToSignV1Request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectEzsigndocumentApi();
let pkiEzsigndocumentID = 56; // Number | 
apiInstance.ezsigndocumentGetAttachmentsV1(pkiEzsigndocumentID, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectEzsigndocumentApi();
let pkiEzsigndocumentID = 56; // Number | 
apiInstance.ezsigndocumentGetEzsigndiscussionsV1(pkiEzsigndocumentID, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectEzsigndocumentApi();
let pkiEzsigndocumentID = 56; // Number | 
let EzsigndocumentSubmitEzsignformV1Request = new EZmaxApiDefinitionFull.EzsigndocumentSubmitEzsignformV1Request(); // EzsigndocumentSubmitEzsignformV1Request | 
apiInstance.ezsigndocumentSubmitEzsignformV1(pkiEzsigndocumentID, EzsigndocumentSubmitEzsignformV1Request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
