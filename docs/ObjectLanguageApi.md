# EZmaxApiDefinitionFull.ObjectLanguageApi
...
> LanguageGetAutocompleteV2Response languageGetAutocompleteV2(sSelector, opts)
...
let apiInstance = new EZmaxApiDefinitionFull.ObjectLanguageApi();
...
apiInstance.languageGetAutocompleteV2(sSelector, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
