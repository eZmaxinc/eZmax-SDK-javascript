...
(function(root, factory) {
  ...
  describe('ObjectEzsigntemplateApi', function() {
    describe('ezsigntemplateCopyV1', function() {
      it('should call ezsigntemplateCopyV1 successfully', function(done) {
        //uncomment below and update the code to test ezsigntemplateCopyV1
        //instance.ezsigntemplateCopyV1(function(error) {
    ...
    describe('ezsigntemplateGetAutocompleteV2', function() {
      it('should call ezsigntemplateGetAutocompleteV2 successfully', function(done) {
        ...
        //instance.ezsigntemplateGetAutocompleteV2(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('ezsigntemplateGetObjectV2', function() {
      it('should call ezsigntemplateGetObjectV2 successfully', function(done) {
        //uncomment below and update the code to test ezsigntemplateGetObjectV2
        //instance.ezsigntemplateGetObjectV2(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
