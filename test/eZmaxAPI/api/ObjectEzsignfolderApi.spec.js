...
(function(root, factory) {
  ...
  describe('ObjectEzsignfolderApi', function() {
    ...
    describe('ezsignfolderGetObjectGetChildrenV1', function() {
      it('should call ezsignfolderGetObjectGetChildrenV1 successfully', function(done) {
        //uncomment below and update the code to test ezsignfolderGetObjectGetChildrenV1
        //instance.ezsignfolderGetObjectGetChildrenV1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
