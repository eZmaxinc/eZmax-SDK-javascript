...
(function(root, factory) {
  ...
  describe('ObjectEzsignsignatureApi', function() {
    ...
    describe('ezsignsignatureGetObjectGetChildrenV1', function() {
      it('should call ezsignsignatureGetObjectGetChildrenV1 successfully', function(done) {
        //uncomment below and update the code to test ezsignsignatureGetObjectGetChildrenV1
        //instance.ezsignsignatureGetObjectGetChildrenV1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
