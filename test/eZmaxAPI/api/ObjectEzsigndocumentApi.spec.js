...
(function(root, factory) {
  ...
  describe('ObjectEzsigndocumentApi', function() {
    ...
    describe('ezsigndocumentGetObjectGetChildrenV1', function() {
      it('should call ezsigndocumentGetObjectGetChildrenV1 successfully', function(done) {
        //uncomment below and update the code to test ezsigndocumentGetObjectGetChildrenV1
        //instance.ezsigndocumentGetObjectGetChildrenV1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
