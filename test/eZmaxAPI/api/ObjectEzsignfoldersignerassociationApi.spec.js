...
(function(root, factory) {
  ...
  describe('ObjectEzsignfoldersignerassociationApi', function() {
    ...
    describe('ezsignfoldersignerassociationForceDisconnectV1', function() {
      it('should call ezsignfoldersignerassociationForceDisconnectV1 successfully', function(done) {
        //uncomment below and update the code to test ezsignfoldersignerassociationForceDisconnectV1
        //instance.ezsignfoldersignerassociationForceDisconnectV1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('ezsignfoldersignerassociationGetObjectV2', function() {
      it('should call ezsignfoldersignerassociationGetObjectV2 successfully', function(done) {
        //uncomment below and update the code to test ezsignfoldersignerassociationGetObjectV2
        //instance.ezsignfoldersignerassociationGetObjectV2(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('ezsignfoldersignerassociationPatchObjectV1', function() {
      it('should call ezsignfoldersignerassociationPatchObjectV1 successfully', function(done) {
        //uncomment below and update the code to test ezsignfoldersignerassociationPatchObjectV1
        //instance.ezsignfoldersignerassociationPatchObjectV1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
