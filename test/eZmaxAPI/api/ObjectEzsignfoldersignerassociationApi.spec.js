...
(function(root, factory) {
  ...
  describe('ObjectEzsignfoldersignerassociationApi', function() {
    ...
    describe('ezsignfoldersignerassociationGetChildrenV1', function() {
      it('should call ezsignfoldersignerassociationGetChildrenV1 successfully', function(done) {
        //uncomment below and update the code to test ezsignfoldersignerassociationGetChildrenV1
        //instance.ezsignfoldersignerassociationGetChildrenV1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
