...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatepackageResponseCompound();
  });
  ...
  describe('EzsigntemplatepackageResponseCompound', function() {
    it('should create an instance of EzsigntemplatepackageResponseCompound', function() {
      // uncomment below and update the code to test EzsigntemplatepackageResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatepackageResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatepackageResponseCompound);
    });
