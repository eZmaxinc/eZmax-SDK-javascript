...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfolderGetEzsignfoldersignerassociationsV1Response();
  });
  ...
  describe('EzsignfolderGetEzsignfoldersignerassociationsV1Response', function() {
    it('should create an instance of EzsignfolderGetEzsignfoldersignerassociationsV1Response', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignfolderGetEzsignfoldersignerassociationsV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfolderGetEzsignfoldersignerassociationsV1Response);
    });
