...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.SignatureGetObjectV2Response();
  });
  ...
  describe('SignatureGetObjectV2Response', function() {
    it('should create an instance of SignatureGetObjectV2Response', function() {
      // uncomment below and update the code to test SignatureGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.SignatureGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.SignatureGetObjectV2Response);
    });
