...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BillingentityinternalGetListV1ResponseMPayload();
  });
  ...
  describe('BillingentityinternalGetListV1ResponseMPayload', function() {
    it('should create an instance of BillingentityinternalGetListV1ResponseMPayload', function() {
      // uncomment below and update the code to test BillingentityinternalGetListV1ResponseMPayload
