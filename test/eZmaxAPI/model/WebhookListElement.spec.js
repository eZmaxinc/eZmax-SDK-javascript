...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookListElement();
  });
  ...
  describe('WebhookListElement', function() {
    it('should create an instance of WebhookListElement', function() {
      // uncomment below and update the code to test WebhookListElement
      //var instance = new EZmaxApiDefinitionFull.WebhookListElement();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookListElement);
    });
