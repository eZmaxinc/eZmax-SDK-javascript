...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipResponse();
  });
  ...
  describe('EzsigntemplatepackagemembershipResponse', function() {
    it('should create an instance of EzsigntemplatepackagemembershipResponse', function() {
      // uncomment below and update the code to test EzsigntemplatepackagemembershipResponse
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipResponse);
    });
