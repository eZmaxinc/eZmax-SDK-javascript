...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserGetPermissionsV1Response();
  });
  ...
  describe('UserGetPermissionsV1Response', function() {
    it('should create an instance of UserGetPermissionsV1Response', function() {
      // uncomment below and update the code to test UserGetPermissionsV1Response
      //var instance = new EZmaxApiDefinitionFull.UserGetPermissionsV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserGetPermissionsV1Response);
    });
