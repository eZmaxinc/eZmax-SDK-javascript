...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzmaxinvoicingsummaryexternalResponse();
  });
  ...
  describe('EzmaxinvoicingsummaryexternalResponse', function() {
    it('should create an instance of EzmaxinvoicingsummaryexternalResponse', function() {
      // uncomment below and update the code to test EzmaxinvoicingsummaryexternalResponse
      //var instance = new EZmaxApiDefinitionFull.EzmaxinvoicingsummaryexternalResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzmaxinvoicingsummaryexternalResponse);
    });
