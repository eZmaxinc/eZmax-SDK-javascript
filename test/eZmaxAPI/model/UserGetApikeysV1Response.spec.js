...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserGetApikeysV1Response();
  });
  ...
  describe('UserGetApikeysV1Response', function() {
    it('should create an instance of UserGetApikeysV1Response', function() {
      // uncomment below and update the code to test UserGetApikeysV1Response
      //var instance = new EZmaxApiDefinitionFull.UserGetApikeysV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserGetApikeysV1Response);
    });
