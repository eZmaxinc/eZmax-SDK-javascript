...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserListElement();
  });
  ...
  describe('UserListElement', function() {
    it('should create an instance of UserListElement', function() {
      // uncomment below and update the code to test UserListElement
      //var instance = new EZmaxApiDefinitionFull.UserListElement();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserListElement);
    });
