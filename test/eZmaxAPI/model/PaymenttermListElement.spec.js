...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PaymenttermListElement();
  });
  ...
  describe('PaymenttermListElement', function() {
    it('should create an instance of PaymenttermListElement', function() {
      // uncomment below and update the code to test PaymenttermListElement
      //var instance = new EZmaxApiDefinitionFull.PaymenttermListElement();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PaymenttermListElement);
    });
