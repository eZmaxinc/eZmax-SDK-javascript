...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignSuggestTemplatesV1ResponseMPayload();
  });
  ...
  describe('EzsignSuggestTemplatesV1ResponseMPayload', function() {
    it('should create an instance of EzsignSuggestTemplatesV1ResponseMPayload', function() {
      // uncomment below and update the code to test EzsignSuggestTemplatesV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.EzsignSuggestTemplatesV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignSuggestTemplatesV1ResponseMPayload);
    });
