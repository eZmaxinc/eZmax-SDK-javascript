...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BrandingGetListV1ResponseMPayload();
  });
  ...
  describe('BrandingGetListV1ResponseMPayload', function() {
    it('should create an instance of BrandingGetListV1ResponseMPayload', function() {
      // uncomment below and update the code to test BrandingGetListV1ResponseMPayload
