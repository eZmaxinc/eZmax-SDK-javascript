...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignfolderResponseAllOf();
  });
  ...
  describe('EzsignfolderResponseAllOf', function() {
    it('should create an instance of EzsignfolderResponseAllOf', function() {
      // uncomment below and update the code to test EzsignfolderResponseAllOf
      //var instane = new EZmaxApiDefinition.EzsignfolderResponseAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignfolderResponseAllOf);
    });
    ...
    it('should have the property fkiEzsignfoldertypeID (base name: "fkiEzsignfoldertypeID")', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignfolderResponseAllOf();
