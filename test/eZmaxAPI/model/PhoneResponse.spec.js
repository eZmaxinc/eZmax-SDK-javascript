...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PhoneResponse();
  });
  ...
  describe('PhoneResponse', function() {
    it('should create an instance of PhoneResponse', function() {
      // uncomment below and update the code to test PhoneResponse
      //var instance = new EZmaxApiDefinitionFull.PhoneResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PhoneResponse);
    });
