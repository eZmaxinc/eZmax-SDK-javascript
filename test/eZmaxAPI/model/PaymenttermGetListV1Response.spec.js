...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PaymenttermGetListV1Response();
  });
  ...
  describe('PaymenttermGetListV1Response', function() {
    it('should create an instance of PaymenttermGetListV1Response', function() {
      // uncomment below and update the code to test PaymenttermGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.PaymenttermGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PaymenttermGetListV1Response);
    });
