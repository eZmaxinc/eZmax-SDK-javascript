...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipRequest();
  });
  ...
  describe('EzsigntemplatepackagemembershipRequest', function() {
    it('should create an instance of EzsigntemplatepackagemembershipRequest', function() {
      // uncomment below and update the code to test EzsigntemplatepackagemembershipRequest
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipRequest);
    });
