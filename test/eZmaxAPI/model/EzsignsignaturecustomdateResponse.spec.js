...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignsignaturecustomdateResponse();
  });
  ...
  describe('EzsignsignaturecustomdateResponse', function() {
    it('should create an instance of EzsignsignaturecustomdateResponse', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignsignaturecustomdateResponse();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignsignaturecustomdateResponse);
    });
