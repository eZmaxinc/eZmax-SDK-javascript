...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignsignaturecustomdateResponse();
  });
  ...
  describe('EzsignsignaturecustomdateResponse', function() {
    it('should create an instance of EzsignsignaturecustomdateResponse', function() {
      // uncomment below and update the code to test EzsignsignaturecustomdateResponse
      //var instance = new EZmaxApiDefinitionFull.EzsignsignaturecustomdateResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignsignaturecustomdateResponse);
    });
