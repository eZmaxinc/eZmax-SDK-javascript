...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupResponse();
  });
  ...
  describe('EzsigntemplateformfieldgroupResponse', function() {
    it('should create an instance of EzsigntemplateformfieldgroupResponse', function() {
      // uncomment below and update the code to test EzsigntemplateformfieldgroupResponse
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupResponse);
    });
