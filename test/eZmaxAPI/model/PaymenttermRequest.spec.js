...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PaymenttermRequest();
  });
  ...
  describe('PaymenttermRequest', function() {
    it('should create an instance of PaymenttermRequest', function() {
      // uncomment below and update the code to test PaymenttermRequest
      //var instance = new EZmaxApiDefinitionFull.PaymenttermRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PaymenttermRequest);
    });
