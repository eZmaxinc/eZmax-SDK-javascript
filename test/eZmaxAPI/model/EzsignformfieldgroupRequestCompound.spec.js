...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignformfieldgroupRequestCompound();
  });
  ...
  describe('EzsignformfieldgroupRequestCompound', function() {
    it('should create an instance of EzsignformfieldgroupRequestCompound', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignformfieldgroupRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignformfieldgroupRequestCompound);
    });
