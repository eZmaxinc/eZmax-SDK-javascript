...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldertypeGetListV1ResponseAllOf();
  });
  ...
  describe('EzsignfoldertypeGetListV1ResponseAllOf', function() {
    it('should create an instance of EzsignfoldertypeGetListV1ResponseAllOf', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeGetListV1ResponseAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldertypeGetListV1ResponseAllOf);
    });
