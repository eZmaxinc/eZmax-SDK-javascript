...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BrandingGetObjectV2Response();
  });
  ...
  describe('BrandingGetObjectV2Response', function() {
    it('should create an instance of BrandingGetObjectV2Response', function() {
      // uncomment below and update the code to test BrandingGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.BrandingGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.BrandingGetObjectV2Response);
    });
