...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload();
  });
  ...
  describe('EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload', function() {
    it('should create an instance of EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload);
    });
