...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EmailResponse();
  });
  ...
  describe('EmailResponse', function() {
    it('should create an instance of EmailResponse', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EmailResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EmailResponse);
    });
