...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignformfieldgroupRequest();
  });
  ...
  describe('EzsignformfieldgroupRequest', function() {
    it('should create an instance of EzsignformfieldgroupRequest', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignformfieldgroupRequest();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignformfieldgroupRequest);
    });
