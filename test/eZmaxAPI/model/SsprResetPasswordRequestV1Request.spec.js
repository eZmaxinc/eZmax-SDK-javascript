...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.SsprResetPasswordRequestV1Request();
  });
  ...
  describe('SsprResetPasswordRequestV1Request', function() {
    it('should create an instance of SsprResetPasswordRequestV1Request', function() {
      // uncomment below and update the code to test SsprResetPasswordRequestV1Request
      //var instane = new EZmaxApiDefinition.SsprResetPasswordRequestV1Request();
      //expect(instance).to.be.a(EZmaxApiDefinition.SsprResetPasswordRequestV1Request);
    });
    ...
    it('should have the property pksCustomerCode (base name: "pksCustomerCode")', function() {
      ...
      //var instance = new EZmaxApiDefinition.SsprResetPasswordRequestV1Request();
