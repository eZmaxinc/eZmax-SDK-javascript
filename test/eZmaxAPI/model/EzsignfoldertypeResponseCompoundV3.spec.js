...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldertypeResponseCompoundV3();
  });
  ...
  describe('EzsignfoldertypeResponseCompoundV3', function() {
    it('should create an instance of EzsignfoldertypeResponseCompoundV3', function() {
      // uncomment below and update the code to test EzsignfoldertypeResponseCompoundV3
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeResponseCompoundV3();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldertypeResponseCompoundV3);
    });
    ...
    it('should have the property a_objUserlogintype (base name: "a_objUserlogintype")', function() {
      // uncomment below and update the code to test the property a_objUserlogintype
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeResponseCompoundV3();
      //expect(instance).to.be();
    });

    it('should have the property a_objUsergroupAll (base name: "a_objUsergroupAll")', function() {
      // uncomment below and update the code to test the property a_objUsergroupAll
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeResponseCompoundV3();
      //expect(instance).to.be();
    });

    it('should have the property a_objUsergroupRestricted (base name: "a_objUsergroupRestricted")', function() {
      // uncomment below and update the code to test the property a_objUsergroupRestricted
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeResponseCompoundV3();
      //expect(instance).to.be();
    });

    it('should have the property a_objUsergroupTemplate (base name: "a_objUsergroupTemplate")', function() {
      // uncomment below and update the code to test the property a_objUsergroupTemplate
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeResponseCompoundV3();
      //expect(instance).to.be();
    });
