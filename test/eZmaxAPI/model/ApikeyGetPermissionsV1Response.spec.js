...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ApikeyGetPermissionsV1Response();
  });
  ...
  describe('ApikeyGetPermissionsV1Response', function() {
    it('should create an instance of ApikeyGetPermissionsV1Response', function() {
      // uncomment below and update the code to test ApikeyGetPermissionsV1Response
      //var instance = new EZmaxApiDefinitionFull.ApikeyGetPermissionsV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ApikeyGetPermissionsV1Response);
    });
