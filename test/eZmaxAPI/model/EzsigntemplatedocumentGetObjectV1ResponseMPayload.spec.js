...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatedocumentGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzsigntemplatedocumentGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsigntemplatedocumentGetObjectV1ResponseMPayload', function() {
      // uncomment below and update the code to test EzsigntemplatedocumentGetObjectV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatedocumentGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatedocumentGetObjectV1ResponseMPayload);
    });
