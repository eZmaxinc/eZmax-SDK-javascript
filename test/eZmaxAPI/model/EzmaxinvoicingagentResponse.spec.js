...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzmaxinvoicingagentResponse();
  });
  ...
  describe('EzmaxinvoicingagentResponse', function() {
    it('should create an instance of EzmaxinvoicingagentResponse', function() {
      // uncomment below and update the code to test EzmaxinvoicingagentResponse
      //var instance = new EZmaxApiDefinitionFull.EzmaxinvoicingagentResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzmaxinvoicingagentResponse);
    });
