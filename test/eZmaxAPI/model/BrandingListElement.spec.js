...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BrandingListElement();
  });
  ...
  describe('BrandingListElement', function() {
    it('should create an instance of BrandingListElement', function() {
      // uncomment below and update the code to test BrandingListElement
      //var instance = new EZmaxApiDefinitionFull.BrandingListElement();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.BrandingListElement);
    });
