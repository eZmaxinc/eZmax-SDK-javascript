...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatedocumentRequestCompound();
  });
  ...
  describe('EzsigntemplatedocumentRequestCompound', function() {
    it('should create an instance of EzsigntemplatedocumentRequestCompound', function() {
      // uncomment below and update the code to test EzsigntemplatedocumentRequestCompound
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatedocumentRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatedocumentRequestCompound);
    });
