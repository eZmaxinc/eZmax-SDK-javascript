...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PaymenttermGetListV1ResponseMPayload();
  });
  ...
  describe('PaymenttermGetListV1ResponseMPayload', function() {
    it('should create an instance of PaymenttermGetListV1ResponseMPayload', function() {
      // uncomment below and update the code to test PaymenttermGetListV1ResponseMPayload
