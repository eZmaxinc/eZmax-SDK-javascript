...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebsocketResponseErrorV1();
  });
  ...
  describe('WebsocketResponseErrorV1', function() {
    it('should create an instance of WebsocketResponseErrorV1', function() {
      // uncomment below and update the code to test WebsocketResponseErrorV1
      //var instance = new EZmaxApiDefinitionFull.WebsocketResponseErrorV1();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebsocketResponseErrorV1);
    });
