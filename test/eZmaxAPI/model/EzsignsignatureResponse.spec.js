...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignsignatureResponse();
  });
  ...
  describe('EzsignsignatureResponse', function() {
    it('should create an instance of EzsignsignatureResponse', function() {
      // uncomment below and update the code to test EzsignsignatureResponse
      //var instance = new EZmaxApiDefinitionFull.EzsignsignatureResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignsignatureResponse);
    });
    ...
    it('should have the property objContactNameDelegation (base name: "objContactNameDelegation")', function() {
      // uncomment below and update the code to test the property objContactNameDelegation
      //var instance = new EZmaxApiDefinitionFull.EzsignsignatureResponse();
      //expect(instance).to.be();
    });
