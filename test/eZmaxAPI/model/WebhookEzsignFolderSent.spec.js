...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookEzsignFolderSent();
  });
  ...
  describe('WebhookEzsignFolderSent', function() {
    it('should create an instance of WebhookEzsignFolderSent', function() {
      // uncomment below and update the code to test WebhookEzsignFolderSent
      //var instance = new EZmaxApiDefinitionFull.WebhookEzsignFolderSent();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookEzsignFolderSent);
    });
