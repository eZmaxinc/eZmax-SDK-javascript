...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignbulksendResponseCompound();
  });
  ...
  describe('EzsignbulksendResponseCompound', function() {
    it('should create an instance of EzsignbulksendResponseCompound', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignbulksendResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignbulksendResponseCompound);
    });
