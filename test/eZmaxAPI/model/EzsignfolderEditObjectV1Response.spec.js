...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfolderEditObjectV1Response();
  });
  ...
  describe('EzsignfolderEditObjectV1Response', function() {
    it('should create an instance of EzsignfolderEditObjectV1Response', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignfolderEditObjectV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfolderEditObjectV1Response);
    });
