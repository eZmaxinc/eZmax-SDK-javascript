...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PhoneRequestCompoundV2();
  });
  ...
  describe('PhoneRequestCompoundV2', function() {
    it('should create an instance of PhoneRequestCompoundV2', function() {
      // uncomment below and update the code to test PhoneRequestCompoundV2
      //var instance = new EZmaxApiDefinitionFull.PhoneRequestCompoundV2();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PhoneRequestCompoundV2);
    });
