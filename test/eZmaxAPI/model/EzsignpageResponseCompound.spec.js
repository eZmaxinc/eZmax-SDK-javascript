...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignpageResponseCompound();
  });
  ...
  describe('EzsignpageResponseCompound', function() {
    it('should create an instance of EzsignpageResponseCompound', function() {
      // uncomment below and update the code to test EzsignpageResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignpageResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignpageResponseCompound);
    });
