...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignpageResponseCompound();
  });
  ...
  describe('EzsignpageResponseCompound', function() {
    it('should create an instance of EzsignpageResponseCompound', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignpageResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignpageResponseCompound);
    });
