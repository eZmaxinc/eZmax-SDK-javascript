...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookEzsignDocumentUnsent();
  });
  ...
  describe('WebhookEzsignDocumentUnsent', function() {
    it('should create an instance of WebhookEzsignDocumentUnsent', function() {
      // uncomment below and update the code to test WebhookEzsignDocumentUnsent
      //var instance = new EZmaxApiDefinitionFull.WebhookEzsignDocumentUnsent();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookEzsignDocumentUnsent);
    });
