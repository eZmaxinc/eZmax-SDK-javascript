...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PermissionRequest();
  });
  ...
  describe('PermissionRequest', function() {
    it('should create an instance of PermissionRequest', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.PermissionRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PermissionRequest);
    });
