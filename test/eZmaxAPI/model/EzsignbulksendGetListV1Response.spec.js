...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignbulksendGetListV1Response();
  });
  ...
  describe('EzsignbulksendGetListV1Response', function() {
    it('should create an instance of EzsignbulksendGetListV1Response', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignbulksendGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignbulksendGetListV1Response);
    });
