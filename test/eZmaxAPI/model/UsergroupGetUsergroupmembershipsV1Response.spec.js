...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UsergroupGetUsergroupmembershipsV1Response();
  });
  ...
  describe('UsergroupGetUsergroupmembershipsV1Response', function() {
    it('should create an instance of UsergroupGetUsergroupmembershipsV1Response', function() {
      // uncomment below and update the code to test UsergroupGetUsergroupmembershipsV1Response
