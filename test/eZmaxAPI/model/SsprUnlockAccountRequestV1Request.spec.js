...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.SsprUnlockAccountRequestV1Request();
  });
  ...
  describe('SsprUnlockAccountRequestV1Request', function() {
    it('should create an instance of SsprUnlockAccountRequestV1Request', function() {
      // uncomment below and update the code to test SsprUnlockAccountRequestV1Request
      //var instane = new EZmaxApiDefinition.SsprUnlockAccountRequestV1Request();
      //expect(instance).to.be.a(EZmaxApiDefinition.SsprUnlockAccountRequestV1Request);
    });
    ...
    it('should have the property pksCustomerCode (base name: "pksCustomerCode")', function() {
      ...
      //var instance = new EZmaxApiDefinition.SsprUnlockAccountRequestV1Request();
