...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UsergroupmembershipResponseCompound();
  });
  ...
  describe('UsergroupmembershipResponseCompound', function() {
    it('should create an instance of UsergroupmembershipResponseCompound', function() {
      // uncomment below and update the code to test UsergroupmembershipResponseCompound
      //var instance = new EZmaxApiDefinitionFull.UsergroupmembershipResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UsergroupmembershipResponseCompound);
    });

    it('should have the property pkiUsergroupmembershipID (base name: "pkiUsergroupmembershipID")', function() {
      // uncomment below and update the code to test the property pkiUsergroupmembershipID
      //var instance = new EZmaxApiDefinitionFull.UsergroupmembershipResponseCompound();
