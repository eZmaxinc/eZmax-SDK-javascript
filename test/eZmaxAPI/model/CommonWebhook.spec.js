...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommonWebhook();
  });
  ...
  describe('CommonWebhook', function() {
    it('should create an instance of CommonWebhook', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.CommonWebhook();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommonWebhook);
    });
