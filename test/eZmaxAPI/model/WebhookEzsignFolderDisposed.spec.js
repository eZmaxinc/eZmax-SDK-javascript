...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookEzsignFolderDisposed();
  });
  ...
  describe('WebhookEzsignFolderDisposed', function() {
    it('should create an instance of WebhookEzsignFolderDisposed', function() {
      // uncomment below and update the code to test WebhookEzsignFolderDisposed
      //var instance = new EZmaxApiDefinitionFull.WebhookEzsignFolderDisposed();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookEzsignFolderDisposed);
    });
