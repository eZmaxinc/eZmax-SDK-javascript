...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestV2();
  });
  ...
  describe('EzsignfoldertypeRequestV2', function() {
    it('should create an instance of EzsignfoldertypeRequestV2', function() {
      // uncomment below and update the code to test EzsignfoldertypeRequestV2
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestV2();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldertypeRequestV2);
    });
