...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CustomUserResponse();
  });
  ...
  describe('CustomUserResponse', function() {
    it('should create an instance of CustomUserResponse', function() {
      // uncomment below and update the code to test CustomUserResponse
      //var instance = new EZmaxApiDefinitionFull.CustomUserResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CustomUserResponse);
    });
