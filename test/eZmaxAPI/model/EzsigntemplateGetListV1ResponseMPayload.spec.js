...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateGetListV1ResponseMPayload();
  });
  ...
  describe('EzsigntemplateGetListV1ResponseMPayload', function() {
    it('should create an instance of EzsigntemplateGetListV1ResponseMPayload', function() {
      // uncomment below and update the code to test EzsigntemplateGetListV1ResponseMPayload
