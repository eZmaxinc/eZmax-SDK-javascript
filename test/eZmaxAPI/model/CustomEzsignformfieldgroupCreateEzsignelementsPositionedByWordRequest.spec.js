...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest();
  });
  ...
  describe('CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest', function() {
    it('should create an instance of CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest', function() {
      // uncomment below and update the code to test CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest
      //var instance = new EZmaxApiDefinitionFull.CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest);
    });
    ...
    it('should have the property objCreateezsignelementspositionedbyword (base name: "objCreateezsignelementspositionedbyword")', function() {
      // uncomment below and update the code to test the property objCreateezsignelementspositionedbyword
      //var instance = new EZmaxApiDefinitionFull.CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest();
      //expect(instance).to.be();
    });
