...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.ListpresentationResponseCompound();
  });
  ...
  describe('ListpresentationResponseCompound', function() {
    it('should create an instance of ListpresentationResponseCompound', function() {
      // uncomment below and update the code to test ListpresentationResponseCompound
      //var instance = new EZmaxApiDefinition.ListpresentationResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinition.ListpresentationResponseCompound);
    });
