...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserstagedGetObjectV2Response();
  });
  ...
  describe('UserstagedGetObjectV2Response', function() {
    it('should create an instance of UserstagedGetObjectV2Response', function() {
      // uncomment below and update the code to test UserstagedGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.UserstagedGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserstagedGetObjectV2Response);
    });
