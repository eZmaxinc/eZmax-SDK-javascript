...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UsergroupdelegationResponse();
  });
  ...
  describe('UsergroupdelegationResponse', function() {
    it('should create an instance of UsergroupdelegationResponse', function() {
      // uncomment below and update the code to test UsergroupdelegationResponse
      //var instance = new EZmaxApiDefinitionFull.UsergroupdelegationResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UsergroupdelegationResponse);
    });
