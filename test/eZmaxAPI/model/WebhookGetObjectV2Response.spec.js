...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookGetObjectV2Response();
  });
  ...
  describe('WebhookGetObjectV2Response', function() {
    it('should create an instance of WebhookGetObjectV2Response', function() {
      // uncomment below and update the code to test WebhookGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.WebhookGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookGetObjectV2Response);
    });
