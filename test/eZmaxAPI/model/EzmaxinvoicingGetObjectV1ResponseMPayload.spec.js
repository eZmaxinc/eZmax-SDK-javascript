...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzmaxinvoicingGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzmaxinvoicingGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzmaxinvoicingGetObjectV1ResponseMPayload', function() {
      // uncomment below and update the code to test EzmaxinvoicingGetObjectV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.EzmaxinvoicingGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzmaxinvoicingGetObjectV1ResponseMPayload);
    });
