...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookGetListV1Response();
  });
  ...
  describe('WebhookGetListV1Response', function() {
    it('should create an instance of WebhookGetListV1Response', function() {
      // uncomment below and update the code to test WebhookGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.WebhookGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookGetListV1Response);
    });
