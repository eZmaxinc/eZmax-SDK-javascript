...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookGetHistoryV1Response();
  });
  ...
  describe('WebhookGetHistoryV1Response', function() {
    it('should create an instance of WebhookGetHistoryV1Response', function() {
      // uncomment below and update the code to test WebhookGetHistoryV1Response
      //var instance = new EZmaxApiDefinitionFull.WebhookGetHistoryV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookGetHistoryV1Response);
    });
