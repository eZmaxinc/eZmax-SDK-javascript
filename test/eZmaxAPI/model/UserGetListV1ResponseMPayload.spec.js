...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserGetListV1ResponseMPayload();
  });
  ...
  describe('UserGetListV1ResponseMPayload', function() {
    it('should create an instance of UserGetListV1ResponseMPayload', function() {
      // uncomment below and update the code to test UserGetListV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.UserGetListV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserGetListV1ResponseMPayload);
    });
