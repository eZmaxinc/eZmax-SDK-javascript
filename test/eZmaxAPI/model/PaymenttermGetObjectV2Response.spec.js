...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PaymenttermGetObjectV2Response();
  });
  ...
  describe('PaymenttermGetObjectV2Response', function() {
    it('should create an instance of PaymenttermGetObjectV2Response', function() {
      // uncomment below and update the code to test PaymenttermGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.PaymenttermGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PaymenttermGetObjectV2Response);
    });
