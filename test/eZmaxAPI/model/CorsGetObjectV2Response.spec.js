...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CorsGetObjectV2Response();
  });
  ...
  describe('CorsGetObjectV2Response', function() {
    it('should create an instance of CorsGetObjectV2Response', function() {
      // uncomment below and update the code to test CorsGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.CorsGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CorsGetObjectV2Response);
    });
