...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.ActivesessionResponse();
  });
  ...
  describe('ActivesessionResponse', function() {
    it('should create an instance of ActivesessionResponse', function() {
      ...
      //var instance = new EZmaxApiDefinition.ActivesessionResponse();
      //expect(instance).to.be.a(EZmaxApiDefinition.ActivesessionResponse);
    });
