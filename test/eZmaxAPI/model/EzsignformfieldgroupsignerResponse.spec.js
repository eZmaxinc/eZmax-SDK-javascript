...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignformfieldgroupsignerResponse();
  });
  ...
  describe('EzsignformfieldgroupsignerResponse', function() {
    it('should create an instance of EzsignformfieldgroupsignerResponse', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignformfieldgroupsignerResponse();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignformfieldgroupsignerResponse);
    });
