...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzmaxinvoicinguserResponseCompound();
  });
  ...
  describe('EzmaxinvoicinguserResponseCompound', function() {
    it('should create an instance of EzmaxinvoicinguserResponseCompound', function() {
      // uncomment below and update the code to test EzmaxinvoicinguserResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzmaxinvoicinguserResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzmaxinvoicinguserResponseCompound);
    });
