...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.SubnetRequest();
  });
  ...
  describe('SubnetRequest', function() {
    it('should create an instance of SubnetRequest', function() {
      // uncomment below and update the code to test SubnetRequest
      //var instance = new EZmaxApiDefinitionFull.SubnetRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.SubnetRequest);
    });
