...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookCreateObjectV2Response();
  });
  ...
  describe('WebhookCreateObjectV2Response', function() {
    it('should create an instance of WebhookCreateObjectV2Response', function() {
      // uncomment below and update the code to test WebhookCreateObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.WebhookCreateObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookCreateObjectV2Response);
    });
