...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BrandingCreateObjectV1Response();
  });
  ...
  describe('BrandingCreateObjectV1Response', function() {
    it('should create an instance of BrandingCreateObjectV1Response', function() {
      // uncomment below and update the code to test BrandingCreateObjectV1Response
      //var instance = new EZmaxApiDefinitionFull.BrandingCreateObjectV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.BrandingCreateObjectV1Response);
    });
