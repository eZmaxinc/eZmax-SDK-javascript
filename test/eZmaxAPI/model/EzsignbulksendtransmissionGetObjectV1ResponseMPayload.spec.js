...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignbulksendtransmissionGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzsignbulksendtransmissionGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsignbulksendtransmissionGetObjectV1ResponseMPayload', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignbulksendtransmissionGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignbulksendtransmissionGetObjectV1ResponseMPayload);
    });
