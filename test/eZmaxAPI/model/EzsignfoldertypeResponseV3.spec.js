...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldertypeResponseV3();
  });
  ...
  describe('EzsignfoldertypeResponseV3', function() {
    it('should create an instance of EzsignfoldertypeResponseV3', function() {
      // uncomment below and update the code to test EzsignfoldertypeResponseV3
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeResponseV3();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldertypeResponseV3);
    });
