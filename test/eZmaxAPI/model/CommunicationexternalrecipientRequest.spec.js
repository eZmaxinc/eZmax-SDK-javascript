...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommunicationexternalrecipientRequest();
  });
  ...
  describe('CommunicationexternalrecipientRequest', function() {
    it('should create an instance of CommunicationexternalrecipientRequest', function() {
      // uncomment below and update the code to test CommunicationexternalrecipientRequest
      //var instance = new EZmaxApiDefinitionFull.CommunicationexternalrecipientRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommunicationexternalrecipientRequest);
    });
