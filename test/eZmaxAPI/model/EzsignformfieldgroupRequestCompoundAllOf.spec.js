...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignformfieldgroupRequestCompoundAllOf();
  });
  ...
  describe('EzsignformfieldgroupRequestCompoundAllOf', function() {
    it('should create an instance of EzsignformfieldgroupRequestCompoundAllOf', function() {
      // uncomment below and update the code to test EzsignformfieldgroupRequestCompoundAllOf
      //var instance = new EZmaxApiDefinitionFull.EzsignformfieldgroupRequestCompoundAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignformfieldgroupRequestCompoundAllOf);
    });
