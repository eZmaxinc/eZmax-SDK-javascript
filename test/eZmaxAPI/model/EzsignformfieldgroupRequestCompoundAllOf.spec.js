...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignformfieldgroupRequestCompoundAllOf();
  });
  ...
  describe('EzsignformfieldgroupRequestCompoundAllOf', function() {
    it('should create an instance of EzsignformfieldgroupRequestCompoundAllOf', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignformfieldgroupRequestCompoundAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignformfieldgroupRequestCompoundAllOf);
    });
