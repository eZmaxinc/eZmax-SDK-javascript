...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommunicationexternalrecipientResponse();
  });
  ...
  describe('CommunicationexternalrecipientResponse', function() {
    it('should create an instance of CommunicationexternalrecipientResponse', function() {
      // uncomment below and update the code to test CommunicationexternalrecipientResponse
      //var instance = new EZmaxApiDefinitionFull.CommunicationexternalrecipientResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommunicationexternalrecipientResponse);
    });
