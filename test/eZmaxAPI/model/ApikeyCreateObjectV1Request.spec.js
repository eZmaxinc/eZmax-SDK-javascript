...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.ApikeyCreateObjectV1Request();
  });
  ...
  describe('ApikeyCreateObjectV1Request', function() {
    it('should create an instance of ApikeyCreateObjectV1Request', function() {
      ...
      //var instane = new EZmaxApiDefinition.ApikeyCreateObjectV1Request();
      //expect(instance).to.be.a(EZmaxApiDefinition.ApikeyCreateObjectV1Request);
    });
    ...
    it('should have the property objApikey (base name: "objApikey")', function() {
      ...
      //var instance = new EZmaxApiDefinition.ApikeyCreateObjectV1Request();
