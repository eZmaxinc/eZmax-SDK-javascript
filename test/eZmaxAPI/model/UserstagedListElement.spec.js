...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserstagedListElement();
  });
  ...
  describe('UserstagedListElement', function() {
    it('should create an instance of UserstagedListElement', function() {
      // uncomment below and update the code to test UserstagedListElement
      //var instance = new EZmaxApiDefinitionFull.UserstagedListElement();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserstagedListElement);
    });
