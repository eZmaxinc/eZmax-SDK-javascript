...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserRequestCompoundV2();
  });
  ...
  describe('UserRequestCompoundV2', function() {
    it('should create an instance of UserRequestCompoundV2', function() {
      // uncomment below and update the code to test UserRequestCompoundV2
      //var instance = new EZmaxApiDefinitionFull.UserRequestCompoundV2();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserRequestCompoundV2);
    });
