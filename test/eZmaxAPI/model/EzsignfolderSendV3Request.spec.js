...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfolderSendV3Request();
  });
  ...
  describe('EzsignfolderSendV3Request', function() {
    it('should create an instance of EzsignfolderSendV3Request', function() {
      // uncomment below and update the code to test EzsignfolderSendV3Request
      //var instance = new EZmaxApiDefinitionFull.EzsignfolderSendV3Request();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfolderSendV3Request);
    });
