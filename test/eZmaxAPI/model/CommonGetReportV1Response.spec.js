...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommonGetReportV1Response();
  });
  ...
  describe('CommonGetReportV1Response', function() {
    it('should create an instance of CommonGetReportV1Response', function() {
      // uncomment below and update the code to test CommonGetReportV1Response
      //var instance = new EZmaxApiDefinitionFull.CommonGetReportV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommonGetReportV1Response);
    });
