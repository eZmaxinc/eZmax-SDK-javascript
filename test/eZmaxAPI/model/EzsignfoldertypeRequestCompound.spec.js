...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompound();
  });
  ...
  describe('EzsignfoldertypeRequestCompound', function() {
    it('should create an instance of EzsignfoldertypeRequestCompound', function() {
      // uncomment below and update the code to test EzsignfoldertypeRequestCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompound);
    });
