...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserstagedResponse();
  });
  ...
  describe('UserstagedResponse', function() {
    it('should create an instance of UserstagedResponse', function() {
      // uncomment below and update the code to test UserstagedResponse
      //var instance = new EZmaxApiDefinitionFull.UserstagedResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserstagedResponse);
    });
