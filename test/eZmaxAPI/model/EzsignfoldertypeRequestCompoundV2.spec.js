...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompoundV2();
  });
  ...
  describe('EzsignfoldertypeRequestCompoundV2', function() {
    it('should create an instance of EzsignfoldertypeRequestCompoundV2', function() {
      // uncomment below and update the code to test EzsignfoldertypeRequestCompoundV2
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompoundV2();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompoundV2);
    });
    ...
    it('should have the property a_fkiUserlogintypeID (base name: "a_fkiUserlogintypeID")', function() {
      // uncomment below and update the code to test the property a_fkiUserlogintypeID
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompoundV2();
      //expect(instance).to.be();
    });

    it('should have the property a_fkiUsergroupIDAll (base name: "a_fkiUsergroupIDAll")', function() {
      // uncomment below and update the code to test the property a_fkiUsergroupIDAll
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompoundV2();
      //expect(instance).to.be();
    });

    it('should have the property a_fkiUsergroupIDRestricted (base name: "a_fkiUsergroupIDRestricted")', function() {
      // uncomment below and update the code to test the property a_fkiUsergroupIDRestricted
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompoundV2();
      //expect(instance).to.be();
    });

    it('should have the property a_fkiUsergroupIDTemplate (base name: "a_fkiUsergroupIDTemplate")', function() {
      // uncomment below and update the code to test the property a_fkiUsergroupIDTemplate
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompoundV2();
      //expect(instance).to.be();
    });
    ...
    it('should have the property a_fkiUserIDSigned (base name: "a_fkiUserIDSigned")', function() {
      // uncomment below and update the code to test the property a_fkiUserIDSigned
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompoundV2();
      //expect(instance).to.be();
    });

    it('should have the property a_fkiUserIDSummary (base name: "a_fkiUserIDSummary")', function() {
      // uncomment below and update the code to test the property a_fkiUserIDSummary
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeRequestCompoundV2();
      //expect(instance).to.be();
    });
