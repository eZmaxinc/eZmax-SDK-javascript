...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserCreateObjectV2Response();
  });
  ...
  describe('UserCreateObjectV2Response', function() {
    it('should create an instance of UserCreateObjectV2Response', function() {
      // uncomment below and update the code to test UserCreateObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.UserCreateObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserCreateObjectV2Response);
    });
