...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatepackageRequest();
  });
  ...
  describe('EzsigntemplatepackageRequest', function() {
    it('should create an instance of EzsigntemplatepackageRequest', function() {
      // uncomment below and update the code to test EzsigntemplatepackageRequest
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatepackageRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatepackageRequest);
    });
