...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.DiscussionGetObjectV2Response();
  });
  ...
  describe('DiscussionGetObjectV2Response', function() {
    it('should create an instance of DiscussionGetObjectV2Response', function() {
      // uncomment below and update the code to test DiscussionGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.DiscussionGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.DiscussionGetObjectV2Response);
    });
