...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.ListpresentationRequestCompound();
  });
  ...
  describe('ListpresentationRequestCompound', function() {
    it('should create an instance of ListpresentationRequestCompound', function() {
      // uncomment below and update the code to test ListpresentationRequestCompound
      //var instance = new EZmaxApiDefinition.ListpresentationRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinition.ListpresentationRequestCompound);
    });
