...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.VariableexpenseGetListV1ResponseMPayload();
  });
  ...
  describe('VariableexpenseGetListV1ResponseMPayload', function() {
    it('should create an instance of VariableexpenseGetListV1ResponseMPayload', function() {
      // uncomment below and update the code to test VariableexpenseGetListV1ResponseMPayload
