...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest();
  });
  ...
  describe('CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest', function() {
    it('should create an instance of CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest', function() {
      // uncomment below and update the code to test CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest
      //var instance = new EZmaxApiDefinitionFull.CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest);
    });
