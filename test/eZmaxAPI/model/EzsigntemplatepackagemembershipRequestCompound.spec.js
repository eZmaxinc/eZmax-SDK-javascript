...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipRequestCompound();
  });
  ...
  describe('EzsigntemplatepackagemembershipRequestCompound', function() {
    it('should create an instance of EzsigntemplatepackagemembershipRequestCompound', function() {
      // uncomment below and update the code to test EzsigntemplatepackagemembershipRequestCompound
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipRequestCompound);
    });
