...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigndocumentGetTemporaryProofV1ResponseMPayload();
  });
  ...
  describe('EzsigndocumentGetTemporaryProofV1ResponseMPayload', function() {
    it('should create an instance of EzsigndocumentGetTemporaryProofV1ResponseMPayload', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsigndocumentGetTemporaryProofV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigndocumentGetTemporaryProofV1ResponseMPayload);
    });
