...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigndocumentCreateObjectV1ResponseMPayload();
  });
  ...
  describe('EzsigndocumentCreateObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsigndocumentCreateObjectV1ResponseMPayload', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsigndocumentCreateObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigndocumentCreateObjectV1ResponseMPayload);
    });
