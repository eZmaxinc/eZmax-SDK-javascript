...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserstagedGetListV1Response();
  });
  ...
  describe('UserstagedGetListV1Response', function() {
    it('should create an instance of UserstagedGetListV1Response', function() {
      // uncomment below and update the code to test UserstagedGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.UserstagedGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserstagedGetListV1Response);
    });
