...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ClonehistoryGetListV1ResponseMPayload();
  });
  ...
  describe('ClonehistoryGetListV1ResponseMPayload', function() {
    it('should create an instance of ClonehistoryGetListV1ResponseMPayload', function() {
      // uncomment below and update the code to test ClonehistoryGetListV1ResponseMPayload
