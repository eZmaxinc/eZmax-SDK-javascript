...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.GlobalCustomerGetEndpointV1Response();
  });
  ...
  describe('GlobalCustomerGetEndpointV1Response', function() {
    it('should create an instance of GlobalCustomerGetEndpointV1Response', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.GlobalCustomerGetEndpointV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.GlobalCustomerGetEndpointV1Response);
    });
