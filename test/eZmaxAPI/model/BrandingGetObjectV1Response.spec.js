...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BrandingGetObjectV1Response();
  });
  ...
  describe('BrandingGetObjectV1Response', function() {
    it('should create an instance of BrandingGetObjectV1Response', function() {
      // uncomment below and update the code to test BrandingGetObjectV1Response
      //var instance = new EZmaxApiDefinitionFull.BrandingGetObjectV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.BrandingGetObjectV1Response);
    });
