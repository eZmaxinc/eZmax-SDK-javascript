...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldersignerassociationRequestCompound();
  });
  ...
  describe('EzsignfoldersignerassociationRequestCompound', function() {
    it('should create an instance of EzsignfoldersignerassociationRequestCompound', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldersignerassociationRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldersignerassociationRequestCompound);
    });
