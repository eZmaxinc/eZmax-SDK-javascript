...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignfolderGetListV1Response();
  });
  ...
  describe('EzsignfolderGetListV1Response', function() {
    it('should create an instance of EzsignfolderGetListV1Response', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignfolderGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignfolderGetListV1Response);
    });
