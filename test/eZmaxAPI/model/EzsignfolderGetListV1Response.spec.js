...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfolderGetListV1Response();
  });
  ...
  describe('EzsignfolderGetListV1Response', function() {
    it('should create an instance of EzsignfolderGetListV1Response', function() {
      // uncomment below and update the code to test EzsignfolderGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.EzsignfolderGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfolderGetListV1Response);
    });
