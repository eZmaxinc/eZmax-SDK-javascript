...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookEzsignSignatureSigned();
  });
  ...
  describe('WebhookEzsignSignatureSigned', function() {
    it('should create an instance of WebhookEzsignSignatureSigned', function() {
      // uncomment below and update the code to test WebhookEzsignSignatureSigned
      //var instance = new EZmaxApiDefinitionFull.WebhookEzsignSignatureSigned();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookEzsignSignatureSigned);
    });
