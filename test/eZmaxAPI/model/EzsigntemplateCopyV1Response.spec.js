...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateCopyV1Response();
  });
  ...
  describe('EzsigntemplateCopyV1Response', function() {
    it('should create an instance of EzsigntemplateCopyV1Response', function() {
      // uncomment below and update the code to test EzsigntemplateCopyV1Response
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateCopyV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateCopyV1Response);
    });
