...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommunicationexternalrecipientRequestCompound();
  });
  ...
  describe('CommunicationexternalrecipientRequestCompound', function() {
    it('should create an instance of CommunicationexternalrecipientRequestCompound', function() {
      // uncomment below and update the code to test CommunicationexternalrecipientRequestCompound
      //var instance = new EZmaxApiDefinitionFull.CommunicationexternalrecipientRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommunicationexternalrecipientRequestCompound);
    });
