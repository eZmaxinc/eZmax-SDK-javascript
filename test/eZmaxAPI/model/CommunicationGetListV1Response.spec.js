...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommunicationGetListV1Response();
  });
  ...
  describe('CommunicationGetListV1Response', function() {
    it('should create an instance of CommunicationGetListV1Response', function() {
      // uncomment below and update the code to test CommunicationGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.CommunicationGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommunicationGetListV1Response);
    });
