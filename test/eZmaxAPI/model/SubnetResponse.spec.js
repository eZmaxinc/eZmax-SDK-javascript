...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.SubnetResponse();
  });
  ...
  describe('SubnetResponse', function() {
    it('should create an instance of SubnetResponse', function() {
      // uncomment below and update the code to test SubnetResponse
      //var instance = new EZmaxApiDefinitionFull.SubnetResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.SubnetResponse);
    });
