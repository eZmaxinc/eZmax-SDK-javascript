...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignelementdependencyRequestCompound();
  });
  ...
  describe('EzsignelementdependencyRequestCompound', function() {
    it('should create an instance of EzsignelementdependencyRequestCompound', function() {
      // uncomment below and update the code to test EzsignelementdependencyRequestCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignelementdependencyRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignelementdependencyRequestCompound);
    });
