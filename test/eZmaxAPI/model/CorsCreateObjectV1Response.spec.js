...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CorsCreateObjectV1Response();
  });
  ...
  describe('CorsCreateObjectV1Response', function() {
    it('should create an instance of CorsCreateObjectV1Response', function() {
      // uncomment below and update the code to test CorsCreateObjectV1Response
      //var instance = new EZmaxApiDefinitionFull.CorsCreateObjectV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CorsCreateObjectV1Response);
    });
