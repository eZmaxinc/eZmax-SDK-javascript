...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BrandingRequestCompound();
  });
  ...
  describe('BrandingRequestCompound', function() {
    it('should create an instance of BrandingRequestCompound', function() {
      // uncomment below and update the code to test BrandingRequestCompound
      //var instance = new EZmaxApiDefinitionFull.BrandingRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.BrandingRequestCompound);
    });
    ...
    it('should have the property sBrandingName (base name: "sBrandingName")', function() {
      // uncomment below and update the code to test the property sBrandingName
      //var instance = new EZmaxApiDefinitionFull.BrandingRequestCompound();
      //expect(instance).to.be();
    });
