...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PermissionResponse();
  });
  ...
  describe('PermissionResponse', function() {
    it('should create an instance of PermissionResponse', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.PermissionResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PermissionResponse);
    });
