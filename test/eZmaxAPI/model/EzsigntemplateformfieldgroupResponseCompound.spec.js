...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupResponseCompound();
  });
  ...
  describe('EzsigntemplateformfieldgroupResponseCompound', function() {
    it('should create an instance of EzsigntemplateformfieldgroupResponseCompound', function() {
      // uncomment below and update the code to test EzsigntemplateformfieldgroupResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupResponseCompound);
    });
