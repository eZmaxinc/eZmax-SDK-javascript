...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.VersionhistoryResponseCompound();
  });
  ...
  describe('VersionhistoryResponseCompound', function() {
    it('should create an instance of VersionhistoryResponseCompound', function() {
      // uncomment below and update the code to test VersionhistoryResponseCompound
      //var instance = new EZmaxApiDefinitionFull.VersionhistoryResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.VersionhistoryResponseCompound);
    });
