...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzmaxinvoicingsummaryexternaldetailResponse();
  });
  ...
  describe('EzmaxinvoicingsummaryexternaldetailResponse', function() {
    it('should create an instance of EzmaxinvoicingsummaryexternaldetailResponse', function() {
      // uncomment below and update the code to test EzmaxinvoicingsummaryexternaldetailResponse
      //var instance = new EZmaxApiDefinitionFull.EzmaxinvoicingsummaryexternaldetailResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzmaxinvoicingsummaryexternaldetailResponse);
    });
