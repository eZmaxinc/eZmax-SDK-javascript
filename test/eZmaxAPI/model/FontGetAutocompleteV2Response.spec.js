...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.FontGetAutocompleteV2Response();
  });
  ...
  describe('FontGetAutocompleteV2Response', function() {
    it('should create an instance of FontGetAutocompleteV2Response', function() {
      // uncomment below and update the code to test FontGetAutocompleteV2Response
      //var instance = new EZmaxApiDefinitionFull.FontGetAutocompleteV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.FontGetAutocompleteV2Response);
    });
