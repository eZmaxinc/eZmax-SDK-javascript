...
(function(root, factory) {
  ...
  describe('CommonResponseObjDebugPayload', function() {
    it('should create an instance of CommonResponseObjDebugPayload', function() {
      ...
      //var instane = new EZmaxApiDefinition.CommonResponseObjDebugPayload();
    ...
    it('should have the property a_RequiredPermissions (base name: "a_RequiredPermissions")', function() {
      // uncomment below and update the code to test the property a_RequiredPermissions
      //var instance = new EZmaxApiDefinition.CommonResponseObjDebugPayload();
      //expect(instance).to.be();
    });
