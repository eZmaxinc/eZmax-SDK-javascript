...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ApikeyListElement();
  });
  ...
  describe('ApikeyListElement', function() {
    it('should create an instance of ApikeyListElement', function() {
      // uncomment below and update the code to test ApikeyListElement
      //var instance = new EZmaxApiDefinitionFull.ApikeyListElement();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ApikeyListElement);
    });
