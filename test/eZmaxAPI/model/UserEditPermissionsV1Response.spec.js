...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserEditPermissionsV1Response();
  });
  ...
  describe('UserEditPermissionsV1Response', function() {
    it('should create an instance of UserEditPermissionsV1Response', function() {
      // uncomment below and update the code to test UserEditPermissionsV1Response
      //var instance = new EZmaxApiDefinitionFull.UserEditPermissionsV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserEditPermissionsV1Response);
    });
