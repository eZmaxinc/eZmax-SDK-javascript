...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CustomAttachmentResponse();
  });
  ...
  describe('CustomAttachmentResponse', function() {
    it('should create an instance of CustomAttachmentResponse', function() {
      // uncomment below and update the code to test CustomAttachmentResponse
      //var instance = new EZmaxApiDefinitionFull.CustomAttachmentResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CustomAttachmentResponse);
    });
    ...
    it('should have the property objAttachmentProof (base name: "objAttachmentProof")', function() {
      // uncomment below and update the code to test the property objAttachmentProof
      //var instance = new EZmaxApiDefinitionFull.CustomAttachmentResponse();
      //expect(instance).to.be();
    });

    it('should have the property objAttachmentProofdocument (base name: "objAttachmentProofdocument")', function() {
      // uncomment below and update the code to test the property objAttachmentProofdocument
      //var instance = new EZmaxApiDefinitionFull.CustomAttachmentResponse();
      //expect(instance).to.be();
    });

    it('should have the property a_objAttachmentAttachment (base name: "a_objAttachmentAttachment")', function() {
      // uncomment below and update the code to test the property a_objAttachmentAttachment
      //var instance = new EZmaxApiDefinitionFull.CustomAttachmentResponse();
      //expect(instance).to.be();
    });

    it('should have the property a_objAttachmentVersion (base name: "a_objAttachmentVersion")', function() {
      // uncomment below and update the code to test the property a_objAttachmentVersion
      //var instance = new EZmaxApiDefinitionFull.CustomAttachmentResponse();
      //expect(instance).to.be();
    });
