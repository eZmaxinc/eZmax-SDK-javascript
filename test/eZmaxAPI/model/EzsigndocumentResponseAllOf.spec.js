...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsigndocumentResponseAllOf();
  });
  ...
  describe('EzsigndocumentResponseAllOf', function() {
    it('should create an instance of EzsigndocumentResponseAllOf', function() {
      // uncomment below and update the code to test EzsigndocumentResponseAllOf
      //var instane = new EZmaxApiDefinition.EzsigndocumentResponseAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsigndocumentResponseAllOf);
    });
    ...
    it('should have the property fkiEzsignfolderID (base name: "fkiEzsignfolderID")', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsigndocumentResponseAllOf();
