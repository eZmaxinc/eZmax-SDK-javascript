...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommonResponse();
  });
  ...
  describe('CommonResponse', function() {
    it('should create an instance of CommonResponse', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.CommonResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommonResponse);
    });
