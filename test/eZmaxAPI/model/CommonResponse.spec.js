...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.CommonResponse();
  });
  ...
  describe('CommonResponse', function() {
    it('should create an instance of CommonResponse', function() {
      ...
      //var instane = new EZmaxApiDefinition.CommonResponse();
      //expect(instance).to.be.a(EZmaxApiDefinition.CommonResponse);
    });
    ...
    it('should have the property objDebugPayload (base name: "objDebugPayload")', function() {
      ...
      //var instance = new EZmaxApiDefinition.CommonResponse();
