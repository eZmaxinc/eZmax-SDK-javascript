...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.SubnetCreateObjectV1Response();
  });
  ...
  describe('SubnetCreateObjectV1Response', function() {
    it('should create an instance of SubnetCreateObjectV1Response', function() {
      // uncomment below and update the code to test SubnetCreateObjectV1Response
      //var instance = new EZmaxApiDefinitionFull.SubnetCreateObjectV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.SubnetCreateObjectV1Response);
    });
