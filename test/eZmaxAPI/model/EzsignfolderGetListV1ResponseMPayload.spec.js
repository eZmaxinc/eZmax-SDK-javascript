...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfolderGetListV1ResponseMPayload();
  });
  ...
  describe('EzsignfolderGetListV1ResponseMPayload', function() {
    it('should create an instance of EzsignfolderGetListV1ResponseMPayload', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignfolderGetListV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfolderGetListV1ResponseMPayload);
    });
