...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ApikeyGetSubnetsV1Response();
  });
  ...
  describe('ApikeyGetSubnetsV1Response', function() {
    it('should create an instance of ApikeyGetSubnetsV1Response', function() {
      // uncomment below and update the code to test ApikeyGetSubnetsV1Response
      //var instance = new EZmaxApiDefinitionFull.ApikeyGetSubnetsV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ApikeyGetSubnetsV1Response);
    });
