...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfolderGetListV1ResponseMPayloadAllOf();
  });
  ...
  describe('EzsignfolderGetListV1ResponseMPayloadAllOf', function() {
    it('should create an instance of EzsignfolderGetListV1ResponseMPayloadAllOf', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignfolderGetListV1ResponseMPayloadAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfolderGetListV1ResponseMPayloadAllOf);
    });
