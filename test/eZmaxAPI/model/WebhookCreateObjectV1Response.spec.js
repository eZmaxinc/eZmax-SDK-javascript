...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookCreateObjectV1Response();
  });
  ...
  describe('WebhookCreateObjectV1Response', function() {
    it('should create an instance of WebhookCreateObjectV1Response', function() {
      // uncomment below and update the code to test WebhookCreateObjectV1Response
      //var instance = new EZmaxApiDefinitionFull.WebhookCreateObjectV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookCreateObjectV1Response);
    });
