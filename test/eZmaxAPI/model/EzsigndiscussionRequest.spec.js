...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigndiscussionRequest();
  });
  ...
  describe('EzsigndiscussionRequest', function() {
    it('should create an instance of EzsigndiscussionRequest', function() {
      // uncomment below and update the code to test EzsigndiscussionRequest
      //var instance = new EZmaxApiDefinitionFull.EzsigndiscussionRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigndiscussionRequest);
    });
