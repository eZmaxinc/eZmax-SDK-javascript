...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CustomContactNameResponse();
  });
  ...
  describe('CustomContactNameResponse', function() {
    it('should create an instance of CustomContactNameResponse', function() {
      // uncomment below and update the code to test CustomContactNameResponse
      //var instance = new EZmaxApiDefinitionFull.CustomContactNameResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CustomContactNameResponse);
    });
