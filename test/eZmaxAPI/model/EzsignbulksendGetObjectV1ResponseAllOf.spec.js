...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignbulksendGetObjectV1ResponseAllOf();
  });
  ...
  describe('EzsignbulksendGetObjectV1ResponseAllOf', function() {
    it('should create an instance of EzsignbulksendGetObjectV1ResponseAllOf', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignbulksendGetObjectV1ResponseAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignbulksendGetObjectV1ResponseAllOf);
    });
