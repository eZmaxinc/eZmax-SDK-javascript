...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignformfieldResponseCompound();
  });
  ...
  describe('EzsignformfieldResponseCompound', function() {
    it('should create an instance of EzsignformfieldResponseCompound', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignformfieldResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignformfieldResponseCompound);
    });
