...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ApikeyGetCorsV1Response();
  });
  ...
  describe('ApikeyGetCorsV1Response', function() {
    it('should create an instance of ApikeyGetCorsV1Response', function() {
      // uncomment below and update the code to test ApikeyGetCorsV1Response
      //var instance = new EZmaxApiDefinitionFull.ApikeyGetCorsV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ApikeyGetCorsV1Response);
    });
