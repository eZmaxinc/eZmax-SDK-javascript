...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserGetUsergroupsV1Response();
  });
  ...
  describe('UserGetUsergroupsV1Response', function() {
    it('should create an instance of UserGetUsergroupsV1Response', function() {
      // uncomment below and update the code to test UserGetUsergroupsV1Response
      //var instance = new EZmaxApiDefinitionFull.UserGetUsergroupsV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserGetUsergroupsV1Response);
    });
