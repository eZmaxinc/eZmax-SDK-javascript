...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommunicationrecipientRequest();
  });
  ...
  describe('CommunicationrecipientRequest', function() {
    it('should create an instance of CommunicationrecipientRequest', function() {
      // uncomment below and update the code to test CommunicationrecipientRequest
      //var instance = new EZmaxApiDefinitionFull.CommunicationrecipientRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommunicationrecipientRequest);
    });
