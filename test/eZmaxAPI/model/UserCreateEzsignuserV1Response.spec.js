...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserCreateEzsignuserV1Response();
  });
  ...
  describe('UserCreateEzsignuserV1Response', function() {
    it('should create an instance of UserCreateEzsignuserV1Response', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.UserCreateEzsignuserV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserCreateEzsignuserV1Response);
    });
