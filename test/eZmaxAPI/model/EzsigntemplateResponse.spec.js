...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateResponse();
  });
  ...
  describe('EzsigntemplateResponse', function() {
    it('should create an instance of EzsigntemplateResponse', function() {
      // uncomment below and update the code to test EzsigntemplateResponse
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateResponse);
    });
