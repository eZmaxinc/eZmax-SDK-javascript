...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.SsprUnlockAccountV1Request();
  });
  ...
  describe('SsprUnlockAccountV1Request', function() {
    it('should create an instance of SsprUnlockAccountV1Request', function() {
      // uncomment below and update the code to test SsprUnlockAccountV1Request
      //var instane = new EZmaxApiDefinition.SsprUnlockAccountV1Request();
      //expect(instance).to.be.a(EZmaxApiDefinition.SsprUnlockAccountV1Request);
    });
    ...
    it('should have the property pksCustomerCode (base name: "pksCustomerCode")', function() {
      ...
      //var instance = new EZmaxApiDefinition.SsprUnlockAccountV1Request();
