...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignbulksendsignermappingResponse();
  });
  ...
  describe('EzsignbulksendsignermappingResponse', function() {
    it('should create an instance of EzsignbulksendsignermappingResponse', function() {
      // uncomment below and update the code to test EzsignbulksendsignermappingResponse
      //var instance = new EZmaxApiDefinitionFull.EzsignbulksendsignermappingResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignbulksendsignermappingResponse);
    });
