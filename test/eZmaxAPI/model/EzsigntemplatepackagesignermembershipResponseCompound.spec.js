...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagesignermembershipResponseCompound();
  });
  ...
  describe('EzsigntemplatepackagesignermembershipResponseCompound', function() {
    it('should create an instance of EzsigntemplatepackagesignermembershipResponseCompound', function() {
      // uncomment below and update the code to test EzsigntemplatepackagesignermembershipResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagesignermembershipResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatepackagesignermembershipResponseCompound);
    });
