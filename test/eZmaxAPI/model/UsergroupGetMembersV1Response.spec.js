...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UsergroupGetMembersV1Response();
  });
  ...
  describe('UsergroupGetMembersV1Response', function() {
    it('should create an instance of UsergroupGetMembersV1Response', function() {
      // uncomment below and update the code to test UsergroupGetMembersV1Response
      //var instance = new EZmaxApiDefinitionFull.UsergroupGetMembersV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UsergroupGetMembersV1Response);
    });
