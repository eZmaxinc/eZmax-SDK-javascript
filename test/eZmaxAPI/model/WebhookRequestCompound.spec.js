...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookRequestCompound();
  });
  ...
  describe('WebhookRequestCompound', function() {
    it('should create an instance of WebhookRequestCompound', function() {
      // uncomment below and update the code to test WebhookRequestCompound
      //var instance = new EZmaxApiDefinitionFull.WebhookRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookRequestCompound);
    });
