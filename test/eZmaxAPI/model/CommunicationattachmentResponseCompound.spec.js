...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommunicationattachmentResponseCompound();
  });
  ...
  describe('CommunicationattachmentResponseCompound', function() {
    it('should create an instance of CommunicationattachmentResponseCompound', function() {
      // uncomment below and update the code to test CommunicationattachmentResponseCompound
      //var instance = new EZmaxApiDefinitionFull.CommunicationattachmentResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommunicationattachmentResponseCompound);
    });
