...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignformfieldgroupGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzsignformfieldgroupGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsignformfieldgroupGetObjectV1ResponseMPayload', function() {
      // uncomment below and update the code to test EzsignformfieldgroupGetObjectV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.EzsignformfieldgroupGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignformfieldgroupGetObjectV1ResponseMPayload);
    });
