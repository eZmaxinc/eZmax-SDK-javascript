...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignformfieldgroupGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzsignformfieldgroupGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsignformfieldgroupGetObjectV1ResponseMPayload', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignformfieldgroupGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignformfieldgroupGetObjectV1ResponseMPayload);
    });
