...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldersignerassociationResponseCompoundUser();
  });
  ...
  describe('EzsignfoldersignerassociationResponseCompoundUser', function() {
    it('should create an instance of EzsignfoldersignerassociationResponseCompoundUser', function() {
      // uncomment below and update the code to test EzsignfoldersignerassociationResponseCompoundUser
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldersignerassociationResponseCompoundUser();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldersignerassociationResponseCompoundUser);
    });
