...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookEzsignFolderUnsent();
  });
  ...
  describe('WebhookEzsignFolderUnsent', function() {
    it('should create an instance of WebhookEzsignFolderUnsent', function() {
      // uncomment below and update the code to test WebhookEzsignFolderUnsent
      //var instance = new EZmaxApiDefinitionFull.WebhookEzsignFolderUnsent();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookEzsignFolderUnsent);
    });
