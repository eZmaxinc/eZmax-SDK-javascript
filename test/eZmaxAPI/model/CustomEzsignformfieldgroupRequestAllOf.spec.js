...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CustomEzsignformfieldgroupRequestAllOf();
  });
  ...
  describe('CustomEzsignformfieldgroupRequestAllOf', function() {
    it('should create an instance of CustomEzsignformfieldgroupRequestAllOf', function() {
      // uncomment below and update the code to test CustomEzsignformfieldgroupRequestAllOf
      //var instance = new EZmaxApiDefinitionFull.CustomEzsignformfieldgroupRequestAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CustomEzsignformfieldgroupRequestAllOf);
    });
