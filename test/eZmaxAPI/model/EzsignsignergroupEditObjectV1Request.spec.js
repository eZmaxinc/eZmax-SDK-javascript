...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignsignergroupEditObjectV1Request();
  });
  ...
  describe('EzsignsignergroupEditObjectV1Request', function() {
    it('should create an instance of EzsignsignergroupEditObjectV1Request', function() {
      // uncomment below and update the code to test EzsignsignergroupEditObjectV1Request
