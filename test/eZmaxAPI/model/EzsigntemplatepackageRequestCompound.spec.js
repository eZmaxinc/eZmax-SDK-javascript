...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatepackageRequestCompound();
  });
  ...
  describe('EzsigntemplatepackageRequestCompound', function() {
    it('should create an instance of EzsigntemplatepackageRequestCompound', function() {
      // uncomment below and update the code to test EzsigntemplatepackageRequestCompound
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatepackageRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatepackageRequestCompound);
    });
