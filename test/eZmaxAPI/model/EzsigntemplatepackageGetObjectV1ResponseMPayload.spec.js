...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatepackageGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzsigntemplatepackageGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsigntemplatepackageGetObjectV1ResponseMPayload', function() {
      // uncomment below and update the code to test EzsigntemplatepackageGetObjectV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatepackageGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatepackageGetObjectV1ResponseMPayload);
    });
