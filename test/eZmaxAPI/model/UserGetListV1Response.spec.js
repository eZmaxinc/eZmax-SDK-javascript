...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserGetListV1Response();
  });
  ...
  describe('UserGetListV1Response', function() {
    it('should create an instance of UserGetListV1Response', function() {
      // uncomment below and update the code to test UserGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.UserGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserGetListV1Response);
    });
