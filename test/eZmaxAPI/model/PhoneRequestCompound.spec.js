...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PhoneRequestCompound();
  });
  ...
  describe('PhoneRequestCompound', function() {
    it('should create an instance of PhoneRequestCompound', function() {
      // uncomment below and update the code to test PhoneRequestCompound
      //var instance = new EZmaxApiDefinitionFull.PhoneRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PhoneRequestCompound);
    });
