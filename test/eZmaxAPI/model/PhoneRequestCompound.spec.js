...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.PhoneRequestCompound();
  });
  ...
  describe('PhoneRequestCompound', function() {
    it('should create an instance of PhoneRequestCompound', function() {
      ...
      //var instance = new EZmaxApiDefinition.PhoneRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinition.PhoneRequestCompound);
    });
