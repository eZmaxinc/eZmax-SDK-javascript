...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagesignermembershipRequest();
  });
  ...
  describe('EzsigntemplatepackagesignermembershipRequest', function() {
    it('should create an instance of EzsigntemplatepackagesignermembershipRequest', function() {
      // uncomment below and update the code to test EzsigntemplatepackagesignermembershipRequest
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagesignermembershipRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatepackagesignermembershipRequest);
    });
