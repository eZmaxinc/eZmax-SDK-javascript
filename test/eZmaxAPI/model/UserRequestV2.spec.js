...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserRequestV2();
  });
  ...
  describe('UserRequestV2', function() {
    it('should create an instance of UserRequestV2', function() {
      // uncomment below and update the code to test UserRequestV2
      //var instance = new EZmaxApiDefinitionFull.UserRequestV2();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserRequestV2);
    });
