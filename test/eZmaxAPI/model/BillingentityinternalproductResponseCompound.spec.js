...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BillingentityinternalproductResponseCompound();
  });
  ...
  describe('BillingentityinternalproductResponseCompound', function() {
    it('should create an instance of BillingentityinternalproductResponseCompound', function() {
      // uncomment below and update the code to test BillingentityinternalproductResponseCompound
      //var instance = new EZmaxApiDefinitionFull.BillingentityinternalproductResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.BillingentityinternalproductResponseCompound);
    });

    it('should have the property pkiBillingentityinternalproductID (base name: "pkiBillingentityinternalproductID")', function() {
      // uncomment below and update the code to test the property pkiBillingentityinternalproductID
      //var instance = new EZmaxApiDefinitionFull.BillingentityinternalproductResponseCompound();
