...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CustomEzmaxinvoicingEzsigndocumentResponseAllOf();
  });
  ...
  describe('CustomEzmaxinvoicingEzsigndocumentResponseAllOf', function() {
    it('should create an instance of CustomEzmaxinvoicingEzsigndocumentResponseAllOf', function() {
      // uncomment below and update the code to test CustomEzmaxinvoicingEzsigndocumentResponseAllOf
      //var instance = new EZmaxApiDefinitionFull.CustomEzmaxinvoicingEzsigndocumentResponseAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CustomEzmaxinvoicingEzsigndocumentResponseAllOf);
    });
