...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateRequestV2();
  });
  ...
  describe('EzsigntemplateRequestV2', function() {
    it('should create an instance of EzsigntemplateRequestV2', function() {
      // uncomment below and update the code to test EzsigntemplateRequestV2
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateRequestV2();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateRequestV2);
    });
