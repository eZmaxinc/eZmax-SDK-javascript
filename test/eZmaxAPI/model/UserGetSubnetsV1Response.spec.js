...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserGetSubnetsV1Response();
  });
  ...
  describe('UserGetSubnetsV1Response', function() {
    it('should create an instance of UserGetSubnetsV1Response', function() {
      // uncomment below and update the code to test UserGetSubnetsV1Response
      //var instance = new EZmaxApiDefinitionFull.UserGetSubnetsV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserGetSubnetsV1Response);
    });
