...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ApikeyCreateObjectV1Response();
  });
  ...
  describe('ApikeyCreateObjectV1Response', function() {
    it('should create an instance of ApikeyCreateObjectV1Response', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.ApikeyCreateObjectV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ApikeyCreateObjectV1Response);
    });
