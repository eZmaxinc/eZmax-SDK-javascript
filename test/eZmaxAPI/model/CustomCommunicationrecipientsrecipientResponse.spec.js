...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CustomCommunicationrecipientsrecipientResponse();
  });
  ...
  describe('CustomCommunicationrecipientsrecipientResponse', function() {
    it('should create an instance of CustomCommunicationrecipientsrecipientResponse', function() {
      // uncomment below and update the code to test CustomCommunicationrecipientsrecipientResponse
      //var instance = new EZmaxApiDefinitionFull.CustomCommunicationrecipientsrecipientResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CustomCommunicationrecipientsrecipientResponse);
    });
    ...
    it('should have the property eCommunicationrecipientsrecipientObjecttype (base name: "eCommunicationrecipientsrecipientObjecttype")', function() {
      // uncomment below and update the code to test the property eCommunicationrecipientsrecipientObjecttype
      //var instance = new EZmaxApiDefinitionFull.CustomCommunicationrecipientsrecipientResponse();
      //expect(instance).to.be();
    });
