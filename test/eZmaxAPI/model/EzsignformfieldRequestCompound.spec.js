...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignformfieldRequestCompound();
  });
  ...
  describe('EzsignformfieldRequestCompound', function() {
    it('should create an instance of EzsignformfieldRequestCompound', function() {
      // uncomment below and update the code to test EzsignformfieldRequestCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignformfieldRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignformfieldRequestCompound);
    });
