...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignbulksendsignermappingRequestCompound();
  });
  ...
  describe('EzsignbulksendsignermappingRequestCompound', function() {
    it('should create an instance of EzsignbulksendsignermappingRequestCompound', function() {
      // uncomment below and update the code to test EzsignbulksendsignermappingRequestCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignbulksendsignermappingRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignbulksendsignermappingRequestCompound);
    });
