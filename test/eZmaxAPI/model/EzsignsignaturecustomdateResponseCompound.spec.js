...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignsignaturecustomdateResponseCompound();
  });
  ...
  describe('EzsignsignaturecustomdateResponseCompound', function() {
    it('should create an instance of EzsignsignaturecustomdateResponseCompound', function() {
      // uncomment below and update the code to test EzsignsignaturecustomdateResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignsignaturecustomdateResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignsignaturecustomdateResponseCompound);
    });
