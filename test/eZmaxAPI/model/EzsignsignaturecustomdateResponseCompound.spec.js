...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignsignaturecustomdateResponseCompound();
  });
  ...
  describe('EzsignsignaturecustomdateResponseCompound', function() {
    it('should create an instance of EzsignsignaturecustomdateResponseCompound', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignsignaturecustomdateResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignsignaturecustomdateResponseCompound);
    });
