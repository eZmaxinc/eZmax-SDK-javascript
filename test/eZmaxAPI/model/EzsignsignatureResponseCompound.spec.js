...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignsignatureResponseCompound();
  });
  ...
  describe('EzsignsignatureResponseCompound', function() {
    it('should create an instance of EzsignsignatureResponseCompound', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignsignatureResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignsignatureResponseCompound);
    });
