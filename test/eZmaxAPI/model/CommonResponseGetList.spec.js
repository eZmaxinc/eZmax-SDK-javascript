...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommonResponseGetList();
  });
  ...
  describe('CommonResponseGetList', function() {
    it('should create an instance of CommonResponseGetList', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.CommonResponseGetList();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommonResponseGetList);
    });
