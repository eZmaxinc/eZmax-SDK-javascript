...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommunicationResponseCompoundAllOf();
  });
  ...
  describe('CommunicationResponseCompoundAllOf', function() {
    it('should create an instance of CommunicationResponseCompoundAllOf', function() {
      // uncomment below and update the code to test CommunicationResponseCompoundAllOf
      //var instance = new EZmaxApiDefinitionFull.CommunicationResponseCompoundAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommunicationResponseCompoundAllOf);
    });
