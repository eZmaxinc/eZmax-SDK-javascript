...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsigndocumentEditEzsignsignaturesV1Request();
  });
  ...
  describe('EzsigndocumentEditEzsignsignaturesV1Request', function() {
    it('should create an instance of EzsigndocumentEditEzsignsignaturesV1Request', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsigndocumentEditEzsignsignaturesV1Request();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsigndocumentEditEzsignsignaturesV1Request);
    });
