...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ActivesessionGetListV1Response();
  });
  ...
  describe('ActivesessionGetListV1Response', function() {
    it('should create an instance of ActivesessionGetListV1Response', function() {
      // uncomment below and update the code to test ActivesessionGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.ActivesessionGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ActivesessionGetListV1Response);
    });
