...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldResponse();
  });
  ...
  describe('EzsigntemplateformfieldResponse', function() {
    it('should create an instance of EzsigntemplateformfieldResponse', function() {
      // uncomment below and update the code to test EzsigntemplateformfieldResponse
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateformfieldResponse);
    });
