...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldertypeResponseCompound();
  });
  ...
  describe('EzsignfoldertypeResponseCompound', function() {
    it('should create an instance of EzsignfoldertypeResponseCompound', function() {
      // uncomment below and update the code to test EzsignfoldertypeResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldertypeResponseCompound);
    });
