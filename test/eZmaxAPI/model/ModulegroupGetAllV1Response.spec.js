...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ModulegroupGetAllV1Response();
  });
  ...
  describe('ModulegroupGetAllV1Response', function() {
    it('should create an instance of ModulegroupGetAllV1Response', function() {
      // uncomment below and update the code to test ModulegroupGetAllV1Response
      //var instance = new EZmaxApiDefinitionFull.ModulegroupGetAllV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ModulegroupGetAllV1Response);
    });
