...
(function(root, factory) {
  ...
  describe('CommonResponseFilter', function() {
    ...
    it('should have the property a_AutoTypeHaving (base name: "a_AutoTypeHaving")', function() {
      // uncomment below and update the code to test the property a_AutoTypeHaving
      //var instance = new EZmaxApiDefinitionFull.CommonResponseFilter();
      //expect(instance).to.be();
    });
