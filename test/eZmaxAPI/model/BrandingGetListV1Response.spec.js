...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BrandingGetListV1Response();
  });
  ...
  describe('BrandingGetListV1Response', function() {
    it('should create an instance of BrandingGetListV1Response', function() {
      // uncomment below and update the code to test BrandingGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.BrandingGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.BrandingGetListV1Response);
    });
