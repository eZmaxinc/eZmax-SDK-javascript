...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.SsprResetPasswordV1Request();
  });
  ...
  describe('SsprResetPasswordV1Request', function() {
    it('should create an instance of SsprResetPasswordV1Request', function() {
      // uncomment below and update the code to test SsprResetPasswordV1Request
      //var instane = new EZmaxApiDefinition.SsprResetPasswordV1Request();
      //expect(instance).to.be.a(EZmaxApiDefinition.SsprResetPasswordV1Request);
    });
    ...
    it('should have the property pksCustomerCode (base name: "pksCustomerCode")', function() {
      ...
      //var instance = new EZmaxApiDefinition.SsprResetPasswordV1Request();
