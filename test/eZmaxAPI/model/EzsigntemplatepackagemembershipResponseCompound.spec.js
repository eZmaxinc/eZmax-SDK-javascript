...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipResponseCompound();
  });
  ...
  describe('EzsigntemplatepackagemembershipResponseCompound', function() {
    it('should create an instance of EzsigntemplatepackagemembershipResponseCompound', function() {
      // uncomment below and update the code to test EzsigntemplatepackagemembershipResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplatepackagemembershipResponseCompound);
    });
