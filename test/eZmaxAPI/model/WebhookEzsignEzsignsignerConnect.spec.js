...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookEzsignEzsignsignerConnect();
  });
  ...
  describe('WebhookEzsignEzsignsignerConnect', function() {
    it('should create an instance of WebhookEzsignEzsignsignerConnect', function() {
      // uncomment below and update the code to test WebhookEzsignEzsignsignerConnect
