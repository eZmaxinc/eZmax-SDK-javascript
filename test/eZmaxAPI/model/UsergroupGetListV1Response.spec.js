...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UsergroupGetListV1Response();
  });
  ...
  describe('UsergroupGetListV1Response', function() {
    it('should create an instance of UsergroupGetListV1Response', function() {
      // uncomment below and update the code to test UsergroupGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.UsergroupGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UsergroupGetListV1Response);
    });
