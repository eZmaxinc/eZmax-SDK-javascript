...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzsigntemplateGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsigntemplateGetObjectV1ResponseMPayload', function() {
      // uncomment below and update the code to test EzsigntemplateGetObjectV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateGetObjectV1ResponseMPayload);
    });
