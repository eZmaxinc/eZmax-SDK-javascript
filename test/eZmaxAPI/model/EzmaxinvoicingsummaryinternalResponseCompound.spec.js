...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzmaxinvoicingsummaryinternalResponseCompound();
  });
  ...
  describe('EzmaxinvoicingsummaryinternalResponseCompound', function() {
    it('should create an instance of EzmaxinvoicingsummaryinternalResponseCompound', function() {
      // uncomment below and update the code to test EzmaxinvoicingsummaryinternalResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzmaxinvoicingsummaryinternalResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzmaxinvoicingsummaryinternalResponseCompound);
    });
