...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignsigningreasonResponseCompound();
  });
  ...
  describe('EzsignsigningreasonResponseCompound', function() {
    it('should create an instance of EzsignsigningreasonResponseCompound', function() {
      // uncomment below and update the code to test EzsignsigningreasonResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignsigningreasonResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignsigningreasonResponseCompound);
    });
