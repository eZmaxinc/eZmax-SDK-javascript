...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ApikeyRegenerateV1Response();
  });
  ...
  describe('ApikeyRegenerateV1Response', function() {
    it('should create an instance of ApikeyRegenerateV1Response', function() {
      // uncomment below and update the code to test ApikeyRegenerateV1Response
      //var instance = new EZmaxApiDefinitionFull.ApikeyRegenerateV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ApikeyRegenerateV1Response);
    });
