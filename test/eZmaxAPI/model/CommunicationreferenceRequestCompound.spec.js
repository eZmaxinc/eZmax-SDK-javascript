...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommunicationreferenceRequestCompound();
  });
  ...
  describe('CommunicationreferenceRequestCompound', function() {
    it('should create an instance of CommunicationreferenceRequestCompound', function() {
      // uncomment below and update the code to test CommunicationreferenceRequestCompound
      //var instance = new EZmaxApiDefinitionFull.CommunicationreferenceRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommunicationreferenceRequestCompound);
    });
