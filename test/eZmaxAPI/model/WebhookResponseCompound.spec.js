...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookResponseCompound();
  });
  ...
  describe('WebhookResponseCompound', function() {
    it('should create an instance of WebhookResponseCompound', function() {
      // uncomment below and update the code to test WebhookResponseCompound
      //var instance = new EZmaxApiDefinitionFull.WebhookResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookResponseCompound);
    });
