...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.SubnetGetObjectV2Response();
  });
  ...
  describe('SubnetGetObjectV2Response', function() {
    it('should create an instance of SubnetGetObjectV2Response', function() {
      // uncomment below and update the code to test SubnetGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.SubnetGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.SubnetGetObjectV2Response);
    });
