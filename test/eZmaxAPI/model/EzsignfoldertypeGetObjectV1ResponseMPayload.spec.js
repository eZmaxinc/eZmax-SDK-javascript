...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfoldertypeGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzsignfoldertypeGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsignfoldertypeGetObjectV1ResponseMPayload', function() {
      // uncomment below and update the code to test EzsignfoldertypeGetObjectV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.EzsignfoldertypeGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfoldertypeGetObjectV1ResponseMPayload);
    });
