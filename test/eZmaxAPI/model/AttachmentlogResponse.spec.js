...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.AttachmentlogResponse();
  });
  ...
  describe('AttachmentlogResponse', function() {
    it('should create an instance of AttachmentlogResponse', function() {
      // uncomment below and update the code to test AttachmentlogResponse
      //var instance = new EZmaxApiDefinitionFull.AttachmentlogResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.AttachmentlogResponse);
    });
