...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigndiscussionResponseCompound();
  });
  ...
  describe('EzsigndiscussionResponseCompound', function() {
    it('should create an instance of EzsigndiscussionResponseCompound', function() {
      // uncomment below and update the code to test EzsigndiscussionResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzsigndiscussionResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigndiscussionResponseCompound);
    });
