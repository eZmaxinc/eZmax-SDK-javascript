...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CustomEzsignformfieldRequestAllOf();
  });
  ...
  describe('CustomEzsignformfieldRequestAllOf', function() {
    it('should create an instance of CustomEzsignformfieldRequestAllOf', function() {
      // uncomment below and update the code to test CustomEzsignformfieldRequestAllOf
      //var instance = new EZmaxApiDefinitionFull.CustomEzsignformfieldRequestAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CustomEzsignformfieldRequestAllOf);
    });
