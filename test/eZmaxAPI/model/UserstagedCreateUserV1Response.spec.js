...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserstagedCreateUserV1Response();
  });
  ...
  describe('UserstagedCreateUserV1Response', function() {
    it('should create an instance of UserstagedCreateUserV1Response', function() {
      // uncomment below and update the code to test UserstagedCreateUserV1Response
      //var instance = new EZmaxApiDefinitionFull.UserstagedCreateUserV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserstagedCreateUserV1Response);
    });
