...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserGetAutocompleteV2Response();
  });
  ...
  describe('UserGetAutocompleteV2Response', function() {
    it('should create an instance of UserGetAutocompleteV2Response', function() {
      // uncomment below and update the code to test UserGetAutocompleteV2Response
      //var instance = new EZmaxApiDefinitionFull.UserGetAutocompleteV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserGetAutocompleteV2Response);
    });
