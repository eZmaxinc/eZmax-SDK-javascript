...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignsigningreasonListElement();
  });
  ...
  describe('EzsignsigningreasonListElement', function() {
    it('should create an instance of EzsignsigningreasonListElement', function() {
      // uncomment below and update the code to test EzsignsigningreasonListElement
      //var instance = new EZmaxApiDefinitionFull.EzsignsigningreasonListElement();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignsigningreasonListElement);
    });
