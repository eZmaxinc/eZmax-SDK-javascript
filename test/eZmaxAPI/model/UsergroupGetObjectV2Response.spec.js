...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UsergroupGetObjectV2Response();
  });
  ...
  describe('UsergroupGetObjectV2Response', function() {
    it('should create an instance of UsergroupGetObjectV2Response', function() {
      // uncomment below and update the code to test UsergroupGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.UsergroupGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UsergroupGetObjectV2Response);
    });
