...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommunicationattachmentRequestCompound();
  });
  ...
  describe('CommunicationattachmentRequestCompound', function() {
    it('should create an instance of CommunicationattachmentRequestCompound', function() {
      // uncomment below and update the code to test CommunicationattachmentRequestCompound
      //var instance = new EZmaxApiDefinitionFull.CommunicationattachmentRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommunicationattachmentRequestCompound);
    });
