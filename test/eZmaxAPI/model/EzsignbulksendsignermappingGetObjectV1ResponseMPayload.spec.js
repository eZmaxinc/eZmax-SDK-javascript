...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignbulksendsignermappingGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzsignbulksendsignermappingGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsignbulksendsignermappingGetObjectV1ResponseMPayload', function() {
      // uncomment below and update the code to test EzsignbulksendsignermappingGetObjectV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.EzsignbulksendsignermappingGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignbulksendsignermappingGetObjectV1ResponseMPayload);
    });
