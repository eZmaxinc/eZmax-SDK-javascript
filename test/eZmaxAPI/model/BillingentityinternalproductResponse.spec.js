...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BillingentityinternalproductResponse();
  });
  ...
  describe('BillingentityinternalproductResponse', function() {
    it('should create an instance of BillingentityinternalproductResponse', function() {
      // uncomment below and update the code to test BillingentityinternalproductResponse
      //var instance = new EZmaxApiDefinitionFull.BillingentityinternalproductResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.BillingentityinternalproductResponse);
    });
