...
(function(root, factory) {
  ...
  describe('CommonResponseObjDebugPayloadGetList', function() {
    ...
    it('should have the property iRowMax (base name: "iRowMax")', function() {
      // uncomment below and update the code to test the property iRowMax
      //var instance = new EZmaxApiDefinitionFull.CommonResponseObjDebugPayloadGetList();
      //expect(instance).to.be();
    });

    it('should have the property iRowOffset (base name: "iRowOffset")', function() {
      // uncomment below and update the code to test the property iRowOffset
      //var instance = new EZmaxApiDefinitionFull.CommonResponseObjDebugPayloadGetList();
      //expect(instance).to.be();
    });
