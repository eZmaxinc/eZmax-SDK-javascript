...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigndocumentApplyEzsigntemplateV1Request();
  });
  ...
  describe('EzsigndocumentApplyEzsigntemplateV1Request', function() {
    it('should create an instance of EzsigndocumentApplyEzsigntemplateV1Request', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsigndocumentApplyEzsigntemplateV1Request();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigndocumentApplyEzsigntemplateV1Request);
    });
