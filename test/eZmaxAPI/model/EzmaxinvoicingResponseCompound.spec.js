...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzmaxinvoicingResponseCompound();
  });
  ...
  describe('EzmaxinvoicingResponseCompound', function() {
    it('should create an instance of EzmaxinvoicingResponseCompound', function() {
      // uncomment below and update the code to test EzmaxinvoicingResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzmaxinvoicingResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzmaxinvoicingResponseCompound);
    });
