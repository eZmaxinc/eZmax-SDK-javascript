...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignSuggestSignersV1Response();
  });
  ...
  describe('EzsignSuggestSignersV1Response', function() {
    it('should create an instance of EzsignSuggestSignersV1Response', function() {
      // uncomment below and update the code to test EzsignSuggestSignersV1Response
      //var instance = new EZmaxApiDefinitionFull.EzsignSuggestSignersV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignSuggestSignersV1Response);
    });
