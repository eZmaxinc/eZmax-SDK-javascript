...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.FranchisereferalincomeCreateObjectV1ResponseMPayload();
  });
  ...
  describe('FranchisereferalincomeCreateObjectV1ResponseMPayload', function() {
    it('should create an instance of FranchisereferalincomeCreateObjectV1ResponseMPayload', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.FranchisereferalincomeCreateObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.FranchisereferalincomeCreateObjectV1ResponseMPayload);
    });
