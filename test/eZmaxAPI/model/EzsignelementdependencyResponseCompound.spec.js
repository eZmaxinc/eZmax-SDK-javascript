...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignelementdependencyResponseCompound();
  });
  ...
  describe('EzsignelementdependencyResponseCompound', function() {
    it('should create an instance of EzsignelementdependencyResponseCompound', function() {
      // uncomment below and update the code to test EzsignelementdependencyResponseCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignelementdependencyResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignelementdependencyResponseCompound);
    });
