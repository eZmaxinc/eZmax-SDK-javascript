...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignbulksendRequestCompound();
  });
  ...
  describe('EzsignbulksendRequestCompound', function() {
    it('should create an instance of EzsignbulksendRequestCompound', function() {
      // uncomment below and update the code to test EzsignbulksendRequestCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignbulksendRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignbulksendRequestCompound);
    });
