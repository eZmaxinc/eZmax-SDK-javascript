...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignbulksendtransmissionResponseCompound();
  });
  ...
  describe('EzsignbulksendtransmissionResponseCompound', function() {
    it('should create an instance of EzsignbulksendtransmissionResponseCompound', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignbulksendtransmissionResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignbulksendtransmissionResponseCompound);
    });
