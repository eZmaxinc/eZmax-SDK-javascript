...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignformfieldRequest();
  });
  ...
  describe('EzsignformfieldRequest', function() {
    it('should create an instance of EzsignformfieldRequest', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignformfieldRequest();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignformfieldRequest);
    });
