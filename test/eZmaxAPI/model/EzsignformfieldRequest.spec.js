...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignformfieldRequest();
  });
  ...
  describe('EzsignformfieldRequest', function() {
    it('should create an instance of EzsignformfieldRequest', function() {
      // uncomment below and update the code to test EzsignformfieldRequest
      //var instance = new EZmaxApiDefinitionFull.EzsignformfieldRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignformfieldRequest);
    });
