...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ApikeyGetListV1Response();
  });
  ...
  describe('ApikeyGetListV1Response', function() {
    it('should create an instance of ApikeyGetListV1Response', function() {
      // uncomment below and update the code to test ApikeyGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.ApikeyGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ApikeyGetListV1Response);
    });
