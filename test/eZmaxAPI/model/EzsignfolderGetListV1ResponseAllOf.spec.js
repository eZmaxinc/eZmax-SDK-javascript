...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignfolderGetListV1ResponseAllOf();
  });
  ...
  describe('EzsignfolderGetListV1ResponseAllOf', function() {
    it('should create an instance of EzsignfolderGetListV1ResponseAllOf', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignfolderGetListV1ResponseAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignfolderGetListV1ResponseAllOf);
    });
