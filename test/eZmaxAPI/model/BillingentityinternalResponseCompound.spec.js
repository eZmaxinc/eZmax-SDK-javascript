...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BillingentityinternalResponseCompound();
  });
  ...
  describe('BillingentityinternalResponseCompound', function() {
    it('should create an instance of BillingentityinternalResponseCompound', function() {
      // uncomment below and update the code to test BillingentityinternalResponseCompound
      //var instance = new EZmaxApiDefinitionFull.BillingentityinternalResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.BillingentityinternalResponseCompound);
    });
