...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateelementdependencyResponse();
  });
  ...
  describe('EzsigntemplateelementdependencyResponse', function() {
    it('should create an instance of EzsigntemplateelementdependencyResponse', function() {
      // uncomment below and update the code to test EzsigntemplateelementdependencyResponse
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateelementdependencyResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateelementdependencyResponse);
    });
