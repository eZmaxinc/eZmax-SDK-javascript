...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserGetObjectV2Response();
  });
  ...
  describe('UserGetObjectV2Response', function() {
    it('should create an instance of UserGetObjectV2Response', function() {
      // uncomment below and update the code to test UserGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.UserGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserGetObjectV2Response);
    });
