...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.BrandingResponseCompound();
  });
  ...
  describe('BrandingResponseCompound', function() {
    it('should create an instance of BrandingResponseCompound', function() {
      // uncomment below and update the code to test BrandingResponseCompound
      //var instance = new EZmaxApiDefinitionFull.BrandingResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.BrandingResponseCompound);
    });
