...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignformfieldgroupResponseCompound();
  });
  ...
  describe('EzsignformfieldgroupResponseCompound', function() {
    it('should create an instance of EzsignformfieldgroupResponseCompound', function() {
      ...
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignformfieldgroupResponseCompound);
    });
