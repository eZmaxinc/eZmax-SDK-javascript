...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UsergroupmembershipResponse();
  });
  ...
  describe('UsergroupmembershipResponse', function() {
    it('should create an instance of UsergroupmembershipResponse', function() {
      // uncomment below and update the code to test UsergroupmembershipResponse
      //var instance = new EZmaxApiDefinitionFull.UsergroupmembershipResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UsergroupmembershipResponse);
    });
