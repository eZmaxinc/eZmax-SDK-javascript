...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload', function() {
      // uncomment below and update the code to test EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload);
    });
