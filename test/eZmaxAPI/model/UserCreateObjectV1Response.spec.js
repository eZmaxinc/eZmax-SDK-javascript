...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UserCreateObjectV1Response();
  });
  ...
  describe('UserCreateObjectV1Response', function() {
    it('should create an instance of UserCreateObjectV1Response', function() {
      // uncomment below and update the code to test UserCreateObjectV1Response
      //var instance = new EZmaxApiDefinitionFull.UserCreateObjectV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UserCreateObjectV1Response);
    });
