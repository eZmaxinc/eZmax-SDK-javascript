...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UsergroupexternalmembershipResponse();
  });
  ...
  describe('UsergroupexternalmembershipResponse', function() {
    it('should create an instance of UsergroupexternalmembershipResponse', function() {
      // uncomment below and update the code to test UsergroupexternalmembershipResponse
      //var instance = new EZmaxApiDefinitionFull.UsergroupexternalmembershipResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UsergroupexternalmembershipResponse);
    });
