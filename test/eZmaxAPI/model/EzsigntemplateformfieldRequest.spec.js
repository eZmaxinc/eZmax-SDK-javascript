...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldRequest();
  });
  ...
  describe('EzsigntemplateformfieldRequest', function() {
    it('should create an instance of EzsigntemplateformfieldRequest', function() {
      // uncomment below and update the code to test EzsigntemplateformfieldRequest
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldRequest();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateformfieldRequest);
    });
