...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookEzsignDocumentFormCompleted();
  });
  ...
  describe('WebhookEzsignDocumentFormCompleted', function() {
    it('should create an instance of WebhookEzsignDocumentFormCompleted', function() {
      // uncomment below and update the code to test WebhookEzsignDocumentFormCompleted
      //var instance = new EZmaxApiDefinitionFull.WebhookEzsignDocumentFormCompleted();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookEzsignDocumentFormCompleted);
    });
