...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PermissionGetObjectV2Response();
  });
  ...
  describe('PermissionGetObjectV2Response', function() {
    it('should create an instance of PermissionGetObjectV2Response', function() {
      // uncomment below and update the code to test PermissionGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.PermissionGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PermissionGetObjectV2Response);
    });
