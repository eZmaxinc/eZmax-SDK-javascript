...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigndiscussionRequestCompound();
  });
  ...
  describe('EzsigndiscussionRequestCompound', function() {
    it('should create an instance of EzsigndiscussionRequestCompound', function() {
      // uncomment below and update the code to test EzsigndiscussionRequestCompound
      //var instance = new EZmaxApiDefinitionFull.EzsigndiscussionRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigndiscussionRequestCompound);
    });
