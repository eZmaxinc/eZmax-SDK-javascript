...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupResponseCompoundAllOf();
  });
  ...
  describe('EzsigntemplateformfieldgroupResponseCompoundAllOf', function() {
    it('should create an instance of EzsigntemplateformfieldgroupResponseCompoundAllOf', function() {
      // uncomment below and update the code to test EzsigntemplateformfieldgroupResponseCompoundAllOf
      //var instance = new EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupResponseCompoundAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsigntemplateformfieldgroupResponseCompoundAllOf);
    });
