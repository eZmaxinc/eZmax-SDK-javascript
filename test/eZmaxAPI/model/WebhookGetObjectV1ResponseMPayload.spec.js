...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookGetObjectV1ResponseMPayload();
  });
  ...
  describe('WebhookGetObjectV1ResponseMPayload', function() {
    it('should create an instance of WebhookGetObjectV1ResponseMPayload', function() {
      // uncomment below and update the code to test WebhookGetObjectV1ResponseMPayload
      //var instance = new EZmaxApiDefinitionFull.WebhookGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookGetObjectV1ResponseMPayload);
    });
