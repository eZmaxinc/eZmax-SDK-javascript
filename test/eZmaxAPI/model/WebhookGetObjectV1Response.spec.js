...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.WebhookGetObjectV1Response();
  });
  ...
  describe('WebhookGetObjectV1Response', function() {
    it('should create an instance of WebhookGetObjectV1Response', function() {
      // uncomment below and update the code to test WebhookGetObjectV1Response
      //var instance = new EZmaxApiDefinitionFull.WebhookGetObjectV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.WebhookGetObjectV1Response);
    });
