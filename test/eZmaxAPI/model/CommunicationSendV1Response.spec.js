...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.CommunicationSendV1Response();
  });
  ...
  describe('CommunicationSendV1Response', function() {
    it('should create an instance of CommunicationSendV1Response', function() {
      // uncomment below and update the code to test CommunicationSendV1Response
      //var instance = new EZmaxApiDefinitionFull.CommunicationSendV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.CommunicationSendV1Response);
    });
