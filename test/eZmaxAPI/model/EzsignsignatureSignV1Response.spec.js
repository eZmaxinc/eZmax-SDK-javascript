...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignsignatureSignV1Response();
  });
  ...
  describe('EzsignsignatureSignV1Response', function() {
    it('should create an instance of EzsignsignatureSignV1Response', function() {
      // uncomment below and update the code to test EzsignsignatureSignV1Response
      //var instance = new EZmaxApiDefinitionFull.EzsignsignatureSignV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignsignatureSignV1Response);
    });
