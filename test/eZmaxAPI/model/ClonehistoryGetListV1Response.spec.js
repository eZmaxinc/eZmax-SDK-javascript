...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ClonehistoryGetListV1Response();
  });
  ...
  describe('ClonehistoryGetListV1Response', function() {
    it('should create an instance of ClonehistoryGetListV1Response', function() {
      // uncomment below and update the code to test ClonehistoryGetListV1Response
      //var instance = new EZmaxApiDefinitionFull.ClonehistoryGetListV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ClonehistoryGetListV1Response);
    });
