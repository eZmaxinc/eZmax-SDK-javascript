...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.ApikeyGetObjectV2Response();
  });
  ...
  describe('ApikeyGetObjectV2Response', function() {
    it('should create an instance of ApikeyGetObjectV2Response', function() {
      // uncomment below and update the code to test ApikeyGetObjectV2Response
      //var instance = new EZmaxApiDefinitionFull.ApikeyGetObjectV2Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.ApikeyGetObjectV2Response);
    });
