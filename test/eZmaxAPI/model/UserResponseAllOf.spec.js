...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.UserResponseAllOf();
  });
  ...
  describe('UserResponseAllOf', function() {
    it('should create an instance of UserResponseAllOf', function() {
      ...
      //var instane = new EZmaxApiDefinition.UserResponseAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinition.UserResponseAllOf);
    });
    ...
    it('should have the property pkiUserID (base name: "pkiUserID")', function() {
      ...
      //var instance = new EZmaxApiDefinition.UserResponseAllOf();
