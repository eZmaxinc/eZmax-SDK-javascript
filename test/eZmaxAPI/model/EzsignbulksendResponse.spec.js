...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignbulksendResponse();
  });
  ...
  describe('EzsignbulksendResponse', function() {
    it('should create an instance of EzsignbulksendResponse', function() {
      ...
      //var instance = new EZmaxApiDefinitionFull.EzsignbulksendResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignbulksendResponse);
    });
