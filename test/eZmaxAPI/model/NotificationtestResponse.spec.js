...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.NotificationtestResponse();
  });
  ...
  describe('NotificationtestResponse', function() {
    it('should create an instance of NotificationtestResponse', function() {
      // uncomment below and update the code to test NotificationtestResponse
      //var instance = new EZmaxApiDefinitionFull.NotificationtestResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.NotificationtestResponse);
    });
    ...
    it('should have the property objNotificationtestName (base name: "objNotificationtestName")', function() {
      // uncomment below and update the code to test the property objNotificationtestName
      //var instance = new EZmaxApiDefinitionFull.NotificationtestResponse();
      //expect(instance).to.be();
    });
