...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignsigningreasonAutocompleteElementResponse();
  });
  ...
  describe('EzsignsigningreasonAutocompleteElementResponse', function() {
    it('should create an instance of EzsignsigningreasonAutocompleteElementResponse', function() {
      // uncomment below and update the code to test EzsignsigningreasonAutocompleteElementResponse
      //var instance = new EZmaxApiDefinitionFull.EzsignsigningreasonAutocompleteElementResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignsigningreasonAutocompleteElementResponse);
    });
