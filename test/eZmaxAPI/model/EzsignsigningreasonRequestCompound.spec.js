...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.EzsignsigningreasonRequestCompound();
  });
  ...
  describe('EzsignsigningreasonRequestCompound', function() {
    it('should create an instance of EzsignsigningreasonRequestCompound', function() {
      // uncomment below and update the code to test EzsignsigningreasonRequestCompound
      //var instance = new EZmaxApiDefinitionFull.EzsignsigningreasonRequestCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.EzsignsigningreasonRequestCompound);
    });
