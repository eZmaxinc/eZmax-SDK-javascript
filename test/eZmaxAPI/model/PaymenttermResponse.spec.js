...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.PaymenttermResponse();
  });
  ...
  describe('PaymenttermResponse', function() {
    it('should create an instance of PaymenttermResponse', function() {
      // uncomment below and update the code to test PaymenttermResponse
      //var instance = new EZmaxApiDefinitionFull.PaymenttermResponse();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.PaymenttermResponse);
    });
