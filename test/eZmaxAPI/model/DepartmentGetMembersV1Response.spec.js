...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.DepartmentGetMembersV1Response();
  });
  ...
  describe('DepartmentGetMembersV1Response', function() {
    it('should create an instance of DepartmentGetMembersV1Response', function() {
      // uncomment below and update the code to test DepartmentGetMembersV1Response
      //var instance = new EZmaxApiDefinitionFull.DepartmentGetMembersV1Response();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.DepartmentGetMembersV1Response);
    });
