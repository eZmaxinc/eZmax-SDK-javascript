...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignsignatureResponseCompoundAllOf();
  });
  ...
  describe('EzsignsignatureResponseCompoundAllOf', function() {
    it('should create an instance of EzsignsignatureResponseCompoundAllOf', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignsignatureResponseCompoundAllOf();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignsignatureResponseCompoundAllOf);
    });
