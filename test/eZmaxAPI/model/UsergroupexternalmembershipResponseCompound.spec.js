...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinitionFull.UsergroupexternalmembershipResponseCompound();
  });
  ...
  describe('UsergroupexternalmembershipResponseCompound', function() {
    it('should create an instance of UsergroupexternalmembershipResponseCompound', function() {
      // uncomment below and update the code to test UsergroupexternalmembershipResponseCompound
      //var instance = new EZmaxApiDefinitionFull.UsergroupexternalmembershipResponseCompound();
      //expect(instance).to.be.a(EZmaxApiDefinitionFull.UsergroupexternalmembershipResponseCompound);
    });

    it('should have the property pkiUsergroupexternalmembershipID (base name: "pkiUsergroupexternalmembershipID")', function() {
      // uncomment below and update the code to test the property pkiUsergroupexternalmembershipID
      //var instance = new EZmaxApiDefinitionFull.UsergroupexternalmembershipResponseCompound();
