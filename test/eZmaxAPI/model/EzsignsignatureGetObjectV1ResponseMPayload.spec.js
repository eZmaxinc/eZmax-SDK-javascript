...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EZmaxApiDefinition.EzsignsignatureGetObjectV1ResponseMPayload();
  });
  ...
  describe('EzsignsignatureGetObjectV1ResponseMPayload', function() {
    it('should create an instance of EzsignsignatureGetObjectV1ResponseMPayload', function() {
      ...
      //var instance = new EZmaxApiDefinition.EzsignsignatureGetObjectV1ResponseMPayload();
      //expect(instance).to.be.a(EZmaxApiDefinition.EzsignsignatureGetObjectV1ResponseMPayload);
    });
